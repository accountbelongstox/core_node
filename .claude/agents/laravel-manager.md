...
Main docs: the machine data sync REQUIREMENTS (UI states: cancelled, terminal retention, skipped tables), nginx multi-end management (UI), the UI exchange hub architecture.
