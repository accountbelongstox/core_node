...
Main docs: terminal control R6/R7 (UI), agent history floating panels / scan center, the mixed-content endpoint refactor, relay groups UI, audio orchestration UI, the delivery status panel (R7).
