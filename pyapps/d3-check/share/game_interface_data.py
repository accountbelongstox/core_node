...
def _initialize_battlenet_region_from_config(game_data: D3InterfaceData) -> None:
    ...
    Services.LastLoginRegion is under a dynamic key (install ID), search recursively. CN (case-insensitive) -> "cn"; non-CN (KR/US/EU/TW etc.) -> "asia".
    """
