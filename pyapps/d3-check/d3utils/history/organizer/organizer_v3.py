...
# -*- coding: utf-8 -*-
"""
Organizer V3: Uses parser V3 (two-pass) + aggregator + formatter.
"""
...
class HistoryOrganizerV3(HistoryOrganizerBase):
    """Organizer V3: Two-pass parser with time window aggregation."""
    
    def __init__(self, history_path: str) -> None:
        super().__init__(history_path)
        self._parser = HistoryParserV3()
