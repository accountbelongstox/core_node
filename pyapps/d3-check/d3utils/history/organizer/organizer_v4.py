...
# -*- coding: utf-8 -*-
"""
Organizer V4: Uses parser V4 (state machine) + aggregator + formatter.
"""
...
class HistoryOrganizerV4(HistoryOrganizerBase):
    """Organizer V4: State machine parser with time window aggregation."""
    
    def __init__(self, history_path: str) -> None:
        super().__init__(history_path)
        self._parser = HistoryParserV4()
