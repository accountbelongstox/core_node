...
# -*- coding: utf-8 -*-
"""
Organizer V5: Uses parser V5 (regex + indent stack) + aggregator + formatter.
"""
...
class HistoryOrganizerV5(HistoryOrganizerBase):
    """Organizer V5: Regex + indent stack parser with time window aggregation."""
    
    def __init__(self, history_path: str) -> None:
        super().__init__(history_path)
        self._parser = HistoryParserV5()
