...
class RosbotUpdateManager:
    ...
    def get_best_newer_zip(self, region: str) -> Tuple[Optional[str], bool, Optional[str]]:
        """
        Find best zip newer than current based on detected region
        ...
        Returns:
            ...
            (zip_path or None, is_newer, version_str like '36.0129')
            is_newer=False if region not detected or no current update
        """
