...
def _initialize_unified_mcp_server() -> FastMCP:
    ...
    mcp = FastMCP("MCP Unified Server", version="2.0.0")
    ...
    ColorPrint.green("[MCP Unified Server] Initialized with 19 tools across 3 subsystems")
...
def start() -> bool:
    ...
    ColorPrint.blue("\n" + "=" * 80)
    ColorPrint.green("MCP UNIFIED SERVER v2.0.0")
    ColorPrint.blue("=" * 80)
    ColorPrint.yellow(f"Project Root: {PROJECT_ROOT}")
    ColorPrint.blue("-" * 80)
    ColorPrint.blue("Subsystems:")
    ColorPrint.blue("  • File Processing (4 tools): OCR, Documents, Color Analysis, Caching")
    ColorPrint.blue("  • Database (7 tools): Namespace Management, Queries, Schema, Stats")
    ColorPrint.blue("  • Codebase (8 tools): Trees, Search, Content Analysis, Frameworks")
    ColorPrint.blue("-" * 80)
    ColorPrint.green("Total: 19 Unified Tools")
    ColorPrint.blue("=" * 80 + "\n")

    ColorPrint.green("[START] Launching unified MCP server...")
