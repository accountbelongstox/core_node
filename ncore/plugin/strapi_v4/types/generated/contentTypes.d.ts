...
export interface ApiTaskTask extends Schema.CollectionType {
  ...
  attributes: {
    tid: Attribute.UID;
    dec: Attribute.String;
    promp: Attribute.Text;
    pdoc: Attribute.Text;
    pai: Attribute.String;
    strict: Attribute.String;
    tested: Attribute.Boolean;
    ttime: Attribute.DateTime;
    ppbulish: Attribute.DateTime;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
