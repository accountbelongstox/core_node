 ...
 */
 ...
 module.exports = {
  ...
  run(options = {}) {
    ...
    console.log('[ee-init] [rd] Start moving resources');
    ...
    if (!fs.existsSync(eeResourceDir)) {
      ...
      console.log('[ee-init] [rd] Clear history resources:', eeResourceDir);
    }

    fsPro.copySync(sourceDir, eeResourceDir);
    console.log('[ee-init] [rd] Copy a resource to:', eeResourceDir);
    console.log('[ee-init] [rd] End');
  },
