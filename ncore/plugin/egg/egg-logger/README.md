...
```js
const Logger = require('@egg/egg-logger').Logger;
const FileTransport = require('@egg/egg-logger').FileTransport;
const ConsoleTransport = require('@egg/egg-logger').ConsoleTransport;
...
const Transport = require('@egg/egg-logger').Transport;
