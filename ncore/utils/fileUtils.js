...
export function getFile(url, dest) {
...
export async function downloadAll(urls, directory, maxThread = 10) {
    let i = 0;
...
export async function compareFileSizes(remoteUrl, localPath) {
