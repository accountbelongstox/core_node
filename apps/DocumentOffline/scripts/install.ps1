...
Write-Host "[INFO] Installing dependencies for DocumentOffline application" -ForegroundColor Green
...
try {
    ...
    Write-Host "[INFO] DocumentOffline-specific installation completed" -ForegroundColor Green
}
catch {
    Write-Host "[ERROR] Failed to install DocumentOffline dependencies: $_" -ForegroundColor Red
    exit 1
}
