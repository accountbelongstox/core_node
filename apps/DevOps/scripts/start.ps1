...
# DevOps NCore App Start Script
# Complexity: Complex - Advanced logic for NCore application startup
# Hardcoded start script for DevOps application
...
Write-Host "[INFO] Starting NCore application: DevOps" -ForegroundColor Green
...
try {
    ...
    # Start DevOps using unified entry point
    Write-Host "[INFO] Executing: node ./main.js app=DevOps" -ForegroundColor Cyan
    node ./main.js app=DevOps
}
catch {
    Write-Host "[ERROR] Failed to start DevOps: $_" -ForegroundColor Red
    exit 1
}
