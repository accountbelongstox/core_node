...
Write-Host "[INFO] Starting NCore application: GetDocFromUrlByPuppeteer" -ForegroundColor Green
...
try {
    ...
    Write-Host "[INFO] Executing: node ./main.js app=GetDocFromUrlByPuppeteer" -ForegroundColor Cyan
    node ./main.js app=GetDocFromUrlByPuppeteer
}
catch {
    Write-Host "[ERROR] Failed to start GetDocFromUrlByPuppeteer: $_" -ForegroundColor Red
    exit 1
}
