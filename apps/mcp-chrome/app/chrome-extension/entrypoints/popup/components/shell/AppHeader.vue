<template>
  <header class="app-header">
    <div class="brand-lockup">
      ...
      <div>
        <h1>Chrome MCP</h1>
        <p>Browser automation console</p>
      </div>
    </div>
    ...
    <div class="app-header__actions">
      ...
      <EndpointDropdown />
      <LanguageSelector />
      <button v-if="!isTabView" class="icon-button" title="Open in a persistent tab" @click="openInTab">
        <svg viewBox="0 0 24 24"><path d="M14 3h7v7m0-7L10 14M19 14v5a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h5" /></svg>
      </button>
      <button class="icon-button" :title="`Use ${theme === 'dark' ? 'light' : 'dark'} theme`" @click="toggleTheme">
