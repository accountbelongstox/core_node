...
const POPUP_MESSAGES = {
  zh: {
    ...
    backendLogin: '连接后台登录', backendUrl: '后台地址', username: '用户名', password: '密码', login: '登录',
  ...
  en: {
    ...
    backendLogin: 'Backend login', backendUrl: 'Backend URL', username: 'Username', password: 'Password', login: 'Log in',
