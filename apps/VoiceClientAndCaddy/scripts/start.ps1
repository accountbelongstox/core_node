...
Write-Host "[INFO] Starting NCore application: VoiceClientAndCaddy" -ForegroundColor Green
...
try {
    ...
    Write-Host "[INFO] Executing: node ./main.js app=VoiceClientAndCaddy" -ForegroundColor Cyan
    node ./main.js app=VoiceClientAndCaddy
}
catch {
    Write-Host "[ERROR] Failed to start VoiceClientAndCaddy: $_" -ForegroundColor Red
    exit 1
}
