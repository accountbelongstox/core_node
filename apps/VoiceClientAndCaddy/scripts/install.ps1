...
Write-Host "[INFO] Installing dependencies for VoiceClientAndCaddy application" -ForegroundColor Green
...
try {
    ...
    Write-Host "[INFO] VoiceClientAndCaddy-specific installation completed" -ForegroundColor Green
}
catch {
    Write-Host "[ERROR] Failed to install VoiceClientAndCaddy dependencies: $_" -ForegroundColor Red
    exit 1
}
