...
const ENCRYPTED_DATA = Buffer.from('b7NFFl8ajRsDLRjXYBxFUz5AZw==', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('5WZWy8zZxvrFIrK8sDzmuBLsGWFyhRBJm9o9fNo7DN0=', 'base64');
const PARAMS_IV = Buffer.from('XUoBZfLlcRPlZQNb3+ttmg==', 'base64');
const ORIGINAL_FILENAME = 'CODEX_MODEL_1';
