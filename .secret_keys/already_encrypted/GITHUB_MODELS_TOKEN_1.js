...
const ENCRYPTED_DATA = Buffer.from('CqcIU71hElO0r1+YmldCfLxPpPCC+rpz8FJL6TmIM39O13Jp63WMloOhcIH25VLlEDDREocZ4djSiYvXJSy9CeT3RnaKlSJZJmtv9rMKlq+rGGu5wZPgMHqqAPUQsfTJT7laoQ==', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('mQkiYBpLBXGSMrh4sinDidCg4jWT5g7wW+5xfQXSDio=', 'base64');
const PARAMS_IV = Buffer.from('qkma4TenYwoXJ4NYrOrH4w==', 'base64');
const ORIGINAL_FILENAME = 'GITHUB_MODELS_TOKEN_1';
