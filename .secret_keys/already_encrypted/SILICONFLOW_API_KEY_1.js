...
const ENCRYPTED_DATA = Buffer.from('BzaVQ94c/sqLRqGxsZkSrm8B23TDcFkfA160OJdfWXdtf2DhpRYe/0GZgQNj1y4kbI0u7GKCDsVb', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('cx3p+GPWMy2ziBTkVOSPZDBqo+5wcsouZrIXgVMfskM=', 'base64');
const PARAMS_IV = Buffer.from('3ANWnXc/90EMjIM60lrWgg==', 'base64');
const ORIGINAL_FILENAME = 'SILICONFLOW_API_KEY_1';
