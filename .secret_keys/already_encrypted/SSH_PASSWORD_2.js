...
const ENCRYPTED_DATA = Buffer.from('NcuBJEVZyzxf3XnNNW12h9/7lpo=', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('UpFQBgGliH6KUGrctgo3Y+2Cv9RRATCbqPD4gDHTKzg=', 'base64');
const PARAMS_IV = Buffer.from('r5/+i/vEUA5QaBRYdNue6A==', 'base64');
const ORIGINAL_FILENAME = 'SSH_PASSWORD_2';
