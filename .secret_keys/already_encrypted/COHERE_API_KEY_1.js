...
const ENCRYPTED_DATA = Buffer.from('7v/tvUZOXTKI5yxxnfBFMrEsK3t2MrKZ2AB9thr+2yNyUz6Za9CDJIL0RmNdBEnZ', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('7j/eK5v9jk7JhvBSs7kOAu09jxFw5UV9yZ9aqDjHtMQ=', 'base64');
const PARAMS_IV = Buffer.from('zYbQXIpmYsgd65XDXV6+TQ==', 'base64');
const ORIGINAL_FILENAME = 'COHERE_API_KEY_1';
