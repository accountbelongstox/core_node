...
const ENCRYPTED_DATA = Buffer.from('v4J41Yn1S/9zCCBPpwng', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('dcOzhGlkeZqk8Fpcuczk2oak+YXfIaODvEqAfZafepM=', 'base64');
const PARAMS_IV = Buffer.from('CprzK92dEXAQxRzrhI2P6Q==', 'base64');
