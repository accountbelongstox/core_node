...
const ENCRYPTED_DATA = Buffer.from('PvUSnKubqr9DN2kfeyn4', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('kXEiXGf2dnb2+m0AOMHn+1SpkWU0m69b9kDAZ+F+wdM=', 'base64');
const PARAMS_IV = Buffer.from('ORxFvf5S9g28eIjmS7Y+Sg==', 'base64');
