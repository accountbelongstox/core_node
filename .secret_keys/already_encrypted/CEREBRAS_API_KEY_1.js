...
const ENCRYPTED_DATA = Buffer.from('KA+MhK/5dTOtjLgcgXR/KKNEqsr8qTQXXo8xmiJYJdUqfcpwxRSE7FnA7K9+whzmqYCu1QpqPD3Q9co=', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('LWubiAYFkXhgPL3ABFaEdbAvwz0UhTuk9X/bId6s2C8=', 'base64');
const PARAMS_IV = Buffer.from('civdOxUpg78dNzq09iZLug==', 'base64');
const ORIGINAL_FILENAME = 'CEREBRAS_API_KEY_1';
