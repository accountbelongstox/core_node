...
const ENCRYPTED_DATA = Buffer.from('', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('/kOQmxNehp3u5AnINwc2YN7tQgyYgPkRETMbjEAoTnM=', 'base64');
const PARAMS_IV = Buffer.from('A50LBXp/KxHh59CTBFY8BQ==', 'base64');
