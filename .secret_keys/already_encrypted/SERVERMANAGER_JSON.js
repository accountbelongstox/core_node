...
const ENCRYPTED_DATA = Buffer.from('', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('29+HLfOuTe4tK97iPAPxL+hh/EuQfx6wWNUkSpykfbA=', 'base64');
const PARAMS_IV = Buffer.from('h7P2Lmm9GCaNu+aRCjbMKg==', 'base64');
