...
const ENCRYPTED_DATA = Buffer.from('', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('nsEE4vQu2jTeXRokJ28lTBO6A5BjqGyVqJrJ7Qf06XU=', 'base64');
const PARAMS_IV = Buffer.from('CwBaq63IvZv1JBBE5nNxfQ==', 'base64');
