...
const ENCRYPTED_DATA = Buffer.from('ZIvEmqVb9YN1uQBWWojd', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('g6KP0NtSc4uAO7+C1+fCBz5qkPjzowXfUEplexo5/LA=', 'base64');
const PARAMS_IV = Buffer.from('ID2b6cMdl8NflCTRLmv+dQ==', 'base64');
const ORIGINAL_FILENAME = 'ANTHROPIC_MODEL_1';
