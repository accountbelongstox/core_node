...
const ENCRYPTED_DATA = Buffer.from('CDvCGLANashrxX9JEoX+tFwC4PFxFBHvhIJOqrmssSKtN8IPMbhgKS/3pHykBAokCIvou18W4+kgLgar1SIJbA==', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('8WESydMlKPgYcdg7rh8jE/7GgoYc/Dk5b9upZbjwroc=', 'base64');
const PARAMS_IV = Buffer.from('bEUtVnWSv7+We+KwacbItA==', 'base64');
const ORIGINAL_FILENAME = 'DASHSCOPE_BASE_URL_1';
