...
const ENCRYPTED_DATA = Buffer.from('i3+XDpN8mZSI0AnZgHhoDpQNfD0eyQDZfUPyLM7D9mEh5aq/FWBJ1w==', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('Kljp6XTVw7cjSFkJDWidyxd7C6B9XFk8oPZtOMbaSSQ=', 'base64');
const PARAMS_IV = Buffer.from('RQ3ITnn60QjnlNCbKt/2qA==', 'base64');
const ORIGINAL_FILENAME = 'CLOUDFLARE_R2_ACCESS_KEY_ID_1';
