...
const ENCRYPTED_DATA = Buffer.from('KUSiA/kWHByX0mVRX8OjLagoGSAimOoWPFvpMMEE7Ik3MbqnJ15qmUcZ2J+hqg/mwItlAjHV/3RspQ2LkfRvMHM691JD38u5tjW5LOko00oYjTCGBI3dnkNl+JqgcPfdH7Wd3CqaXxJJu3oq1PIS/Y7RhlPZSmm4d5zUyBKMpS3j', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('/BwgyZOhfkQUpBba90C3zyFibDwH6QW7EUafhW1on+4=', 'base64');
const PARAMS_IV = Buffer.from('Y9U2Luzbx5jQJ+CQVURflQ==', 'base64');
const ORIGINAL_FILENAME = 'MINIMAX_API_KEY_1';
