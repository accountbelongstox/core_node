...
const ENCRYPTED_DATA = Buffer.from('n8yZl90iFq7jgDr+Zkyhzxc7JX3cRGnnqcUjqx5fGgRNWJ05sJON8oqT1RL6sswUc5Is', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('yf3JRzDtPP9KhMn2eo++QN7C+H4wz20tBXSFRA5R36w=', 'base64');
const PARAMS_IV = Buffer.from('c2Pzg1b50FWMidFb51mmHw==', 'base64');
const ORIGINAL_FILENAME = 'ARK_BASE_URL_1';
