...
const ENCRYPTED_DATA = Buffer.from('n0wyO3oJUAnhgGhWzmySD/kb7Cr5iFXqDS1g2KqkTgm92XTolVvnCJlg7AL9ZbPO+Y1bMlAsMS1ZDRF1lL4=', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('l/kvR8FhSh+IVaPEVD6Upr0V5YBIq0IQgNbw6M61HP4=', 'base64');
const PARAMS_IV = Buffer.from('CFg5zrB2i/g92Xw+K1vHwg==', 'base64');
const ORIGINAL_FILENAME = 'ANTHROPIC_API_KEY_5';
