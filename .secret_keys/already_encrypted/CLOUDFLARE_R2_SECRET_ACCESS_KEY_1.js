...
const ENCRYPTED_DATA = Buffer.from('Hfli+hMaAw3tbD+mnQgjfmJAbO4iYa89QNLGFAZsgJAZ6uRfuvMxpWOkqy1nSZ2oMiHAqpTRvFfqcA==', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('KKjy2ehMtpoS2Tw8RNaw2AfcFE0w5MCixihtYtDKKwM=', 'base64');
const PARAMS_IV = Buffer.from('oNCxS8Ps4KmCNI0yqGuhsw==', 'base64');
const ORIGINAL_FILENAME = 'CLOUDFLARE_R2_SECRET_ACCESS_KEY_1';
