...
const ENCRYPTED_DATA = Buffer.from('Az9RrWs2AazlVUxymFvhla77TfvOzZ85CJ6Mcq6rjFIimbIX7vec37hriZNzhrvPku2dAP+58sPYdo92UAlD5gDo19rKXh5mioFu9qOiDVQ=', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('U/6PG16Ydq3pIhmkPGdlpW3NOUPQOViBHfQdDjnVz1I=', 'base64');
const PARAMS_IV = Buffer.from('As8+dMesb2Bq3s9VqvZ5Pw==', 'base64');
const ORIGINAL_FILENAME = 'QIANFAN_API_KEY_1';
