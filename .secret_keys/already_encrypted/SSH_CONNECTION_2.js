...
const ENCRYPTED_DATA = Buffer.from('x5zM56YCYJjbpiN7cS64cja6YnIQE2kmVCoRoWM=', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('NvtP6SkGAvEn7vA2uvl+i40nOU+cme3Akbkpv1aE+hM=', 'base64');
const PARAMS_IV = Buffer.from('1M7VlL5nN8MpwRbxyt+RTQ==', 'base64');
const ORIGINAL_FILENAME = 'SSH_CONNECTION_2';
