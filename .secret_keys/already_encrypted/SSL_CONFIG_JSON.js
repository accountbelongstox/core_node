...
const ENCRYPTED_DATA = Buffer.from('vDnJbxh7yf0BSUHisT3PXGz95wJ00HQeqOId1F+c+hvlHql25m6TxLVtXcIw/9Ob9Ap7pjFGq0HMGg/bgHRYioJ9rhMJWixde6NE4mbJvcfyvEn1iMQ=', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('bkPHCap6WQrCW+V5PsBXmLwmsJ6H9J2d7urTxTpHg58=', 'base64');
const PARAMS_IV = Buffer.from('axGd+5znktBFp5mrxnuiGA==', 'base64');
const ORIGINAL_FILENAME = 'SSL_CONFIG_JSON';
