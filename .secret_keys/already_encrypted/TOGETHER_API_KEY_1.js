...
const ENCRYPTED_DATA = Buffer.from('wcQIgdpas8Bs2C1N+wcNrNOzYGI/Q3LVVbtZ+jBgvj/Lbbzw+uC98bQKvMXvgPneVuKn1xs3HMGnyw==', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('lWeCWV7/pZLoDytJOeghxFE0xJ1oejToHlmuOFdqTtM=', 'base64');
const PARAMS_IV = Buffer.from('lOQ2oyXxVZLuJEC/b1QW4g==', 'base64');
const ORIGINAL_FILENAME = 'TOGETHER_API_KEY_1';
