...
const ENCRYPTED_DATA = Buffer.from('', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('zLwEQok3jiQFNKwH3QqSb0bwGsir2vN7r2liH7ghbiY=', 'base64');
const PARAMS_IV = Buffer.from('vFE3N/cEto8Mn5T2AcONgg==', 'base64');
const ORIGINAL_FILENAME = 'TMDB_API_READ_ACCESS_TOKEN_1';
