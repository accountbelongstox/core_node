...
const ENCRYPTED_DATA = Buffer.from('zRzJPKDXkeOxP3PTYHUivBXDLo3YNkbhGUI0uSnCnXYO', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('waFU7gci8KgpZ1fhcDbElRI71Z7tUFQ86lE/e5Xpnv4=', 'base64');
const PARAMS_IV = Buffer.from('bG8oiKYwVgfGejzNSWLSUg==', 'base64');
const ORIGINAL_FILENAME = 'TOGETHER_KEY_ID_1';
