...
const ENCRYPTED_DATA = Buffer.from('i4DFevN6WGtHOuzgWybbOplHeNFkibfMjTlN3IJ2Erpl7ogNyGSHXjTPHb78euu/PWaDg8hP9tUZME6zR2P2IQ==', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('FqVMZP4BviBk3w7V+0vPNPTZDENOs17/1j2qY88e0MU=', 'base64');
const PARAMS_IV = Buffer.from('3fAsRKhpIo34eUka2yz+2g==', 'base64');
const ORIGINAL_FILENAME = 'GROQ_API_KEY_1';
