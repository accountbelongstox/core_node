...
const ENCRYPTED_DATA = Buffer.from('GBIqIf0QuxcKUzbVCcv5StCcm8guHkhtd0l02SwG1GHrZyr7sdDpM1dkF9NVNyvuP0FxvIkV3CJZk7ZPYg==', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('f9XzW3WBuZ2skqrh2nYj4x7mwgPyeScPWdO//rhmBXI=', 'base64');
const PARAMS_IV = Buffer.from('uB+RnPb473BtUxNWDyVWZw==', 'base64');
const ORIGINAL_FILENAME = 'CLOUDFLARE_R2_API_TOKEN_1';
