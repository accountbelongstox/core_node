...
const ENCRYPTED_DATA = Buffer.from('OPawltnM3rm8Czz54hM2fc1k6Q3dvDU4H7Un0wSkScuwfzzYCfahvAXUddF0zdqaMd14zmI9mwz/rZvv0ifeCf8+EN98RYiZM9zJa+ZtePFaohEOM1vMWL+DkockGA69dl4om1XWQJSnK8YEMIW6T1Ko8Rq6RtccvA==', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('lM/P0gHV4ovRwOYbPz+XJJ0GoBFSobpGPiWcjYUl6wc=', 'base64');
const PARAMS_IV = Buffer.from('hRI7kiz33ZHD+BDJS6tW5Q==', 'base64');
const ORIGINAL_FILENAME = 'DASHSCOPE_API_KEY_1';
