...
const ENCRYPTED_DATA = Buffer.from('JCR0SJB5gLqnAxmlqXEgW2ZgMrvm2ss2DmywEwreNCQKoh2XgVLUow==', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('di8/mVZOTyodmSJ+2nQjHFMzDzxsqH8CuD4Ol4R+LEc=', 'base64');
const PARAMS_IV = Buffer.from('DUBGekn97JIV3ZD9OjcESQ==', 'base64');
const ORIGINAL_FILENAME = 'TMDB_API_KEY_1';
