...
const ENCRYPTED_DATA = Buffer.from('wcsY0y1/LK27IeGqrH6fI8do/FrNWRgykrZ0HiewVHWtTcKcUFOhbg==', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('T1fCyB8hSS0X/nSSGCjDb88WEoo1+5LTANlQLOBOUa8=', 'base64');
const PARAMS_IV = Buffer.from('oPMSDF0tRigOsyeP1U/4EQ==', 'base64');
const ORIGINAL_FILENAME = 'MISTRAL_API_KEY_1';
