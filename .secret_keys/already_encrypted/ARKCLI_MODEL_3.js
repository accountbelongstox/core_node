...
const ENCRYPTED_DATA = Buffer.from('aIR4c3ZFlaz4LCIeUccw', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('vuScQcXfDDYW/yX+CQid7t9QuBlBKQyPjYdYGatgijk=', 'base64');
const PARAMS_IV = Buffer.from('t9W4M2Pq7xozIKiDy3qnlw==', 'base64');
