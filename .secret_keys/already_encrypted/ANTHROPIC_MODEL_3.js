...
const ENCRYPTED_DATA = Buffer.from('ko2WaNYBDFivK+2Qnl4w', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('9FDSUBMZTAcozlt2bnFlmn2cqDHgEWdsab72KLWgnN4=', 'base64');
const PARAMS_IV = Buffer.from('P3W2DCvtDaB74Tc3iugXdg==', 'base64');
const ORIGINAL_FILENAME = 'ANTHROPIC_MODEL_3';
