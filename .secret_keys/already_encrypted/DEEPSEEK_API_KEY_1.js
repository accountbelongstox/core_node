...
const ENCRYPTED_DATA = Buffer.from('vZiDBiFZrqHZo8JqGd71MQxNA28P1JrwULk1H6sHequ/h8e4riSuX9BmZA==', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('SVXc/UkjdB8LYAzdqpBCkSNVStsUTjg3y960btIHRpA=', 'base64');
const PARAMS_IV = Buffer.from('E2Lnp3hO2tIj1yzuo2uPWg==', 'base64');
const ORIGINAL_FILENAME = 'DEEPSEEK_API_KEY_1';
