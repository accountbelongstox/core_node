...
const ENCRYPTED_DATA = Buffer.from('ejkjnYh7w8+Gct+U3spyo7vATVdJ0ecWc9QAmLyZ1yIrlx629++8PYtpTmk=', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('tPIu7Ayysz6GOnl8FjaTS71Ljcl/UlC4FOukc01hOO0=', 'base64');
const PARAMS_IV = Buffer.from('i64glguVjGHyeC6jKb8/gQ==', 'base64');
const ORIGINAL_FILENAME = 'OMDB_API_KEY_1';
