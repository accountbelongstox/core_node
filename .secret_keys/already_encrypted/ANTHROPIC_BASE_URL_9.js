...
const ENCRYPTED_DATA = Buffer.from('O7KQ/Ux0N0gIK6A3UQUG', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('kNMHbuAOawXRYjcSFoaPRfOVfo81+Cp16LYfK/B5S80=', 'base64');
const PARAMS_IV = Buffer.from('51KeWZllyAhzdKFN+ZVg3Q==', 'base64');
