...
const ENCRYPTED_DATA = Buffer.from('sAVMUvee6hF+D8lqqE5C+vGyV6yPKPkEdFKxCWu+ypHZUph2OlSHYY5cDLc0', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('LxfqMApnoYurFdwV2TC2udiAcab0BFCqzHDEA1KvQ/o=', 'base64');
const PARAMS_IV = Buffer.from('ghk5meScOOmWh7sguFC7OA==', 'base64');
const ORIGINAL_FILENAME = 'HF_TOKEN_1';
