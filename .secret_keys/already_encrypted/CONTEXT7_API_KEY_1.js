...
const ENCRYPTED_DATA = Buffer.from('qOfIu6aJv12pgk6gM+KyvP/E6ftKyZYmi0Pu29XF9ZrSGQN2Rw4TsTiHs6LXmYj+xhVV', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('', 'base64');
const PARAMS_KEY = Buffer.from('x5KILlmMXa8RFPx5NY/NG+KxhZgQmGPSuIVFhsq46ks=', 'base64');
const PARAMS_IV = Buffer.from('3dSfuJbkxzM/Pusup2ZZ3A==', 'base64');
