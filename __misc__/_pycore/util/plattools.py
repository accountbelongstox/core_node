...
class Plattools(Base):
    ...
    def install_on_windows(self, install_command):
        ...
        try:
            subprocess.run(["choco", "init"] + install_command.split(), check=True)
    ...
    def install_on_centos(self, install_command):
        try:
            subprocess.run(["sudo", "yum", "init", "-y"] + install_command.split(), check=True)
    ...
    def install_on_ubuntu(self, install_command):
        try:
            subprocess.run(["sudo", "apt-get", "init", "-y"] + install_command.split(), check=True)
