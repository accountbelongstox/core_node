# -*- coding: utf-8 -*-
"""
Video Extract Processor - orchestrator for the "Video Extraction" feature.
...
laravel_media_sync.py and video_extract_controller.py need NO import changes.
  * filename_sanitizer.py - ASCII filename transcoding (sanitize_relpath,
    to_english_ascii, _load_backends).
...
from .filename_sanitizer import (  # re-exported
    sanitize_relpath,
    to_english_ascii,
    _load_backends,
)
from .ffmpeg_ops import (  # VIDEO_EXTENSIONS re-exported
    VIDEO_EXTENSIONS,
    CODECS,
    resolve_ffmpeg,
    resolve_ffprobe,
...
from .whisper_runtime import (  # whisper_capabilities re-exported
...
from .srt_utils import (  # _parse_srt_segments, _srt_time_to_sec re-exported
    _parse_srt_segments,
    _srt_time_to_sec,
    plan_segments,
    _count_srt_segments,
