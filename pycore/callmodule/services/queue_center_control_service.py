...
from pycore.callmodule.services.queue_center_contract import QUEUE_CENTER_CONTROL_NAMES
...
def get_control_intent(name: str) -> Dict[str, Any]:
    ...
    document = get_user_data_store().get_section(_CONTROL_SECTION) or {}
...
__all__ = ["get_control_intent", "normalize_control_name", "record_control_intent"]
