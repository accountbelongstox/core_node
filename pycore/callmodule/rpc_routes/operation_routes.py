...
def register_operation_routes(server):
    ...
    server.post(path=route_names.UI_OPERATION_SNAPSHOT, handler=snapshot_handler)
    ...
    server.post(path=route_names.UI_OPERATION_EVENTS, handler=events_handler)
    ...
    server.post(path=route_names.UI_OPERATION_CANCEL, handler=cancel_handler)
