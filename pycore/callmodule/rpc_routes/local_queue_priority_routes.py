...
def register_local_queue_priority_routes(server):
    ...
    server.post(
        path=UI_QUEUE_PRIORITY_PRIORITIZE_SENTENCE_AUDIO,
    ...
    server.post(
        path=UI_QUEUE_PRIORITY_PRIORITIZE_SENTENCE_AUDIO_ITEM,
    ...
    server.post(
        path=UI_QUEUE_PRIORITY_PRIORITIZE_WORD_AUDIO_WORDS,
