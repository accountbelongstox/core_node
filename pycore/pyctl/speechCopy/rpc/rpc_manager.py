...
class RpcManager:
    ...
    - /rpc/tts - Text to speech conversion
    - /rpc/stt - Speech to text conversion
    ...
    Usage:
        ...
        # API endpoints:
        # POST /rpc/tts - {"text": "hello", "language": "en-US"}
        # POST /rpc/stt - {"audio": "base64...", "language": "en-US"} or {"audio_path": "/path/to/file"}
        # POST /rpc/multi_tts - {"text": "hello", "languages": ["en-US", "zh-CN", "ja-JP"]}
        # POST /rpc/multi_stt - {"audio": "base64...", "languages": ["en-US", "zh-CN"]}
    """
