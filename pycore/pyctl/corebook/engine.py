...
from pycore.pyctl.corebook.completeness import (
    bundle_summary,
    compute_completeness,
)
from pycore.pyctl.corebook.translate import translate_sentences
from pycore.pyctl.corebook.audio import fill_audio_for_slots
