...
class EnhancedPage(StandardPage):
    ...
    def setup_download_directory(self):
        try:
            ...
            ColorPrint.red(f'Error setting download directory: {error}')
    ...
    async def setup_resource_collection(self):
        try:
            ...
            ColorPrint.red(f'[EnhancedPage] Failed to setup resource collection: {error}')
    ...
    async def collect_resources(self, options: Dict[str, Any] = None):
        ...
        try:
            ...
            ColorPrint.red(f'[EnhancedPage] Failed to collect resources: {error}')
            return None
    ...
    async def open_url(self, url: str, options: Dict[str, Any] = None):
        ...
        try:
            ...
            ColorPrint.red(f'Failed to open URL {url}: {error}')
            raise
    ...
    async def switch_to_page_by_index(self, index: int):
        try:
            ...
            ColorPrint.red(f'Failed to switch to page index {index}: {error}')
            raise
