...
PANEL_API_ROUTES = {
    ...
    "workspaceFiles": WORKSPACE_FILES_PATH,
    "workspaceFile": WORKSPACE_FILE_PATH,
    "workspaceDocuments": WORKSPACE_DOCUMENTS_PATH,
    "workspaceLatestDocument": WORKSPACE_LATEST_DOCUMENT_PATH,
}
...
__all__ = [
    ...
    "WORKSPACE_FILE_PATH",
    "WORKSPACE_LATEST_DOCUMENT_PATH",
    "WORKSPACE_PATH",
    "PANEL_API_ROUTES",
]
