...
Because it is run as a file, the repository root is added explicitly and the
canonical `pycore.pyutils.codesync.cli` module is imported. The parent package
initializers are markers, so this does not start the full Pycore runtime.
...
import pycore.pyutils.codesync.cli as codesync_cli  # noqa: E402

if __name__ == "__main__":
    raise SystemExit(codesync_cli.main(sys.argv[1:]))
