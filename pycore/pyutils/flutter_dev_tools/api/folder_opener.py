...
from pycore.pyfoundations.system_launcher import open_dir, open_file_with_notepad as _open_file_with_notepad
...
def open_file_with_notepad(file_path: Union[str, Path]) -> Dict[str, Any]:
    ...
    Delegates to pycore.pyfoundations.system_launcher.open_file_with_notepad.
    Accepts str or Path.
