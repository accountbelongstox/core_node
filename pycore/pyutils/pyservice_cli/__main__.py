...
Headless config CLI for pycore (no UI required).
    ...
    python -m pycore.pyutils.pyservice_cli config system get [--key K]
    python -m pycore.pyutils.pyservice_cli config system set (--key K --value V | --json '{...}')
    python -m pycore.pyutils.pyservice_cli config codesync show
    python -m pycore.pyutils.pyservice_cli config codesync role [dev|client]
    python -m pycore.pyutils.pyservice_cli config codesync peers list
    python -m pycore.pyutils.pyservice_cli config codesync peers add --name N --host H [--port 59000] [--role client]
    python -m pycore.pyutils.pyservice_cli config codesync peers remove --id ID
    python -m pycore.pyutils.pyservice_cli config codesync peers update --id ID [--name N] [--host H] [--port P] [--role R]
    python -m pycore.pyutils.pyservice_cli config codesync distribute (on|off)
    python -m pycore.pyutils.pyservice_cli config codesync skip-update (on|off)
