# =============================================================================
# Claude AI Launch Script #2 - v4 [team + opt-in ultracode]
# =============================================================================
# Auto-generated by Special Software Environment Manager.
# Reads encrypted secrets from .secret_keys/.secret_ignore/*_2.
...
$ultraSettingsFile = Join-Path $env:TEMP "claude2_ultracode_settings.json"

Write-Host ""
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host "Claude AI #2 - v4 [team + opt-in ultracode]" -ForegroundColor Yellow
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
...
# Load secrets from _2 files
$env:ANTHROPIC_BASE_URL = Read-SecretFile (Join-Path $secretDir "ANTHROPIC_BASE_URL_2")
$env:ANTHROPIC_AUTH_TOKEN = Read-SecretFile (Join-Path $secretDir "ANTHROPIC_AUTH_TOKEN_2")
$env:ANTHROPIC_API_KEY = Read-SecretFile (Join-Path $secretDir "ANTHROPIC_API_KEY_2")
$env:ANTHROPIC_MODEL = Read-SecretFile (Join-Path $secretDir "ANTHROPIC_MODEL_2")
...
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host "Press Enter to start Claude AI #2 [team + opt-in ultracode]..." -ForegroundColor Yellow
Write-Host "============================================================" -ForegroundColor Cyan
