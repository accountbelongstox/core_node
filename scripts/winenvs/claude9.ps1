...
$env:ANTHROPIC_BASE_URL = Get-SecretKey -KeyName "ANTHROPIC_BASE_URL_9"
...
$env:ANTHROPIC_AUTH_TOKEN = Get-SecretKey -KeyName "ANTHROPIC_AUTH_TOKEN_9"
...
$env:ANTHROPIC_API_KEY = Get-SecretKey -KeyName "ANTHROPIC_API_KEY_9"
