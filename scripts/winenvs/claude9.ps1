...
Write-Host "Running: claude9.ps1" -ForegroundColor Yellow
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
...
$env:ANTHROPIC_BASE_URL = Get-SecretValue "ANTHROPIC_BASE_URL_9"
...
$env:ANTHROPIC_AUTH_TOKEN = Get-SecretValue "ANTHROPIC_AUTH_TOKEN_9"
...
$env:ANTHROPIC_API_KEY = Get-SecretValue "ANTHROPIC_API_KEY_9"
