# =============================================================================
# Ark CLI (Volcano Ark / GLM) Launch Script #4 - v4 [arkcli -> Claude]
# =============================================================================
...
# Extra CLI args are forwarded to claude (e.g. ark4.ps1 -p "hi").
# =============================================================================
...
$ultraSettingsFile = Join-Path $env:TEMP "ark4_ultracode_settings.json"
...
Write-Host "Ark CLI (Volcano Ark / GLM) #4 - v4 [arkcli -> Claude]" -ForegroundColor Yellow
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
...
# Isolated Claude + arkcli user profile (map path: D:\programing\Users\ark4).
...
$arkUserDir = Join-Path $arkUserBase "ark4"
...
$arkcliProfile = Read-SecretFile (Join-Path $secretDir "ARKCLI_PROFILE_4")
$arkcliModel = Read-SecretFile (Join-Path $secretDir "ARKCLI_MODEL_4")
$arkcliMcpProfile = Read-SecretFile (Join-Path $secretDir "ARKCLI_MCP_PROFILE_4")
$arkcliOvResource = Read-SecretFile (Join-Path $secretDir "ARKCLI_OV_RESOURCE_4")
$arkcliApi = Read-SecretFile (Join-Path $secretDir "ARKCLI_API_4")
$arkcliApiKey = Read-SecretFile (Join-Path $secretDir "ARKCLI_API_KEY_4")
...
Write-Host "============================================================" -ForegroundColor Cyan
if ($usePlainClaude) {
    Write-Host "Press Enter to start Ark CLI (Volcano Ark / GLM) #4 [plain Claude / API KEY]..." -ForegroundColor Yellow
} else {
    Write-Host "Press Enter to start Ark CLI (Volcano Ark / GLM) #4 [arkcli -> Claude]..." -ForegroundColor Yellow
}
if (-not $enableTeam) {
    Write-Host "Tip: re-run with -team to enable Agent Teams (e.g. ark4.ps1 -team)" -ForegroundColor DarkGray
}
Write-Host "============================================================" -ForegroundColor Cyan
