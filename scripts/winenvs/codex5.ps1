...
Write-Host "Running: codex5.ps1" -ForegroundColor Yellow
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
...
$env:OPENAI_BASE_URL = Get-SecretKey -KeyName "OPENAI_BASE_URL_5"
...
Write-Host ""
Write-Host "[INFO] Executing: python -u `"$syncScript`" --target codex --working-dir `"$currentWorkingDir`"" -ForegroundColor Cyan
Write-Host "[INFO] Working Directory: $currentWorkingDir" -ForegroundColor Cyan
Write-Host ""

python -u "$syncScript" --target codex --working-dir "$currentWorkingDir"
