...
Write-Host "Running: codex2.ps1" -ForegroundColor Yellow
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
...
$env:OPENAI_API_KEY = Get-SecretValue "OPENAI_API_KEY_2"
...
$env:OPENAI_BASE_URL = Get-SecretValue "OPENAI_BASE_URL_2"
