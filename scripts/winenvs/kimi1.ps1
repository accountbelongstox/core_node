...
# Flow: isolate profile (D:\.tmp\Users\Kimi1) -> load secrets
...
# Isolated per-slot user profile: D:\.tmp\Users\Kimi1
$kimiUserDirPath = Join-Path $kimiUserBaseDirPath "Kimi1"
...
Write-Host "kimi1.ps1" -ForegroundColor Yellow
Write-Host "============================================================" -ForegroundColor Cyan
...
if ([string]::IsNullOrWhiteSpace($kimiApiKey)) {
    Write-Host "[WARN] KIMI_API_KEY_1 is empty; provider setup will fail." -ForegroundColor Yellow
}
