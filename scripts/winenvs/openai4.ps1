...
Write-Host "Running: openai4.ps1" -ForegroundColor Yellow
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
...
$env:OPENAI_API_BASE = Get-SecretKey -KeyName "OPENAI_API_BASE_4"
...
$env:OPENAI_API_KEY = Get-SecretKey -KeyName "OPENAI_API_KEY_4"
