# =============================================================================
# Ark CLI (Volcano Ark / GLM) Launch Script #7 - v4 [arkcli -> Claude]
# =============================================================================
...
# Extra CLI args are forwarded to claude (e.g. ark7.ps1 -p "hi").
# =============================================================================
...
$ultraSettingsFile = Join-Path $env:TEMP "ark7_ultracode_settings.json"
...
Write-Host "Ark CLI (Volcano Ark / GLM) #7 - v4 [arkcli -> Claude]" -ForegroundColor Yellow
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
...
# Isolated Claude + arkcli user profile (map path: D:\programing\Users\ark7).
...
$arkUserDir = Join-Path $arkUserBase "ark7"
...
$arkcliProfile = Read-SecretFile (Join-Path $secretDir "ARKCLI_PROFILE_7")
$arkcliModel = Read-SecretFile (Join-Path $secretDir "ARKCLI_MODEL_7")
$arkcliMcpProfile = Read-SecretFile (Join-Path $secretDir "ARKCLI_MCP_PROFILE_7")
$arkcliOvResource = Read-SecretFile (Join-Path $secretDir "ARKCLI_OV_RESOURCE_7")
$arkcliApi = Read-SecretFile (Join-Path $secretDir "ARKCLI_API_7")
$arkcliApiKey = Read-SecretFile (Join-Path $secretDir "ARKCLI_API_KEY_7")
...
Write-Host "============================================================" -ForegroundColor Cyan
if ($usePlainClaude) {
    Write-Host "Press Enter to start Ark CLI (Volcano Ark / GLM) #7 [plain Claude / API KEY]..." -ForegroundColor Yellow
} else {
    Write-Host "Press Enter to start Ark CLI (Volcano Ark / GLM) #7 [arkcli -> Claude]..." -ForegroundColor Yellow
}
if (-not $enableTeam) {
    Write-Host "Tip: re-run with -team to enable Agent Teams (e.g. ark7.ps1 -team)" -ForegroundColor DarkGray
}
Write-Host "============================================================" -ForegroundColor Cyan
