...
.DESCRIPTION
    Launches Claude Code using Volcano Ark (Doubao) API
...
$volcBaseUrl = ""
$volcApiKey = ""
$volcModel = "doubao-seed-code-preview-latest"
...
Write-Host "Claude AI (Volcano Ark / Doubao) - v3" -ForegroundColor Yellow
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
...
if ($volcApiKey) {
    ...
    $env:ANTHROPIC_API_KEY = $volcApiKey
}
...
if (-not $volcApiKey) {
    ...
    if ($volcApiKey.Length -gt 8) {
        $maskedKey = $volcApiKey.Substring(0, 4) + "***" + $volcApiKey.Substring($volcApiKey.Length - 4)
...
# Launch tool
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host "Press Enter to start Claude AI (Volcano Ark)..." -ForegroundColor Yellow
Write-Host "============================================================" -ForegroundColor Cyan
