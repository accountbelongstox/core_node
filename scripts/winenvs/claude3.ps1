...
<#
.SYNOPSIS
    Claude AI Environment Variables Global File #3
...
.NOTES
    ...
    - Generation Time: 2025-11-02 19:12:25
#>
...
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
$env:ANTHROPIC_BASE_URL = Get-SecretKey -KeyName "ANTHROPIC_BASE_URL_3"
...
$env:ANTHROPIC_AUTH_TOKEN = Get-SecretKey -KeyName "ANTHROPIC_AUTH_TOKEN_3"
...
$env:ANTHROPIC_API_KEY = Get-SecretKey -KeyName "ANTHROPIC_API_KEY_3"
