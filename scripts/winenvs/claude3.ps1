...
$ultraSettingsFile = Join-Path $env:TEMP "claude3_ultracode_settings.json"

Write-Host ""
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host "Claude AI #3 - v4 [team + opt-in ultracode]" -ForegroundColor Yellow
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
...
$env:ANTHROPIC_BASE_URL = Read-SecretFile (Join-Path $secretDir "ANTHROPIC_BASE_URL_3")
$env:ANTHROPIC_AUTH_TOKEN = Read-SecretFile (Join-Path $secretDir "ANTHROPIC_AUTH_TOKEN_3")
$env:ANTHROPIC_API_KEY = Read-SecretFile (Join-Path $secretDir "ANTHROPIC_API_KEY_3")
$env:ANTHROPIC_MODEL = Read-SecretFile (Join-Path $secretDir "ANTHROPIC_MODEL_3")
...
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host "Press Enter to start Claude AI #3 [team + opt-in ultracode]..." -ForegroundColor Yellow
Write-Host "============================================================" -ForegroundColor Cyan
