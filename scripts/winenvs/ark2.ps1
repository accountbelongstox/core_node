# =============================================================================
# Ark CLI (Volcano Ark / GLM) Launch Script #2 - v4 [arkcli -> Claude]
# =============================================================================
...
# Isolated user profile: D:\programing\Users\ark2
...
# Extra CLI args are forwarded to claude (e.g. ark2.ps1 -p "hi").
# =============================================================================
...
$ultraSettingsFile = Join-Path $env:TEMP "ark2_ultracode_settings.json"
...
Write-Host "Ark CLI (Volcano Ark / GLM) #2 - v4 [arkcli -> Claude]" -ForegroundColor Yellow
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
...
# Isolated Claude + arkcli user profile (map path: D:\programing\Users\ark2).
...
$arkUserDir = Join-Path $arkUserBase "ark2"
...
$arkcliProfile = Read-SecretFile (Join-Path $secretDir "ARKCLI_PROFILE_2")
$arkcliModel = Read-SecretFile (Join-Path $secretDir "ARKCLI_MODEL_2")
$arkcliMcpProfile = Read-SecretFile (Join-Path $secretDir "ARKCLI_MCP_PROFILE_2")
$arkcliOvResource = Read-SecretFile (Join-Path $secretDir "ARKCLI_OV_RESOURCE_2")
$arkcliApi = Read-SecretFile (Join-Path $secretDir "ARKCLI_API_2")
$arkcliApiKey = Read-SecretFile (Join-Path $secretDir "ARKCLI_API_KEY_2")
...
Write-Host "============================================================" -ForegroundColor Cyan
if ($usePlainClaude) {
    Write-Host "Press Enter to start Ark CLI (Volcano Ark / GLM) #2 [plain Claude / API KEY]..." -ForegroundColor Yellow
} else {
    Write-Host "Press Enter to start Ark CLI (Volcano Ark / GLM) #2 [arkcli -> Claude]..." -ForegroundColor Yellow
}
if (-not $enableTeam) {
    Write-Host "Tip: re-run with -team to enable Agent Teams (e.g. ark2.ps1 -team)" -ForegroundColor DarkGray
}
Write-Host "============================================================" -ForegroundColor Cyan
