# =============================================================================
# Ark CLI (Volcano Ark / GLM) Launch Script #5 - v4 [arkcli -> Claude]
# =============================================================================
...
# Extra CLI args are forwarded to claude (e.g. ark5.ps1 -p "hi").
# =============================================================================
...
$ultraSettingsFile = Join-Path $env:TEMP "ark5_ultracode_settings.json"
...
Write-Host "Ark CLI (Volcano Ark / GLM) #5 - v4 [arkcli -> Claude]" -ForegroundColor Yellow
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
...
# Isolated Claude + arkcli user profile (map path: D:\programing\Users\ark5).
...
$arkUserDir = Join-Path $arkUserBase "ark5"
...
$arkcliProfile = Read-SecretFile (Join-Path $secretDir "ARKCLI_PROFILE_5")
$arkcliModel = Read-SecretFile (Join-Path $secretDir "ARKCLI_MODEL_5")
$arkcliMcpProfile = Read-SecretFile (Join-Path $secretDir "ARKCLI_MCP_PROFILE_5")
$arkcliOvResource = Read-SecretFile (Join-Path $secretDir "ARKCLI_OV_RESOURCE_5")
$arkcliApi = Read-SecretFile (Join-Path $secretDir "ARKCLI_API_5")
$arkcliApiKey = Read-SecretFile (Join-Path $secretDir "ARKCLI_API_KEY_5")
...
Write-Host "============================================================" -ForegroundColor Cyan
if ($usePlainClaude) {
    Write-Host "Press Enter to start Ark CLI (Volcano Ark / GLM) #5 [plain Claude / API KEY]..." -ForegroundColor Yellow
} else {
    Write-Host "Press Enter to start Ark CLI (Volcano Ark / GLM) #5 [arkcli -> Claude]..." -ForegroundColor Yellow
}
if (-not $enableTeam) {
    Write-Host "Tip: re-run with -team to enable Agent Teams (e.g. ark5.ps1 -team)" -ForegroundColor DarkGray
}
Write-Host "============================================================" -ForegroundColor Cyan
