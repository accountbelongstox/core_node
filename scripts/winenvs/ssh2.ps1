...
.NOTES
    ...
    - SSH Connection: Loaded dynamically from secret key SSH_CONNECTION_2
    - File Number: 2
    - File Name: ssh2.ps1
#>
...
Write-Host "Running: ssh2.ps1" -ForegroundColor Yellow
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
...
$sshConnection = Get-SSHSecret "SSH_CONNECTION_2"
if ($sshConnection) {
