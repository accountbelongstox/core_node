...
const ENCRYPTED_DATA = Buffer.from('{{ENCRYPTED_DATA}}', 'base64');
const OBFUSCATED_PARAMS = Buffer.from('{{OBFUSCATED_PARAMS}}', 'base64');
const PARAMS_KEY = Buffer.from('{{PARAMS_KEY}}', 'base64');
const PARAMS_IV = Buffer.from('{{PARAMS_IV}}', 'base64');
