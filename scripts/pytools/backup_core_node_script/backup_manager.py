...
# Add pycore to path for color_print import
...
class BackupManager:
    def __init__(self):
        ...
        self.project_root = self.script_dir.parent.parent.parent  # Go up to core_node
    ...
    def start_backup(self):
        ...
        try:
            ...
            ColorPrint.cyan("Scanning files for backup...")
            total_files = 0
