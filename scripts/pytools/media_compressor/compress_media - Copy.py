...
class MediaCompressor:
    ...
    def __init__(self):
        ...
        if not self.CACHE_JSON.exists():
            self._write_cache_safe(self._create_empty_cache())
    ...
    def _update_cache_file(self, update_func, max_retries=5, retry_delay=1.0) -> bool:
        ...
        for attempt in range(max_retries):
            try:
                ...
                # Write
                if self._write_cache_safe(cache):
                    return True
...
def show_menu():
    ...
    print()
    print("7. Progressive Directory Deduplication")
    print("   - Scan all first-level directories in order")
    print("   - Optional: Set priority directory (e.g., 'evident')")
    print("   - Each directory vs subsequent directories")
    print("   - Supports videos, audios, images")
    print("   - Ensures NO duplicates in entire directory")
    print()
    print("8. Copy to External Drive (Smart Copy)")
    print("   - Copy from BaiduNetdiskDownload to E:\\Evidences")
    print("   - Compare file sizes before replacing")
    print("   - Skip Windows ' Copy' files")
    print("   - Clean up ' Copy' files after copying")
    print()
    print("9. Detect Corrupted Videos")
    print("   - Scan primary directory for corrupted video files")
    print("   - Move corrupted videos to _corrupted_videos subdirectory")
    print("   - Also move corresponding files from secondary directory")
...
def main():
    ...
    while True:
        ...
        if choice == '1':
            ...
            # Progressive directory deduplication (automatic)
            print("\n" + "="*60)
            print("Progressive Directory Deduplication")
            print("="*60)

            compressor.scan_and_deduplicate_progressive()
            ...
            compressor.copy_to_external_drive()
            ...
            compressor.detect_corrupted_videos()
