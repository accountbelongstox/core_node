...
"""
    ...
    def _handle_file_download(self, rel_path):
        ...
        try:
            ...
            print(f"Downloaded: {rel_path} (from byte {start_byte})")
...
class FileTransferClient:
    ...
    def download_file(self, rel_path: str, file_info: Dict) -> bool:
        ...
        try:
            ...
            elapsed = time.time() - start_time
            speed = expected_size / elapsed if elapsed > 0 else 0
