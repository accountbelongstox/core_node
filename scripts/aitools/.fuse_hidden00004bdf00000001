...
export ANTHROPIC_API_URL="http://claudeaicode.xyz/api"
...
$USE_SUDO ANTHROPIC_API_KEY="$ANTHROPIC_API_KEY" ANTHROPIC_API_URL="$ANTHROPIC_API_URL" "$NODE_BIN" "$CLAUDE_PATH" "$@"
