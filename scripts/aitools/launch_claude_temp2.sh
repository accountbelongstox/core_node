...
export ANTHROPIC_AUTH_TOKEN="88_3788a12e1e455efc96b09d29fb7b4281d0524a4dcc5cd95046ee2d0ffc402352"
...
$USE_SUDO ANTHROPIC_AUTH_TOKEN="$ANTHROPIC_AUTH_TOKEN" ANTHROPIC_BASE_URL="$ANTHROPIC_BASE_URL" "$NODE_BIN" "$CLAUDE_PATH" "$@"
