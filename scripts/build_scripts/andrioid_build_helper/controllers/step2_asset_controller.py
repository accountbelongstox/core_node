...
class Step2AssetController:
    ...
    def execute_step2(self, temp_build_root: Path, app_name: str, menu_helper: Any, auto_mode: bool = False) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            selected_images = self._process_final_images(selected_images, menu_helper, auto_mode)
    ...
    def _process_final_images(self, selected_images: Dict[str, Any], menu_helper: Any, auto_mode: bool = False) -> Dict[str, Any]:
        """Process final images using SmartImageSelector"""
        try:
            selected_images = self.smart_selector.show_final_summary_and_process(selected_images, menu_helper, auto_mode=auto_mode)
            return selected_images
        except Exception as e:
