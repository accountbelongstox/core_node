...
echo ""
echo "============================================================"
echo "Claude AI #5 - v4 [team + opt-in ultracode]"
echo "============================================================"
echo ""
...
ANTHROPIC_BASE_URL=$(read_secret_file "$secret_dir/ANTHROPIC_BASE_URL_5")
ANTHROPIC_AUTH_TOKEN=$(read_secret_file "$secret_dir/ANTHROPIC_AUTH_TOKEN_5")
ANTHROPIC_API_KEY=$(read_secret_file "$secret_dir/ANTHROPIC_API_KEY_5")
ANTHROPIC_MODEL=$(read_secret_file "$secret_dir/ANTHROPIC_MODEL_5")
...
echo "============================================================"
echo "Press Enter to start Claude AI #5 [team + opt-in ultracode]..."
echo "============================================================"
