...
echo ""
echo "============================================================"
echo "Claude AI #2 - v4 [team + opt-in ultracode]"
echo "============================================================"
echo ""
...
ANTHROPIC_BASE_URL=$(read_secret_file "$secret_dir/ANTHROPIC_BASE_URL_2")
ANTHROPIC_AUTH_TOKEN=$(read_secret_file "$secret_dir/ANTHROPIC_AUTH_TOKEN_2")
ANTHROPIC_API_KEY=$(read_secret_file "$secret_dir/ANTHROPIC_API_KEY_2")
ANTHROPIC_MODEL=$(read_secret_file "$secret_dir/ANTHROPIC_MODEL_2")
...
echo "============================================================"
echo "Press Enter to start Claude AI #2 [team + opt-in ultracode]..."
echo "============================================================"
