...
# Isolated user profile: /var/_core_node/Users/ark3
...
# Extra CLI args are forwarded to claude (e.g. ark3.sh -p "hi").
# =============================================================================
...
echo ""
echo "============================================================"
echo "Ark CLI (Volcano Ark / GLM) #3 - v4 [arkcli -> Claude]"
echo "============================================================"
echo ""
...
ark_user_dir="$ark_user_base/ark3"
...
arkcli_profile="$(read_secret_file "$secret_dir/ARKCLI_PROFILE_3")"
arkcli_model="$(read_secret_file "$secret_dir/ARKCLI_MODEL_3")"
arkcli_mcp_profile="$(read_secret_file "$secret_dir/ARKCLI_MCP_PROFILE_3")"
arkcli_ov_resource="$(read_secret_file "$secret_dir/ARKCLI_OV_RESOURCE_3")"
arkcli_api="$(read_secret_file "$secret_dir/ARKCLI_API_3")"
arkcli_api_key="$(read_secret_file "$secret_dir/ARKCLI_API_KEY_3")"
...
echo "============================================================"
if [ "$use_plain_claude" -eq 1 ]; then
    echo "Press Enter to start Ark CLI (Volcano Ark / GLM) #3 [plain Claude / API KEY]..."
else
    echo "Press Enter to start Ark CLI (Volcano Ark / GLM) #3 [arkcli -> Claude]..."
fi
if [ "$enable_team" -eq 0 ]; then
    echo "Tip: re-run with -team to enable Agent Teams (e.g. ark3.sh -team)"
fi
echo "============================================================"
