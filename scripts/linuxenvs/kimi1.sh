...
# =============================================================================
# Kimi Code CLI Launch Script #1 [Kimi For Coding]
# =============================================================================
# Auto-generated by Special Software Environment Manager.
# Flow: isolate profile (/var/_core_node/Users/Kimi1) -> load secrets
...
mcp_chrome_dev_log_path="/tmp/mcp-chrome-kimi1.log"
...
# Isolated per-slot user profile: /var/_core_node/Users/Kimi1
kimi_user_dir="/var/_core_node/Users/Kimi1"
if ! mkdir -p "$kimi_user_dir" 2>/dev/null; then
    kimi_user_dir="$HOME/.kimi_slots/Kimi1"
