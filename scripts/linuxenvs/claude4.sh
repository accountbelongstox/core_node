#!/bin/bash
# =============================================================================
# Claude AI Launch Script #4 - v4 [team + opt-in ultracode]
# =============================================================================
# Auto-generated by Special Software Environment Manager.
# Reads encrypted secrets from .secret_keys/.secret_ignore/*_4.
...
echo ""
echo "============================================================"
echo "Claude AI #4 - v4 [team + opt-in ultracode]"
echo "============================================================"
echo ""
...
ANTHROPIC_BASE_URL=$(read_secret_file "$secret_dir/ANTHROPIC_BASE_URL_4")
ANTHROPIC_AUTH_TOKEN=$(read_secret_file "$secret_dir/ANTHROPIC_AUTH_TOKEN_4")
ANTHROPIC_API_KEY=$(read_secret_file "$secret_dir/ANTHROPIC_API_KEY_4")
ANTHROPIC_MODEL=$(read_secret_file "$secret_dir/ANTHROPIC_MODEL_4")
...
echo "============================================================"
echo "Press Enter to start Claude AI #4 [team + opt-in ultracode]..."
echo "============================================================"
