...
# Isolated user profile: /var/_core_node/Users/ark5
...
# Extra CLI args are forwarded to claude (e.g. ark5.sh -p "hi").
# =============================================================================
...
echo ""
echo "============================================================"
echo "Ark CLI (Volcano Ark / GLM) #5 - v4 [arkcli -> Claude]"
echo "============================================================"
echo ""
...
ark_user_dir="$ark_user_base/ark5"
...
arkcli_profile="$(read_secret_file "$secret_dir/ARKCLI_PROFILE_5")"
arkcli_model="$(read_secret_file "$secret_dir/ARKCLI_MODEL_5")"
arkcli_mcp_profile="$(read_secret_file "$secret_dir/ARKCLI_MCP_PROFILE_5")"
arkcli_ov_resource="$(read_secret_file "$secret_dir/ARKCLI_OV_RESOURCE_5")"
arkcli_api="$(read_secret_file "$secret_dir/ARKCLI_API_5")"
arkcli_api_key="$(read_secret_file "$secret_dir/ARKCLI_API_KEY_5")"
...
echo "============================================================"
if [ "$use_plain_claude" -eq 1 ]; then
    echo "Press Enter to start Ark CLI (Volcano Ark / GLM) #5 [plain Claude / API KEY]..."
else
    echo "Press Enter to start Ark CLI (Volcano Ark / GLM) #5 [arkcli -> Claude]..."
fi
if [ "$enable_team" -eq 0 ]; then
    echo "Tip: re-run with -team to enable Agent Teams (e.g. ark5.sh -team)"
fi
echo "============================================================"
