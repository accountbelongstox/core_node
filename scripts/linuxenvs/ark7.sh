...
# Isolated user profile: /var/_core_node/Users/ark7
...
# Extra CLI args are forwarded to claude (e.g. ark7.sh -p "hi").
# =============================================================================
...
echo ""
echo "============================================================"
echo "Ark CLI (Volcano Ark / GLM) #7 - v4 [arkcli -> Claude]"
echo "============================================================"
echo ""
...
ark_user_dir="$ark_user_base/ark7"
...
arkcli_profile="$(read_secret_file "$secret_dir/ARKCLI_PROFILE_7")"
arkcli_model="$(read_secret_file "$secret_dir/ARKCLI_MODEL_7")"
arkcli_mcp_profile="$(read_secret_file "$secret_dir/ARKCLI_MCP_PROFILE_7")"
arkcli_ov_resource="$(read_secret_file "$secret_dir/ARKCLI_OV_RESOURCE_7")"
arkcli_api="$(read_secret_file "$secret_dir/ARKCLI_API_7")"
arkcli_api_key="$(read_secret_file "$secret_dir/ARKCLI_API_KEY_7")"
...
echo "============================================================"
if [ "$use_plain_claude" -eq 1 ]; then
    echo "Press Enter to start Ark CLI (Volcano Ark / GLM) #7 [plain Claude / API KEY]..."
else
    echo "Press Enter to start Ark CLI (Volcano Ark / GLM) #7 [arkcli -> Claude]..."
fi
if [ "$enable_team" -eq 0 ]; then
    echo "Tip: re-run with -team to enable Agent Teams (e.g. ark7.sh -team)"
fi
echo "============================================================"
