...
echo "[$SCRIPT_INDEX]   1. Run 135_setup_domain_ssl.sh to add SSL certificates"
echo "[$SCRIPT_INDEX]   2. Run 136_setup_api_domains.sh to setup API domains"
echo "[$SCRIPT_INDEX]   3. Run 137_setup_html_domains.sh to setup HTML domains"
echo "[$SCRIPT_INDEX] =================================="
