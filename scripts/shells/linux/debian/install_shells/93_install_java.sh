...
SCRIPT_TEMP_DIR=$(create_script_temp_dir "56_install_java")
...
install_java() {
    ...
    safe_chown_R root:root "$JAVA_INSTALL_DIR/jdk-${JAVA_VERSION}"
    safe_chmod_R 755 "$JAVA_INSTALL_DIR/jdk-${JAVA_VERSION}"
