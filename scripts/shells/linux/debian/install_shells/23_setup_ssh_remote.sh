...
install_ssh_server() {
    ...
    # Git (GitHub/Gitee) SSH KEYS are a SEPARATE concern -- see 27_install_git_ssh.sh.
    case "${SSH_AUTO_INSTALL_SERVER:-0}" in
        ...
        *)
            ...
            print_info_from_common_functions "To install the SSH server explicitly: SSH_AUTO_INSTALL_SERVER=1 bash 23_setup_ssh_remote.sh"
            print_info_from_common_functions "For Git GitHub/Gitee SSH keys, use 27_install_git_ssh.sh instead."
            return 2
            ;;
    esac
