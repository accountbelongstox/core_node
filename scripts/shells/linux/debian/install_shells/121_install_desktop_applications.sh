...
#
# Usage:
#   ./122_install_desktop_applications.sh                    # Normal installation using config flags
#   ./122_install_desktop_applications.sh DEV               # Test install DEV package group (UPPERCASE = group)
#   ./122_install_desktop_applications.sh code              # Test install apps containing "code" in name (lowercase = app)
#   ./122_install_desktop_applications.sh DEV firefox       # Test install "firefox" apps from DEV group
#   ./122_install_desktop_applications.sh --cleanup code    # Force cleanup "code" from all package managers
#
# Parameter Rules:
...
SCRIPT_TEMP_DIR=$(create_script_temp_dir "122_install_desktop_applications")
...
refresh_environment() {
    ...
    # linked by install_shells/133_install_claude_code.sh (native workflow).
...
# Generated by 122_install_desktop_applications.sh
# Package: $package_id
