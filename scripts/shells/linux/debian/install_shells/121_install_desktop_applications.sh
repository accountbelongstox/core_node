...
#
# Usage:
#   ./121_install_desktop_applications.sh                    # Normal installation using config flags
#   ./121_install_desktop_applications.sh DEV               # Test install DEV package group (UPPERCASE = group)
#   ./121_install_desktop_applications.sh code              # Test install apps containing "code" in name (lowercase = app)
#   ./121_install_desktop_applications.sh DEV firefox       # Test install "firefox" apps from DEV group
#   ./121_install_desktop_applications.sh --cleanup code    # Force cleanup "code" from all package managers
#
# Parameter Rules:
...
refresh_environment() {
    ...
    # linked by install_shells/130_install_claude_code.sh (native workflow).
...
# Generated by 121_install_desktop_applications.sh
# Package: $package_id
