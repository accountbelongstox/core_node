...
HARNESS_SETTINGS_SCRIPT="$PARENT_DIR_LEVEL_2/common/pi_harness_settings.js"
...
install_pi_harness() {
    if [ -x "$PI_BIN" ] || [ -x "$PI_LINK" ]; then
        ...
        echo "[$SCRIPT_INDEX] WARNING: pnpm is unavailable. Run 17_install_node_toolchain_24.sh first."
    else
