...
#   - standalone `24_install_tts_offline.sh`    -> CORE + UMBRELLA (default engines only).
...
#   24_install_tts_offline.sh [--python <py>] [--force] [--core-only] [--melotts] [--gptsovits]
...
# This mirrors the proven 23_install_edge_tts.sh / 13_ensure_python.sh ordering.
...
EDGE_TTS_SCRIPT="$SCRIPT_DIR/23_install_edge_tts.sh"
FASTER_WHISPER_SCRIPT="$SCRIPT_DIR/16_install_faster_whisper.sh"
