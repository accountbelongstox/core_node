...
manage_natgateway() {
    ...
    local natgateway_script="$CORE_NODE_ROOT_DIR/scripts/shells/linux/debian/install_shells/103_natgateway.sh"
...
EOF
        ...
        echo "  bash $CORE_NODE_ROOT_DIR/scripts/shells/linux/debian/install_shells/129_setup_gnome_rdp.sh"
    fi
