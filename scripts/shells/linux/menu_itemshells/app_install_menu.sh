...
SCRIPT_INSTALL_ENTRIES=(
    ...
    "script:93_install_java.sh|Java"
    "script:91_install_golang22.sh|Go 1.22"
    ...
    "script:49_install_frankenphp.sh|FrankenPHP"
    "script:89_install_tailscale.sh|Tailscale (VPN)"
