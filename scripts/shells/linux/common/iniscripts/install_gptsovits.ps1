...
# parent-of-repo (where .data\pycore\gptsovits actually lives). Old location
# pycore\scripts\iniscripts used ..\..\..\.. (4 up = parent of repo root); from the new
# location (scripts\shells\linux\common\iniscripts, 5 below repo root) that same target is SIX up.
