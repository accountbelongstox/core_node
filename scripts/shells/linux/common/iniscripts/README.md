...
pyservice.ps1 / pyservice.sh          (repo-root entry point — ONLY an entry point)
        ...
        ▼
scripts/shells/linux/common/iniscripts/prepare.ps1 / prepare.sh   (orchestrator)
...
bash scripts/shells/linux/common/iniscripts/install_whisper.sh --python python3 --model base
```
