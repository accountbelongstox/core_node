...
CORE_NODE_RUNTIME_CACHE_DIR="$CORE_NODE_DATA_DIR/cache"
CORE_NODE_RUNTIME_DATA_DIR="$CORE_NODE_DATA_DIR/data"
CORE_NODE_INSTALLER_CACHE_DIR="$CORE_NODE_RUNTIME_CACHE_DIR/installer"
CORE_NODE_INSTALLER_STATE_DIR="$CORE_NODE_RUNTIME_DATA_DIR/installer"
CORE_NODE_APP_VERSIONS_DIR="$CORE_NODE_INSTALLER_STATE_DIR/app_versions"
CORE_NODE_GLOBAL_VAR_DIR="$CORE_NODE_DATA_DIR/global_var"
CORE_NODE_UNIFIED_MANAGER_DIR="$CORE_NODE_DATA_DIR/unified_manager"
CORE_NODE_UNIFIED_MANAGER_LAUNCHER_DIR="$CORE_NODE_UNIFIED_MANAGER_DIR/temp_scripts"
CORE_NODE_FILE_CACHE_DIR="$CORE_NODE_INSTALLER_CACHE_DIR/file_cache"
CORE_NODE_BEHAVIOR_CACHE_DIR="$CORE_NODE_INSTALLER_CACHE_DIR/behavior_cache"
CORE_NODE_DIRECTORY_PROCESSING_CACHE_DIR="$CORE_NODE_INSTALLER_CACHE_DIR/dir_processing_cache"
CORE_NODE_SECRET_CACHE_DIR="$CORE_NODE_INSTALLER_CACHE_DIR/secret_cache"
CORE_NODE_STEP_STATE_DIR="$CORE_NODE_INSTALLER_STATE_DIR/step_state"
CORE_NODE_LEGACY_FILE_CACHE_DIR="$CORE_NODE_GLOBAL_VAR_DIR/file_cache"
CORE_NODE_LEGACY_BEHAVIOR_CACHE_DIR="$CORE_NODE_GLOBAL_VAR_DIR/behavior_cache"
CORE_NODE_LEGACY_DIRECTORY_PROCESSING_CACHE_DIR="$CORE_NODE_GLOBAL_VAR_DIR/dir_processing_cache"
CORE_NODE_LEGACY_SECRET_CACHE_DIR="$CORE_NODE_GLOBAL_VAR_DIR/secret_cache"
CORE_NODE_LEGACY_STEP_STATE_DIR="$CORE_NODE_GLOBAL_VAR_DIR/step_state"
CORE_NODE_LEGACY_APP_VERSIONS_DIR="$CORE_NODE_GLOBAL_VAR_DIR/app_versions"
...
export CORE_NODE_RUNTIME_CACHE_DIR
export CORE_NODE_RUNTIME_DATA_DIR
export CORE_NODE_INSTALLER_CACHE_DIR
export CORE_NODE_INSTALLER_STATE_DIR
export CORE_NODE_APP_VERSIONS_DIR
export CORE_NODE_UNIFIED_MANAGER_DIR
export CORE_NODE_UNIFIED_MANAGER_LAUNCHER_DIR
export CORE_NODE_GLOBAL_VAR_DIR
export CORE_NODE_FILE_CACHE_DIR
export CORE_NODE_BEHAVIOR_CACHE_DIR
export CORE_NODE_DIRECTORY_PROCESSING_CACHE_DIR
export CORE_NODE_SECRET_CACHE_DIR
export CORE_NODE_STEP_STATE_DIR
export CORE_NODE_LEGACY_FILE_CACHE_DIR
export CORE_NODE_LEGACY_BEHAVIOR_CACHE_DIR
export CORE_NODE_LEGACY_DIRECTORY_PROCESSING_CACHE_DIR
export CORE_NODE_LEGACY_SECRET_CACHE_DIR
export CORE_NODE_LEGACY_STEP_STATE_DIR
export CORE_NODE_LEGACY_APP_VERSIONS_DIR
