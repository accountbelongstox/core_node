...
$SCRIPT_STEP17_CHECK_CORE_NODE_PROJECT = "Step17_CheckCoreNodeProject.ps1"
...
$InstallerScriptsMap = @{
    ...
    "CheckCoreNodeProject" = $SCRIPT_STEP17_CHECK_CORE_NODE_PROJECT
...
$InstallerScripts = @(
    ...
    $SCRIPT_STEP17_CHECK_CORE_NODE_PROJECT,
