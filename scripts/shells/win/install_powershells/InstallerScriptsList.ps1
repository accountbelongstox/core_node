...
$SCRIPT_STEP41_INSTALL_QWEN_CODE = "Step41_InstallQwenCode.ps1"
$SCRIPT_STEP42_INSTALL_ARK_CLI = "Step42_InstallArkCli.ps1"
$SCRIPT_STEP43_INSTALL_ZHIPU_CLI = "Step43_InstallZhipuCli.ps1"
...
$InstallerScriptsMap = @{
    ...
    "InstallQwenCode" = $SCRIPT_STEP41_INSTALL_QWEN_CODE
    "InstallArkCli" = $SCRIPT_STEP42_INSTALL_ARK_CLI
    "InstallZhipuCli" = $SCRIPT_STEP43_INSTALL_ZHIPU_CLI
}
...
$InstallerScripts = @(
    ...
    $SCRIPT_STEP41_INSTALL_QWEN_CODE,
    $SCRIPT_STEP42_INSTALL_ARK_CLI,
    $SCRIPT_STEP43_INSTALL_ZHIPU_CLI
)
