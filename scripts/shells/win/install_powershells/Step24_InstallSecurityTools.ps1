...
function Step24_AcceptSecurityToolsEula {
...
function Step24_ExtractSecurityTools {
...
function Step24_LinkSecurityToolsToWinEnvs {
...
function Step24_LinkSecurityHelperScripts {
...
function Step24_InstallSecurityTools {
    ...
    Step24_AcceptSecurityToolsEula
    ...
    Step24_LinkSecurityToolsToWinEnvs
    Step24_LinkSecurityHelperScripts
