...
$FILES = @(
    ...
    'scripts/shells/win/install_powershells/Step7_InstallScoopWithChinaMirror.ps1',
    'scripts/shells/win/install_powershells/Step8_ExtendWindowsUpdate.ps1',
    'scripts/shells/win/install_powershells/Step8_InstallPHP.ps1',
    'scripts/shells/win/install_powershells/Step9_DV.ps1',
    'scripts/shells/win/install_powershells/Step10_SetFileAssociations.ps1',
    'scripts/shells/win/install_powershells/Step12_Install7ipBase.ps1',
    'scripts/shells/win/install_powershells/Step13_InstallApplications.ps1',
    'scripts/shells/win/install_powershells/Step14_CheckCoreNodeProject.ps1',
    'scripts/shells/win/install_powershells/Step27_InstallChrome.ps1',
    'scripts/shells/win/install_powershells/Step28_InstallPuppeteerPlugins.ps1',
    'scripts/shells/win/install_powershells/Step48_InstallApkTool.ps1',
    'scripts/shells/win/install_powershells/Step57_InstallAndroidStudio.ps1',
    'scripts/shells/win/install_powershells/Step58_InstallAndroidPlatformTools.ps1',
    'scripts/shells/win/install_powershells/Step67_InstallFlutter.ps1',
    'scripts/shells/win/install_powershells/Step81_InstallWSL.ps1',
    'scripts/shells/win/install_powershells/Step82_InstallWSLUbuntu24.ps1',
    'scripts/shells/win/install_powershells/Step83_SetRootLoginWSLUbuntuDebian.ps1',
    'scripts/shells/win/install_powershells/Step84_InstallVisualStudio.ps1',
    'scripts/shells/win/install_powershells/Step85_InstallQtBuildTools.ps1',
    'scripts/shells/win/install_powershells/Step86_InstallQt.ps1',
    'scripts/shells/win/install_powershells/Step91_InstallQtOfficial.ps1',
    'scripts/shells/win/install_powershells/Step96_InstallDeepSeek.ps1',
    'scripts/shells/win/install_powershells/Step97_InstallDeepSeekOCR.ps1',
    'scripts/shells/win/install_powershells/Step98_InstallQwen25.ps1',
    'scripts/shells/win/install_powershells/Step99_InstallNLLB200.ps1',
    ...
    'scripts/shells/win/install_powershells/postinstall/PythonPostInstallProcessor.ps1',
