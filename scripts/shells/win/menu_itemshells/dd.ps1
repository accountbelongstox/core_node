...
.NOTES
    ...
    - Python: Prefer $Global:PYTHON_EXE_PATH from win_common/GlobalVars.ps1 (set by Run DevInstaller / Step8_InstallDefaultPython.ps1)
#>
...
if (-not $pythonExe) {
    ...
    Write-Host "Install via: Installer Menu -> Run DevInstaller (Step8_InstallDefaultPython.ps1)." -ForegroundColor Yellow
