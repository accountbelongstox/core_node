...
if ('D:\programing\core_node\scripts\shells\win\menu_itemshells\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('D:\programing\core_node\scripts\shells\win\menu_itemshells\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
