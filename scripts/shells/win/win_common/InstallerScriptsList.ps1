...
$SCRIPT_STEP13_INSTALL_PYTHON310 = "Step13_InstallPython310.ps1"
...
$SCRIPT_STEP48_INSTALL_DESKTOP_MANAGER = "Step48_InstallDesktopManager.ps1"
...
$InstallerScriptsMap = @{
    ...
    "InstallDesktopManager" = $SCRIPT_STEP48_INSTALL_DESKTOP_MANAGER
...
$InstallerScripts = @(
    ...
    $SCRIPT_STEP48_INSTALL_DESKTOP_MANAGER,
