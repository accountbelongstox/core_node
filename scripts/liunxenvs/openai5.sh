...
load_secret_value "OPENAI_API_BASE_5" "OPENAI_API_BASE" "OPENAI_API_BASE"
load_secret_value "OPENAI_API_KEY_5" "OPENAI_API_KEY" "OPENAI_API_KEY"
...
echo "OpenAI - Pre-Launch Tasks"
echo ""

# Execute pre-launch script if it exists
preLaunchScript="$aiToolsDirPath/openai_pre_launch.sh"
...
echo "  [1] Upgrade OpenAI to latest version (runs in separate terminal)"
echo "  [2] Sync MCP server configurations (runs now)"
echo ""

read -p "Do you want to upgrade OpenAI? (y/N): " upgrade_choice
if [ "$upgrade_choice" = "y" ] || [ "$upgrade_choice" = "Y" ]; then
    echo ""
    echo "[INFO] Launching OpenAI upgrade in separate terminal..."
    upgrade_script="$aiToolsDirPath/openai_update.sh"
...
echo ""
sync_script="$aiToolsDirPath/openai_sync_mcp_servers.py"
if [ -f "$sync_script" ]; then
    echo "[INFO] Executing: python -u '$sync_script' --target openai --working-dir '$current_working_dir'"
    echo "[INFO] Working Directory: $current_working_dir"
    echo ""
    ...
    $PYTHON_CMD -u "$sync_script" --target openai --working-dir "$current_working_dir"
else
...
echo ""
echo "============================================================"
echo "Press Enter to start OpenAI..."
echo "============================================================"
