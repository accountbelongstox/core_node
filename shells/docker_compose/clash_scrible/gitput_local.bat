...
set new_remote=ssh://git@git.local.12gm.com:5022/adminroot/clash_subscribe.git
...
REM Check for node_spider directory and execute gitput_local.bat if it exists
@REM if exist "node_spider" (
@REM     echo "node_spider directory found. Executing gitput_local.bat..."
@REM     cd /d "node_spider"
@REM     call gitput_local.bat
@REM ) else (
@REM     echo "node_spider directory not found."
@REM )
