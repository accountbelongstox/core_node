...
import { MobileLayout, GlassCard } from '@/apps/awy/awy_components/Shared';
      ...
      <View style={localStyles.content}>
        ...
        <View style={localStyles.actionsRow}>
          ...
          >
            <GlassCard style={localStyles.actionCardInner}>
              ...
              <Text style={[localStyles.actionCardText, { color: colors.textPrimary }]}>
                {t('friend.myCode')}
              </Text>
            </GlassCard>
          </TouchableOpacity>
        ...
        <GlassCard style={localStyles.settingsCard}>
          ...
          <MenuItem 
            ...
            value={language === 'en' ? t('common.english') : t('common.chinese')} 
          />
        </GlassCard>
        ...
        >
          ...
          <Text style={localStyles.logoutText}>{t('profile.logout')}</Text>
        </TouchableOpacity>
      </View>
    </MobileLayout>
  );
