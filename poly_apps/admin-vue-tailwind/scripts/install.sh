...
echo "[INFO] Installing dependencies for Admin Vue Tailwind application"
...
if npm install; then
    echo "[SUCCESS] Dependencies installed successfully for admin-vue-tailwind"
else
    echo "[ERROR] Failed to install dependencies for admin-vue-tailwind"
    exit 1
fi
