/**
 * WfLibraryPlayback - top-to-bottom word playback engine for the library table.
 *
 * Mirrors WfBookReaderPlayback but simpler: each node is ONE word (single
...
export class WfLibraryPlayback {
  ...
  constructor(private readonly deps: WfLibraryPlaybackDeps) {}
