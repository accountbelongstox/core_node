/**
 * WfBookReaderPlayback — bilingual sequence playback engine for the book reader.
...
} from './WfBookReaderSpeech';

export interface WfBookReaderPlaybackSettings {
...
export class WfBookReaderPlayback {
  ...
  constructor(private readonly deps: WfBookReaderPlaybackDeps) {}
