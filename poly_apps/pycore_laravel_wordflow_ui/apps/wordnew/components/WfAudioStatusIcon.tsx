...
export interface WfAudioStatusIconProps {
  state: WfAudioCellState;
  onClick?: () => void;
  disabled?: boolean;
  title?: string;
  size?: 'sm' | 'md';
...
export const WfAudioStatusIcon: React.FC<WfAudioStatusIconProps> = ({
...
export default WfAudioStatusIcon;
