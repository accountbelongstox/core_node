/**
 * WfLibraryWordRow - one row of the library word table. Mirrors
 * WfBookReaderVerseRow: three-state audio icon, multi-audio variant picker,
 * click-to-play (routed through WfLibraryPlayback), expandable detail.
 */
import React from 'react';
import {
  ChevronDown, ChevronUp, Image as ImageIcon, BookOpen, Volume2, Languages,
} from 'lucide-react';
import type { WfNewLibraryWord, WfNewWordMedia, WfAudioFileVariant } from '../../api';
...
import { pickSentenceAudioUrl, readySentenceVariants } from '../../utils/WfSentenceAudioPick';
import { buildWordCell } from '../../utils/WfLibraryWordCell';

export interface WfLibraryWordRowProps {
...
export const WfLibraryWordRow: React.FC<WfLibraryWordRowProps> = ({
  ...
  const pickerVariants: WfAudioFileVariant[] = readySentenceVariants(cell);
...
export default WfLibraryWordRow;
