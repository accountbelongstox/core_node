/* [v4.1-Iris] About — ported from qy_capacitor/pages/Settings/About.tsx.
 * Self-contained: useNavigate + wfPath() for in-app nav, window.open for
 * external links, useWfApp().t for copy, shared Iris primitives from WfUI.
...
const WfSettingsAboutPage: React.FC = () => {
  const navigate = useNavigate();
  const { t } = useWfApp();

  const openLink = (url: string) => {
    try { window.open(url, '_blank', 'noopener,noreferrer'); } catch (e) {
      console.error('[WfSettingsAbout] open link failed:', e);
    }
  };
      ...
      <div className="relative w-full max-w-md mx-auto px-[var(--page-padding-h)] pt-[var(--page-padding-v)] pb-[var(--space-breath)]">
        ...
        >
          ...
          <div className="relative flex flex-col items-center text-center py-4">
            <div className="w-24 h-24 bg-white/15 rounded-3xl flex items-center justify-center text-5xl font-black mb-4">W</div>
      ...
      <div className="relative w-full max-w-md mx-auto px-[var(--page-padding-h)] ds-section-gap">
        ...
        <div className="ds-stack-tight flex flex-col">
          <InfoItem
            ...
            onClick={() => navigate(wfPath('settings_statistics'))}
          />
        </div>
        ...
        <div className="ds-stack-tight flex flex-col">
          ...
          <InfoItem
            ...
            onClick={() => openLink('https://wordflow.ai/terms')}
            icon={
              <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <InfoItem
            ...
            onClick={() => openLink('https://wordflow.ai/privacy')}
            icon={
              <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <InfoItem
            ...
            onClick={() => openLink('https://github.com/wordflow-ai')}
            icon={
              <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="ds-stack-tight flex flex-col">
          ...
          <InfoItem
            ...
            value="wordflow.ai"
            onClick={() => openLink('https://wordflow.ai')}
            icon={
              <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <InfoItem
            label={t('settings.twitter') || 'Twitter'}
            value="@wordflow"
            onClick={() => openLink('https://twitter.com/wordflow')}
            icon={
          ...
          <InfoItem
            ...
            onClick={() => openLink('mailto:support@wordflow.ai')}
            icon={
              <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default WfSettingsAboutPage;
