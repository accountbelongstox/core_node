...
const PcLaravelMediaPanel: React.FC = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener(PYCORE_LARAVEL_API_CHANGED_EVENT, onEndpointChanged);
    return () => window.removeEventListener(PYCORE_LARAVEL_API_CHANGED_EVENT, onEndpointChanged);
  }, [fetchedOnce, refresh]);
