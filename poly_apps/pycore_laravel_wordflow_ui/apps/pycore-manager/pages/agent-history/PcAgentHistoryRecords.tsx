          ...
          {records.map((r) => (
            <li key={r.id} className="rounded-xl border border-slate-200/80 dark:border-white/5 bg-white/60 dark:bg-white/[0.02] px-4 py-3 space-y-2">
              <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
                ...
                <span className={`ml-auto inline-flex items-center px-2 py-0.5 rounded-md text-[11px] font-semibold border ${
                  r.uploaded
              ...
              {r.audio_available && (
                <audio
                  controls
                  preload="none"
                  src={pycoreApi.getAgentHistoryArticleAudioUrl(r.id)}
