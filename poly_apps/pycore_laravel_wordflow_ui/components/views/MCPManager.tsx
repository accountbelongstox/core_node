...
import { LoadingBlock, InlineSpinner, EmptyState, AlertBox, FileDropzone, StatusBadge, Field } from '../common';
...
const MCPManager: React.FC<MCPManagerProps> = ({ lang = 'en', allowedTabs }) => {
  ...
  // Copy to clipboard helper (delegates to useClipboard: handles secure-context
  // check + textarea/execCommand fallback + failure toast internally).
  const copyToClipboard = async (text: string): Promise<void> => {
    await copy(text, t.screenshots.toast.copied);
  };
