import { subscribe as wsSubscribe, dispatchEvent as wsDispatch } from './PycoreWs';
  ...
  subscribe<T = any>(
    ...
    const wrapped: PycoreEventHandler<T> = (payload: T) => {
      ...
      try {
        ...
        // PycoreWs.ts already isolates per-handler exceptions, but keep this
