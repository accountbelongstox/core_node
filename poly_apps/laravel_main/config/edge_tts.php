...
return [
    'supported_locales' => [
        ...
        'az-AZ', 'bg-BG', 'bn-BD', 'bn-IN', 'bs-BA', 'ca-ES', 'cs-CZ', 'cy-GB', 'da-DK', 'de-AT', 'de-CH', 'de-DE',
        'el-GR', 'en-AU', 'en-CA', 'en-GB', 'en-HK', 'en-IE', 'en-IN', 'en-KE', 'en-NG', 'en-NZ', 'en-PH', 'en-SG', 'en-TZ', 'en-US', 'en-ZA',
        ...
        'et-EE', 'eu-ES', 'fa-IR', 'fi-FI', 'fil-PH', 'fr-BE', 'fr-CA', 'fr-CH', 'fr-FR', 'ga-IE', 'gl-ES', 'gu-IN',
        'he-IL', 'hi-IN', 'hr-HR', 'hu-HU', 'hy-AM', 'id-ID', 'is-IS', 'it-IT', 'ja-JP', 'jv-ID', 'ka-GE',
        'kk-KZ', 'km-KH', 'kn-IN', 'ko-KR', 'lo-LA', 'lt-LT', 'lv-LV', 'mk-MK', 'ml-IN', 'mn-MN', 'mr-IN', 'ms-MY',
        'mt-MT', 'my-MM', 'nb-NO', 'ne-NP', 'nl-BE', 'nl-NL', 'or-IN', 'pa-IN', 'pl-PL', 'ps-AF', 'pt-BR', 'pt-PT',
        'ro-RO', 'ru-RU', 'si-LK', 'sk-SK', 'sl-SI', 'so-SO', 'sq-AL', 'sr-RS', 'su-ID', 'sv-SE', 'sw-KE', 'sw-TZ',
        'ta-IN', 'ta-LK', 'ta-MY', 'ta-SG', 'te-IN', 'th-TH', 'tr-TR', 'uk-UA', 'ur-IN', 'ur-PK', 'uz-UZ',
        'vi-VN', 'wuu-CN', 'yue-CN', 'zh-CN', 'zh-HK', 'zh-TW', 'zu-ZA',
    ],
    ...
    'lang_code_mapping' => [
        ...
        'id' => 'id-ID', 'is' => 'is-IS', 'it' => 'it-IT', 'ja' => 'ja-JP', 'jv' => 'jv-ID',
        ...
        'nb' => 'nb-NO', 'ne' => 'ne-NP', 'nl' => 'nl-NL', 'or' => 'or-IN', 'pa' => 'pa-IN',
        'pl' => 'pl-PL', 'ps' => 'ps-AF', 'pt' => 'pt-PT', 'ro' => 'ro-RO', 'ru' => 'ru-RU',
        'si' => 'si-LK', 'sk' => 'sk-SK', 'sl' => 'sl-SI', 'so' => 'so-SO', 'sq' => 'sq-AL',
        'sr' => 'sr-RS', 'su' => 'su-ID', 'sv' => 'sv-SE', 'sw' => 'sw-KE', 'ta' => 'ta-IN',
        'te' => 'te-IN', 'th' => 'th-TH', 'tr' => 'tr-TR', 'uk' => 'uk-UA', 'ur' => 'ur-PK',
        'uz' => 'uz-UZ', 'vi' => 'vi-VN', 'wuu' => 'wuu-CN', 'yue' => 'yue-CN', 'zh' => 'zh-CN', 'zu' => 'zu-ZA',
    ],
