...
class DictV1WordGroupManagementController 
{

    public function isGroupNameExist($gname)
    {
        $uid = Auth::id();
        $group = DictV1WordGroupModel::where('gname', $gname)->where('uid', $uid)->first();
        return $group;
    }
    ...
    public function getGroupByGid(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $uid = Auth::id();
            $group = DictV1WordGroupModel::where('gid', $gid)
                ->where('uid', $user->id)
                ->first();
    ...
    public function getGroupByName(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $group = DictV1WordGroupModel::where('gname', $gname)
                ->where('uid', $user->id)
                ->first();
    ...
    public function getAllGroupByManager(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $groups = DictV1WordGroupModel::orderBy('created_at', 'desc')
                ->skip($start)
                ->take($limit)
                ->get()
