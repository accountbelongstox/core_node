 ...
 */
class DictV1ExternalStorageManager
{
    ...
    public function __construct()
    {
        ...
        $this->externalDataPath = Config::get('dictv1.paths.external_data_root');
        $this->databasesPath = dirname(Config::get('dictv1.paths.legacy_database'));
        $this->audioPath = dirname(Config::get('dictv1.paths.audio_directory'));
        $this->imagesPath = dirname(Config::get('dictv1.paths.images_directory'));
        $this->cachePath = Config::get('dictv1.paths.cache_directory');
        $this->markersPath = Config::get('dictv1.paths.markers_directory');
    }
    ...
    {
        return Config::get('dictv1.paths.legacy_database');
    }
    ...
    {
        return Config::get('dictv1.paths.audio_archive');
    }
    ...
    {
        return Config::get('dictv1.paths.images_archive');
    }
    ...
    {
        return Config::get('dictv1.paths.audio_directory');
    }
    ...
    {
        return Config::get('dictv1.paths.audio_subtitles');
    }
    ...
    {
        return Config::get('dictv1.paths.sentence_sounds');
    }
    ...
    {
        return Config::get('dictv1.paths.sentence_subtitles');
    }
    ...
    {
        return Config::get('dictv1.paths.images_directory');
    }
    ...
    {
        return Config::get('dictv1.paths.temp_directory');
    }
