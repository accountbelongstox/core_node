...
Write-Host "[INFO] Executing: flutter run --debug -t "lib/apps/app_qy/main_app_qy.dart"" -ForegroundColor Cyan
...
try {
    flutter run --debug -t "lib/apps/app_qy/main_app_qy.dart"
