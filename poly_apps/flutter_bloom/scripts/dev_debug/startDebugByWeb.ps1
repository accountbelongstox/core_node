...
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "[INFO] App: app_qy" -ForegroundColor Yellow
Write-Host "[INFO] Entry File: lib/apps/app_qy/main_app_qy.dart" -ForegroundColor Yellow
Write-Host "[INFO] Debug Port: 10005" -ForegroundColor Yellow
Write-Host "[INFO] Platform: Web" -ForegroundColor Yellow
Write-Host "========================================" -ForegroundColor Cyan
Set-Location "D:\programing\core_node\poly_apps\flutter_bloom"
Write-Host "[INFO] Executing: flutter run -d web-server --web-port 10005 --web-hostname 0.0.0.0 -t "lib/apps/app_qy/main_app_qy.dart"" -ForegroundColor Green
Write-Host "[INFO] Web server will be available at: http://localhost:10005" -ForegroundColor Green
