...
- **Desktop UI Version**: Traditional Tkinter-based application (`main.py`)
- **Web Version**: Modern web-based interface (`web_main.py`) - **Recommended**
...
4. **Launch the application**:
   ...
   **Web Version (Recommended)**:
   - **Windows**: Double-click `run_web_viewer.bat`
   - **Command Line**: `python web_main.py`
   - **Access**: Open http://localhost:40017 in your browser
...
1. **Launch Web App**: Start the web server and open in browser
...
4. **Drag & Drop Upload**: Drag images directly to the upload area
5. **Select & Replace**: Choose target images and perform batch operations
6. **Real-time Updates**: All operations update the interface automatically

**Desktop UI Version Workflow:**
...
- **Modern Responsive Design**: Bootstrap-based UI that works on all devices
- **Real-time Statistics**: Live counters for each platform
- **Drag & Drop Support**: Direct file upload with visual feedback
- **Interactive Controls**: Hover effects and smooth animations
- **Platform Tabs**: Organized view with badge counters
- **Status Notifications**: Real-time feedback for all operations

**Desktop UI Version Interface:**
