...
class ChinaRegions {
  ...
  static final Map<String, List<String>> _citiesMap = {
    ...
    '澳门特别行政区': ['花地玛堂区', '圣安多尼堂区', '望德堂区', '大堂区', '风顺堂区', '嘉模堂区', '路凼填海区', '圣方济各堂区'],
  };

  static final Map<String, Map<String, List<String>>> _countiesMap = {};

  static List<String> getCities(String province) {
    return _citiesMap[province] ?? [];
  }

  static List<String> getCounties(String province, String city) {
    final key = '$province-$city';
    return _countiesMap[province]?[city] ?? [];
  }
}
