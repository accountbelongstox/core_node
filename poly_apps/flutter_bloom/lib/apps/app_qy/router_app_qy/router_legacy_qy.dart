...
import 'package:qyflutter/apps/app_qy/features_app_qy/authentication/views/forgot_screen.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/authentication/views/resetpassword_screen.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/authentication/views/signin_up_screen.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/authentication/views/verify_screen.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/dashboard/views/dashboard_screen.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/donation/views/donation_all_screen.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/donation/views/donation_screen.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/fundraising/views/fundrasing_screen.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/comming/coming_screen.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/home/views/urgent_fundraising.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/home/views/watch_impact.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/inbox/views/chat_screen.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/onbording/views/onbording_screen.dart';
...
import 'package:qyflutter/apps/app_qy/features_app_qy/about/about_screen.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/profile/views/edit_profile.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/setting/views/help_screen.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/invite_friend/invite_friend_screen.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/setting/views/notification_setting.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/setting/views/security_screen.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/help/views/about_us_screen.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/help/views/contact_screen.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/help/views/fqa_screen.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/help/views/privacy_policy.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/help/views/themes_conditions.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/profile_two/views/profile_two_screen.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/setting/views/setting_screen_view.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/top_menu/top_menu.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/bookmark/bookmark_screen.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/profile_two/views/wallet_center_screen.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/social_feed/views/social_feed_screen.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/splash/views/splash_screen.dart';
import 'package:qyflutter/apps/app_qy/features_app_qy/home_login/views/home_login_view.dart';
