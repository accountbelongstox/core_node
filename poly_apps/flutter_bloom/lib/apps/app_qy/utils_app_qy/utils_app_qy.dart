...
/// QY App Utilities
/// Contains utility functions specific to the QY app
class QyAppUtils {
  ...
  static bool isValidEmail(String email) {
    return RegExp(QyAppConstants.emailRegex).hasMatch(email);
  }

  static bool isValidPhone(String phone) {
    return RegExp(QyAppConstants.phoneRegex).hasMatch(phone);
  }

  static bool isValidPassword(String password) {
    return RegExp(QyAppConstants.passwordRegex).hasMatch(password);
  }

  static bool isValidUsername(String username) {
    return RegExp(QyAppConstants.usernameRegex).hasMatch(username);
  }
  ...
  static String formatDate(DateTime date, {String? format}) {
    final formatter = DateFormat(format ?? QyAppConstants.dateFormatShort);
    return formatter.format(date);
  }

  static String formatDateTime(DateTime dateTime, {String? format}) {
    final formatter = DateFormat(format ?? QyAppConstants.dateTimeFormat);
    return formatter.format(dateTime);
  }

  static String formatTime(DateTime time, {String? format}) {
    final formatter = DateFormat(format ?? QyAppConstants.timeFormat);
