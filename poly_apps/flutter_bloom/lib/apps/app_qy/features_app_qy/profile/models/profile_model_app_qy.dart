...
class ProfileModelAppQy {
  ...
  factory ProfileModelAppQy.fromUserData(Map<String, dynamic> userData) {
    return ProfileModelAppQy(
  ...
  factory ProfileModelAppQy.fromJson(Map<String, dynamic> json) {
    return ProfileModelAppQy(
      id: json['id']?.toString(),
  ...
  ProfileModelAppQy copyWithExtendedData(Map<String, dynamic> extendedData) {
    return copyWith(
  ...
  bool operator ==(Object other) {
    ...
    return other is ProfileModelAppQy &&
           other.id == id &&
           other.name == name &&
           other.email == email &&
           other.phone == phone &&
  ...
  @override
  String toString() {
    return 'ProfileModelAppQy(id: $id, name: $name, email: $email, completion: ${(completionPercentage * 100).toStringAsFixed(1)}%)';
  }
}
