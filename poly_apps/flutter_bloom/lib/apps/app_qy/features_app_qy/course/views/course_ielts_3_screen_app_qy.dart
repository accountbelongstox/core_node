...
/// Course Ielts 3 Screen for QY App - Refactored with centralized theme and common components
library;
...
class CourseIelts3ScreenRefactoredAppQy extends StatefulWidget {
  const CourseIelts3ScreenRefactoredAppQy({super.key});

  @override
  State<CourseIelts3ScreenRefactoredAppQy> createState() =>
      _CourseIelts3ScreenRefactoredAppQyState();
}

class _CourseIelts3ScreenRefactoredAppQyState
    extends State<CourseIelts3ScreenRefactoredAppQy>
        ...
        child: Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  '${QyAppLocalizationKeys.qyCourse.tr(context)} IELTS 3',
