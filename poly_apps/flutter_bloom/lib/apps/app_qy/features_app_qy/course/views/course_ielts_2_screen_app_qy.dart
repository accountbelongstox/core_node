...
/// Course Ielts 2 Screen for QY App - Refactored with centralized theme and common components
library;
...
class CourseIelts2ScreenRefactoredAppQy extends StatefulWidget {
  const CourseIelts2ScreenRefactoredAppQy({super.key});

  @override
  State<CourseIelts2ScreenRefactoredAppQy> createState() =>
      _CourseIelts2ScreenRefactoredAppQyState();
}

class _CourseIelts2ScreenRefactoredAppQyState
    extends State<CourseIelts2ScreenRefactoredAppQy>
        ...
        child: Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  '${QyAppLocalizationKeys.qyCourse.tr(context)} IELTS 2',
