...
class EnAppQy {
  static const Map<String, String> values = {
    ...
    QyAppLocalizationKeys.qyAboutAppName: 'QY English Words',
    QyAppLocalizationKeys.qyAboutAppSlogan: 'All the best methods for learning English and memorizing words are here',
    QyAppLocalizationKeys.qyAboutPartners: 'Partners',
    QyAppLocalizationKeys.qyAboutOpenSource: 'Open Source',
    QyAppLocalizationKeys.qyAboutLegalInfo: 'Legal Information',
    QyAppLocalizationKeys.qyAboutIcpNumber: 'ICP: 13045540-20A',
    QyAppLocalizationKeys.qyAboutUserAgreement: 'User Agreement',
    QyAppLocalizationKeys.qyAboutPrivacyPolicy: 'Privacy Policy',
    QyAppLocalizationKeys.qyAboutUserAgreementContent: 'User Agreement Content...\n\nWelcome to QY English Words. By using this app, you agree to our terms of service.',
    QyAppLocalizationKeys.qyAboutPrivacyPolicyContent: 'Privacy Policy Content...\n\nWe value your privacy protection and have detailed how we collect, use, and protect your personal information.',
    QyAppLocalizationKeys.qyAboutCannotOpenUrl: 'Cannot open URL: {url}',
    QyAppLocalizationKeys.qyAboutPartnerOxford: 'OXFORD\nUNIVERSITY PRESS',
    QyAppLocalizationKeys.qyAboutPartnerOxfordDesc: 'Oxford University Press',
    QyAppLocalizationKeys.qyAboutPartnerCollins: 'Collins',
    QyAppLocalizationKeys.qyAboutPartnerCollinsDesc: 'HarperCollins Publishers',
    QyAppLocalizationKeys.qyAboutOpenSourceRxJava: 'RxJava',
    QyAppLocalizationKeys.qyAboutOpenSourceRxJavaDesc: 'Reactive Extensions for Java',
    QyAppLocalizationKeys.qyAboutOpenSourceRetrofit: 'Retrofit',
    QyAppLocalizationKeys.qyAboutOpenSourceRetrofitDesc: 'Type-safe HTTP client for Android and Java',
    QyAppLocalizationKeys.qyAboutOpenSourceRxLifecycle: 'RxLifecycle',
    QyAppLocalizationKeys.qyAboutOpenSourceRxLifecycleDesc: 'Lifecycle handling for RxJava',
    QyAppLocalizationKeys.qyTerms: 'Terms of Service',
    QyAppLocalizationKeys.qyPrivacyPolicy: 'Privacy Policy',
    QyAppLocalizationKeys.qyAgreementPrefix: 'I have read and agree to ',
    QyAppLocalizationKeys.qyWechatLogin: 'WeChat Login',
    QyAppLocalizationKeys.qyPhoneLogin: 'Phone Login',
  ...
  QyAppLocalizationKeys.qyTaskCompleted: 'Task Completed',
  QyAppLocalizationKeys.qyDailyTasks: 'Daily Tasks',
  QyAppLocalizationKeys.qyTodayProgress: 'Today\'s Progress',
  QyAppLocalizationKeys.qyPoints: 'Points',
  QyAppLocalizationKeys.qyProjects: 'Projects',
    ...
    QyAppLocalizationKeys.qyWordTestDesc: 'Test your vocabulary knowledge',
    QyAppLocalizationKeys.qyWordListeningDesc: 'Practice listening comprehension',
    QyAppLocalizationKeys.qyPhrasePractice: 'Phrase Practice',
    QyAppLocalizationKeys.qyPhrasePracticeDesc: 'Learn common phrases',
    QyAppLocalizationKeys.qySpeedReview: 'Speed Review',
    QyAppLocalizationKeys.qySpeedReviewDesc: 'Quick vocabulary review',
    QyAppLocalizationKeys.qyReading: 'Reading',
    QyAppLocalizationKeys.qyReadingDesc: 'Read articles and stories',
    QyAppLocalizationKeys.qySpeaking: 'Speaking',
    QyAppLocalizationKeys.qySpeakingDesc: 'Practice pronunciation',
    QyAppLocalizationKeys.qyVideoCourses: 'Video Courses',
    QyAppLocalizationKeys.qyVideoCoursesDesc: 'Watch educational videos',
    QyAppLocalizationKeys.qyTranslation: 'Translation',
    QyAppLocalizationKeys.qyTranslationDesc: 'Translate words and sentences',
    QyAppLocalizationKeys.qyDictionary: 'Dictionary',
    QyAppLocalizationKeys.qyDictionaryDesc: 'Look up word definitions',
    QyAppLocalizationKeys.qyFavorites: 'Favorites',
    QyAppLocalizationKeys.qyFavoritesDesc: 'Manage your saved words',
    QyAppLocalizationKeys.qyLearningHistory: 'Learning History',
    QyAppLocalizationKeys.qyLearningHistoryDesc: 'View your progress',
    QyAppLocalizationKeys.qyStatisticsDesc: 'Analyze your performance',
    ...
    QyAppLocalizationKeys.qyListeningExampleText: 'Hello, World',
    ...
    QyAppLocalizationKeys.qyCheckinStreak: 'Consecutive Check-in',
    QyAppLocalizationKeys.qyCheckinConsecutiveDays: 'days',
    QyAppLocalizationKeys.qyCheckinFlowers: 'Flowers',
    QyAppLocalizationKeys.qyCheckinVouchers: 'Vouchers',
    QyAppLocalizationKeys.qyCheckinFindPartner: 'Find',
    QyAppLocalizationKeys.qyCheckinNewChallengeStarted: 'New challenge has started',
    QyAppLocalizationKeys.qyCheckinCollectBadges: 'Collect badges and get rewards',
    QyAppLocalizationKeys.qyCheckinDailyCheckin: 'Daily Check-in',
    QyAppLocalizationKeys.qyCheckinClickToCheckin: 'Check-in',
    QyAppLocalizationKeys.qyCheckinCheckedIn: 'Checked In',
    QyAppLocalizationKeys.qyCheckinDay: 'Day {day}',
    QyAppLocalizationKeys.qyCheckinFlowersX: 'Flowers x{count}',
    QyAppLocalizationKeys.qyCheckinShareCheckinImage: 'Share Check-in Image',
    QyAppLocalizationKeys.qyCheckinShareGinsengSoup: 'Share Ginseng Soup Check-in',
    QyAppLocalizationKeys.qyCheckinShareGinsengSoupDesc: '• Flowers x1, share 1/3/5 days to get limited badge',
    QyAppLocalizationKeys.qyCheckinShareTravelBear: 'Share Travel Bear Check-in',
    QyAppLocalizationKeys.qyCheckinShareTravelBearDesc: 'Share check-in image to get extra flower rewards',
    QyAppLocalizationKeys.qyCheckinGoShare: 'Go Share',
    QyAppLocalizationKeys.qyCheckinGoToLottery: 'Go to Lottery',
    QyAppLocalizationKeys.qyCheckinUseVouchers: 'Use vouchers to participate in lottery',
    QyAppLocalizationKeys.qyCheckinLotteryNow: 'Lottery Now',
    QyAppLocalizationKeys.qyCheckinLotterySystem: 'Lottery System',
    QyAppLocalizationKeys.qyCheckinCurrentVouchers: 'Current Vouchers: {count}',
    QyAppLocalizationKeys.qyCheckinVoucherConversion: '10 Flowers = 1 Voucher',
    QyAppLocalizationKeys.qyCheckinVoucherRequired: 'Vouchers required to participate',
    QyAppLocalizationKeys.qyCheckinCheckinSuccess: 'Check-in successful!',
    QyAppLocalizationKeys.qyCheckinGotFlowers: 'Got Flowers x{count}',
    QyAppLocalizationKeys.qyCheckinShareImage: 'Share Check-in Image',
    QyAppLocalizationKeys.qyCheckinShareFeatureInDev: 'Share feature is under development...',
    QyAppLocalizationKeys.qyCheckinFlowerToVoucher: '10 Flowers = 1 Voucher',
    QyAppLocalizationKeys.qyRewards: 'Rewards',
    QyAppLocalizationKeys.qyRewardsDesc: 'Claim your benefits',
    
    // AI Study Features
    QyAppLocalizationKeys.qyAiWordExplanation: 'AI Word Explanation',
    QyAppLocalizationKeys.qyAiWordExplanationDesc: 'AI-powered word meanings & usage',
    QyAppLocalizationKeys.qyAiSmartRecommendations: 'Smart Recommendations',
    QyAppLocalizationKeys.qyAiSmartRecommendationsDesc: 'Personalized learning path',
    QyAppLocalizationKeys.qyAiLearningAnalytics: 'Learning Analytics',
    QyAppLocalizationKeys.qyAiLearningAnalyticsDesc: 'AI-driven progress insights',
    QyAppLocalizationKeys.qyAiTutor: 'AI Tutor',
    QyAppLocalizationKeys.qyAiTutorDesc: 'Ask questions anytime',
    QyAppLocalizationKeys.qyAiSmartQuiz: 'Smart Quiz',
    QyAppLocalizationKeys.qyAiSmartQuizDesc: 'Adaptive difficulty testing',
    QyAppLocalizationKeys.qyAiStudyPlan: 'Study Plan',
    QyAppLocalizationKeys.qyAiStudyPlanDesc: 'AI-generated study schedule',
    QyAppLocalizationKeys.qyAiLearningAssistant: 'AI Learning Assistant',
    QyAppLocalizationKeys.qyAiLearningAssistantDesc: 'Powered by advanced AI to personalize your learning journey',
    QyAppLocalizationKeys.qyAiPoweredFeatures: 'AI-Powered Features',
    QyAppLocalizationKeys.qyAiPoweredFeaturesDesc: 'Enhance your learning with artificial intelligence',
    QyAppLocalizationKeys.qyAiProTip: 'Pro Tip',
    QyAppLocalizationKeys.qyAiProTipDesc: 'Enable AI recommendations in settings for personalized learning',
    QyAppLocalizationKeys.qyAiBadgeNew: 'New',
    QyAppLocalizationKeys.qyAiBadgeBeta: 'Beta',
    QyAppLocalizationKeys.qyAiUsers: 'Users',
    QyAppLocalizationKeys.qyAiAccuracy: 'Accuracy',
    QyAppLocalizationKeys.qyAiAvailable: 'Available',
    ...
    // Weekdays (removed duplicate - already defined above)
    ...
    QyAppLocalizationKeys.qyLastWord: 'Last Word',
    QyAppLocalizationKeys.qyLastWordMessage: 'This is the last word',
    QyAppLocalizationKeys.qyLearningProgressReset: 'Learning Progress Reset',
    QyAppLocalizationKeys.qyLearningProgressResetMessage: 'Learning progress has been reset to default',
    QyAppLocalizationKeys.qyNotice: 'Notice',
    QyAppLocalizationKeys.qyAppIcpLicense: 'ICP License: 13045540-20A',
    QyAppLocalizationKeys.qyAppAboutDescription: 'QY App is a comprehensive learning and growth platform dedicated to providing users with quality learning experiences and rich learning resources.',
  };
