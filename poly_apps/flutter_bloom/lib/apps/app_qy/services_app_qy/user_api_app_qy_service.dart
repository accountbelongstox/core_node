...
/// User management API service for app_qy
/// Uses the new unified network framework
class UserApiAppQyService extends AdvancedNetworkService {
  UserApiAppQyService(BuildContext context) : super();

  @override
  String get serviceName => 'UserApiAppQyService';
  ...
  Future<UserData?> getUserProfile() async {
    final response = await getRequest(ApiEndpointsAppQy.userProfile);
  ...
  Future<Map<String, dynamic>?> getUserSettings() async {
    final response = await getRequest(ApiEndpointsAppQy.userSettings);
  ...
  Future<bool> updateUserSettings(Map<String, dynamic> settings) async {
    final response = await putRequest(
      ApiEndpointsAppQy.userSettings,
      {'settings': settings},
    );
  ...
  Future<Map<String, dynamic>?> getUserPreferences() async {
    final response = await getRequest(ApiEndpointsAppQy.userPreferences);
  ...
  Future<bool> updateUserPreferences(Map<String, dynamic> preferences) async {
    final response = await putRequest(
      ApiEndpointsAppQy.userPreferences,
  ...
  Future<List<Map<String, dynamic>>> getUserActivity({
    ...
    final response = await getRequest(
      ApiEndpointsAppQy.userActivity,
      queryParams: {
  ...
  Future<List<Map<String, dynamic>>> getUserSessions() async {
    final response = await getRequest(ApiEndpointsAppQy.userSessions);
  ...
  Map<String, dynamic> getServiceStatus() {
    return {
      'service_name': 'UserApiAppQyService',
