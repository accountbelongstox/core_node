...
/// Authenticated API service for app_qy
/// Provides standardized API methods with authentication verification
class AuthApiAppQyService extends AdvancedNetworkService {
  final BuildContext context;

  AuthApiAppQyService({required this.context}) : super();

  @override
  String get serviceName => 'AuthApiAppQy';
  ...
  Map<String, dynamic> getServiceStatus() {
    return {
      'service_name': 'AuthApiAppQyService',
