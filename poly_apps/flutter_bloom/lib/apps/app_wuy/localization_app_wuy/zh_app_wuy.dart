...
class WuyZhTranslations {
  static const Map<String, String> translations = {
    ...
    LocalizationKeysAppWuy.wuyFriendMonitor: '监控',
    LocalizationKeysAppWuy.wuyFriendDetails: '详情',
    LocalizationKeysAppWuy.wuyFriendSearch: '搜索',
    LocalizationKeysAppWuy.wuyFriendSearchPhone: '搜索手机号',
    LocalizationKeysAppWuy.wuyFriendMonitoringStatus: '监控状态',
    LocalizationKeysAppWuy.wuyFriendLastMessage: '最后消息',
    LocalizationKeysAppWuy.wuyFriendsOffline: '离线',
    LocalizationKeysAppWuy.wuyTimeMinutesAgo: '分钟前',
    LocalizationKeysAppWuy.wuyTimeHoursAgo: '小时前',
    LocalizationKeysAppWuy.wuyTimeDaysAgo: '天前',
    ...
    LocalizationKeysAppWuy.wuyTabMap: '地图',
    LocalizationKeysAppWuy.wuyTabFriends: '好友',
    LocalizationKeysAppWuy.wuyTabMe: '我的',
    LocalizationKeysAppWuy.wuyHomeSos: '一键求救',
    LocalizationKeysAppWuy.wuyHomeFence: '电子围栏',
    LocalizationKeysAppWuy.wuyHomeDays: '守护天数',
    LocalizationKeysAppWuy.wuyHomeBattery: '电量',
    LocalizationKeysAppWuy.wuyHomeDaysProtected: '守护天数',
    ...
    LocalizationKeysAppWuy.wuyMeProfile: '个人资料',
    LocalizationKeysAppWuy.wuyMeTheme: '主题',
    LocalizationKeysAppWuy.wuyMeLang: '语言',
    LocalizationKeysAppWuy.wuyMeAbout: '关于',
    LocalizationKeysAppWuy.wuyMeSettings: '设置',
    LocalizationKeysAppWuy.wuyMeLogout: '退出登录',
    LocalizationKeysAppWuy.wuyMeThemeLight: '浅色',
    LocalizationKeysAppWuy.wuyMeThemeDark: '深色',
    ...
    LocalizationKeysAppWuy.wuyStatsDevice: '设备',
    LocalizationKeysAppWuy.wuyStatsPlaces: '地点',
    LocalizationKeysAppWuy.wuyStatsSteps: '步数',
    LocalizationKeysAppWuy.wuyStatsHeart: '心率',
    LocalizationKeysAppWuy.wuyStatsTemp: '体温',
    LocalizationKeysAppWuy.wuyStatsNetwork: '网络',
    LocalizationKeysAppWuy.wuyStatsUnlocks: '解锁',
    LocalizationKeysAppWuy.wuyStatsScreenTime: '屏幕时间',
    LocalizationKeysAppWuy.wuyStatsUpdated: '更新于',
    LocalizationKeysAppWuy.wuyStatsTimes: '次',
    ...
    // Send request screen
    LocalizationKeysAppWuy.wuySendRequestTitle: '验证请求',
    LocalizationKeysAppWuy.wuySendRequestMessage: '消息',
    LocalizationKeysAppWuy.wuySendRequestAlias: '备注/别名',
    LocalizationKeysAppWuy.wuySendRequestRelation: '关系',
    LocalizationKeysAppWuy.wuySendRequestSend: '发送请求',
    LocalizationKeysAppWuy.wuySendRequestRelationFamily: '家人',
    LocalizationKeysAppWuy.wuySendRequestRelationPartner: '伴侣',
    LocalizationKeysAppWuy.wuySendRequestRelationFriend: '朋友',
