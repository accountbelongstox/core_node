...
class ExampleAppConstants {
  ...
  // Storage Keys
  static const String keyUserToken = 'example_user_token';
  static const String keyUserProfile = 'example_user_profile';
  static const String keyAppSettings = 'example_app_settings';
  static const String keyLastLoginTime = 'example_last_login_time';
  static const String keyOfflineData = 'example_offline_data';
  static const String keyNotificationSettings = 'example_notification_settings';
  static const String keyThemePreference = 'example_theme_preference';
  static const String keyLanguagePreference = 'example_language_preference';
  ...
  static const String prefsPrefix = 'example_';
  static const String prefsName = 'example_prefs';
}

/// Example App Enums
enum ExampleUserRole {
  guest,
  user,
  moderator,
  admin,
