...
import 'api_endpoints_app_example.dart';
import 'api_data_models_app_example.dart';

/// API configuration for app_example
/// This defines the API settings and user data structure for the example app
class ApiConfigAppExample {
...
class AppEnvironmentConfig {
  ...
  static ApiConfig get currentApiConfig => 
      ApiConfigAppExample.getApiConfig(isDevelopment: isDevelopment);

  static ApiConfig get currentPublicApiConfig => 
      ApiConfigAppExample.getPublicApiConfig(isDevelopment: isDevelopment);

  static ApiConfig get currentCdnApiConfig => 
      ApiConfigAppExample.getCdnApiConfig(isDevelopment: isDevelopment);
}
