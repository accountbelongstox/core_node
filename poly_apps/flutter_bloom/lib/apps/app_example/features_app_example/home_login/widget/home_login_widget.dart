...
class _HomeLoginWidgetState extends State<HomeLoginWidget> {
  ...
  List<Map<String, dynamic>> _getMenuItems(BuildContext context) => [
    {'icon': Icons.home, 'label': 'example_home'.tr(context)},
    {'icon': Icons.menu_book, 'label': 'example_learning'.tr(context)},
    {'icon': Icons.bar_chart, 'label': 'example_statistics'.tr(context)},
    {'icon': Icons.emoji_events, 'label': 'example_achievements'.tr(context)},
    {'icon': Icons.people, 'label': 'example_community'.tr(context)},
    {'icon': Icons.calendar_today, 'label': 'example_calendar'.tr(context)},
    {'icon': Icons.settings, 'label': 'example_settings'.tr(context)},
    {'icon': Icons.help_outline, 'label': 'example_help'.tr(context)},
  ];
              ...
              child: Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'example_placeholder_search'.tr(context),
              ...
              child: Column(
                children: [
                    ...
                    children: [
                      Expanded(
                        child: TextButton(
                          ...
                          child: Text(
                            'example_global_search'.tr(context),
                  ...
                  Padding(
                    ...
                    child: TextField(
                      decoration: InputDecoration(
                        hintText: 'example_placeholder_search_content'.tr(context),
  ...
  Widget _buildTimeline() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            'example_learning_progress'.tr(context),
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            'example_study_duration'.tr(context),
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            'example_accuracy_rate'.tr(context),
                            style: ThemeTextStyles.bodyMedium,
                          ),
                          Text(
                            '85%',
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            'example_review_count'.tr(context),
                            style: ThemeTextStyles.bodyMedium,
                          ),
                          Text(
                            '3 times',
