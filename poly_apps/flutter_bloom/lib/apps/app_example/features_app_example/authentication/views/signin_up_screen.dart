...
import 'package:qyflutter/apps/app_example/features_app_example/authentication/actions/auth_actions.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (_isSignIn) ...[
                      ...
                      InkWell(
                          onTap: () {
                            context.pushReplacement(ExampleAppRoutesProvider.routeForgot);
                          },
