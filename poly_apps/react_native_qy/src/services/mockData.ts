...
export const MOCK_USER: User = {
  ...
  name: 'Demo User',
  avatar:
    'https://ui-avatars.com/api/?name=Demo+User&background=3B82F6&color=fff',
...
export const MOCK_WORD_GROUPS: WordGroup[] = [
  {
    ...
    language: 'en',
    coverImage: '📗',
    description: 'Essential vocabulary for high IELTS scores.',
  },
  {
    id: 'g2',
    ...
    language: 'en',
    coverImage: '💼',
    description: 'Professional terms for the workplace.',
  },
  {
    id: 'g3',
    ...
    language: 'jp',
    coverImage: '📘',
    description: 'Beginner Japanese for JLPT N5.',
  },
  {
    id: 'g4',
    ...
    language: 'en',
    coverImage: '📄',
    description: 'Extracted from "The_Great_Gatsby.pdf"',
  },
  {
    id: 'g5',
    name: 'Travel French',
    ...
    language: 'fr',
    coverImage: '🗼',
    description: 'Useful phrases for your Paris trip.',
  },
  {
    id: 'g6',
    name: 'TOEFL Mastery',
  ...
  },
  {
    ...
    language: 'kr',
    coverImage: '🔤',
    description: 'Hangul and basic greetings.',
  },
];
...
export const MOCK_WORDS_EN: Word[] = [
  {
    ...
    example: 'It was only through pure serendipity that we met.',
    masteryLevel: 20,
    tags: ['noun', 'advanced'],
  },
  {
  ...
  },
  {
    ...
    example: 'He showed great resilience after the accident.',
    masteryLevel: 10,
    tags: ['noun'],
  },
  {
  ...
  },
  {
    ...
    example: 'The ineffable beauty of the sunrise.',
    masteryLevel: 0,
    tags: ['adjective'],
  },
  {
    ...
    example: 'I love the smell of petrichor in the spring.',
    masteryLevel: 0,
    tags: ['noun'],
  },
];
...
export const MOCK_RETENTION_STATS: RetentionStat[] = [
  { level: 'Critical', count: 12, color: '#ef4444', percentage: 10 },
  { level: 'Review', count: 45, color: '#f59e0b', percentage: 35 },
  { level: 'Learning', count: 120, color: '#3b82f6', percentage: 40 },
  { level: 'Mastered', count: 273, color: '#22c55e', percentage: 60 },
];
...
export const MOCK_LEADERBOARD: LeaderboardUser[] = [
  ...
  },
  {
    rank: 4,
    name: 'Yuki Tanaka',
    avatar: 'https://ui-avatars.com/api/?name=Yuki&background=random',
    xp: 11000,
    isCurrentUser: false,
  },
  {
    rank: 5,
    name: 'Jean Pierre',
    avatar: 'https://ui-avatars.com/api/?name=Jean&background=random',
    xp: 9800,
    isCurrentUser: false,
  },
];
...
export const MOCK_ACTIVITIES: ActivityLog[] = [
  {
    ...
    userId: 'f1',
    userName: 'Alice Wu',
    userAvatar: 'https://ui-avatars.com/api/?name=Alice',
    action: 'completed 50 words',
    time: '10m ago',
    likes: 3,
  },
  {
    ...
    userId: 'f2',
    userName: 'Bob Smith',
    userAvatar: 'https://ui-avatars.com/api/?name=Bob',
  ...
  },
  {
    ...
    userAvatar: 'https://ui-avatars.com/api/?name=Charlie',
    action: 'joined "IELTS Core"',
    time: '3h ago',
    likes: 1,
  },
];
