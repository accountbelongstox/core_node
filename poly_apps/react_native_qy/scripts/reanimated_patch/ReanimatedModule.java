...
public class ReanimatedModule extends NativeReanimatedModuleSpec
  ...
  public void initialize() {
    ...
    if (BuildConfig.IS_NEW_ARCHITECTURE_ENABLED) {
      ...
      // UIManagerModuleListener API was removed in newer RN; skip legacy listener wiring.
    }
  ...
  // Legacy Paper UIManagerModuleListener removed for compatibility with RN 0.82+
  public void willDispatchViewUpdatesLegacy(final UIManagerModule uiManager) {}
  ...
  public boolean installTurboModule() {
    ...
    if (!Utils.isChromeDebugger) {
      ...
      Log.w("[Reanimated]", "TurboModules are not available in Chrome Debugger.");
      return false;
    }
  }
}
