 ...
 */
class AppQyV1LegacyDatabaseProcessor
{
    ...
    protected function convertAndInsertRecord(array $legacyRecord): bool
    {
        try {
            ...
            $existingRecord = AppQyV1DictionaryModel::findByContent($legacyRecord['content']);
     ...
     * 
     * @param AppQyV1DictionaryModel $existingRecord
     * @param array $legacyRecord
     * @return bool
     */
    protected function updateExistingRecord(AppQyV1DictionaryModel $existingRecord, array $legacyRecord): bool
    {
        try {
            $updated = false;
