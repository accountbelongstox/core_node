    ...
    public static function removeDomain(string $domain): bool
    {
        ...
        if (self::saveDomains($domains)) {
            ...
            if ($shouldStopService && $wwwDir && $swoolePort) {
                try {
                    \App\Apps\ServerManagerV1\ServerManagerV1Utils\ServerManagerV1OctaneServiceManager::undeployOctaneServiceFromPath($wwwDir, $swoolePort);
...
server {
    ...
    private static function getNextAvailableSwoolePort(): int
    {
        ...
        return \App\Apps\ServerManagerV1\ServerManagerV1Utils\ServerManagerV1OctaneServiceManager::getNextAvailablePort();
    }
    ...
    public static function getSwooleServiceInfoByPath(string $wwwDir): ?array
    {
        ...
        $pathHash = \App\Apps\ServerManagerV1\ServerManagerV1Utils\ServerManagerV1OctaneServiceManager::getPathHash($wwwDir);
        $serviceName = \App\Apps\ServerManagerV1\ServerManagerV1Utils\ServerManagerV1OctaneServiceManager::getOctaneServiceNameFromPath($wwwDir, $port);
