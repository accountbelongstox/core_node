    ...
    private function addWebsite(?string $domain): int
    {
        ...
        if ($domainResult && $wwwResult) {
            ...
            if (ServerManagerV1PathConfig::isSwooleMode($phpMode)) {
                $serviceInfo = \App\Apps\ServerManagerV1\ServerManagerV1Utils\ServerManagerV1DomainManager::getSwooleServiceInfo($baseDomain);
                ...
                if ($serviceInfo) {
                    ...
                    if ($serviceActive) {
                        // Service already running, nginx config updated, done
                        ...
                        $deployed = \App\Apps\ServerManagerV1\ServerManagerV1Utils\ServerManagerV1OctaneServiceManager::deployOctaneServiceFromPath(
                            $wwwDir,
                            $port,
                            $workers,
                            $wwwDir,
