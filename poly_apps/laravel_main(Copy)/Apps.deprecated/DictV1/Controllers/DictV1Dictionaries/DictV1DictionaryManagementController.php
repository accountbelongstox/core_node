...
class DictV1DictionaryManagementController extends BaseController
{
    /**
    ...
    public function addDictionary(Request $request)
    {
        ...
        try {
            ...
            $existingEntry = DictV1DictionaryModel::findByContent($content);
    ...
    public function filterAndAddDictionaryList(Request $request)
    {
        ...
        try {
            ...
            $existingEntries = DB::table('dict_v1_dictionaries')
                ->whereIn('md5', $allMd5s)
                ->select('id', 'content', 'md5', 'queryCount')
                ->get();
            $dictionariesRecoredCount = DB::table( 'dict_v1_dictionaries' )->count();
