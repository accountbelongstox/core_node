...
namespace App\Apps\DictV1\Controllers\DictV1WordSubmit;
 ...
 */
class DictV1WordDataSubmissionController extends BaseController
{
    ...
    public function submitTranslation(Request $request, string $word)
    {
        ...
        try {
            ...
            $dictionary = DictV1DictionaryModel::findByContent($word);
