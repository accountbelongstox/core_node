...
class DictV1PreValidationController extends Controller
{
    ...
    {
        $audioPath = Config::get('dictv1.paths.audio_directory', $this->storageManager->getWordSoundsPath());
    ...
    {
        $legacyDbPath = Config::get('dictv1.paths.legacy_database', $this->storageManager->getLegacyDatabasePath());
        $newDbPath = Config::get('dictv1.paths.main_database', database_path('dictionary.sqlite'));
        ...
        try {
            $wordCount = DictV1DictionaryModel::count();
        } catch (\Exception $e) {
