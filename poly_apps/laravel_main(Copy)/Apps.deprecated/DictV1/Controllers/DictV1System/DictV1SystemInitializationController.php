...
namespace App\Apps\DictV1\Controllers\DictV1System;
...
use App\Apps\DictV1\Utils\DictV1SystemInit\DictV1ExternalStorageManager;
use App\Apps\DictV1\Utils\DictV1SystemInit\DictV1LegacyDatabaseProcessor;
use App\Apps\DictV1\Utils\DictV1SystemInit\DictV1AudioFileProcessor;
use App\Apps\DictV1\Utils\DictV1SystemInit\DictV1ImageFileProcessor;
use App\Apps\DictV1\Utils\DictV1SystemInit\DictV1InitializationMarkerManager;
use App\Apps\DictV1\Utils\DictV1VocabularyProcessor\DictV1VocabularyProcessor;

class DictV1SystemInitializationController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->databaseProcessor = new DictV1LegacyDatabaseProcessor();
        $this->audioProcessor = new DictV1AudioFileProcessor();
        $this->imageProcessor = new DictV1ImageFileProcessor();
        $this->markerManager = new DictV1InitializationMarkerManager();
        $this->vocabularyProcessor = new DictV1VocabularyProcessor();
    }
    ...
    protected function checkNewDatabaseExists(): bool
    {
        try {
            ...
            return DictV1DictionaryModel::count() > 0;
        } catch (\Exception $e) {
            return false;
        }
    }
