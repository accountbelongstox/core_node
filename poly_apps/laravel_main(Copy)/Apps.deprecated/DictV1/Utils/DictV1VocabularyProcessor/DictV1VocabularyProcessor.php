...
namespace App\Apps\DictV1\Utils\DictV1VocabularyProcessor;
...
class DictV1VocabularyProcessor
{
        ...
        try {
            ...
            foreach ($batches as $batch) {
                ...
                foreach ($batch as $wordData) {
                    ...
                    $existingWord = DictV1DictionaryModel::where('word', $wordData['word'])->first();
                ...
                if (!empty($insertData)) {
                    DictV1DictionaryModel::insert($insertData);
    ...
    public function getProcessingStats(): array
    {
        if ($this->markerManager->isVocabularyProcessingComplete()) {
            ...
            $totalWords = DictV1DictionaryModel::where('word_category', 'vocabulary')->count();
            return [
                'status' => 'completed',
    ...
    public function resetProcessing(): void
    {
        ...
        // DictV1DictionaryModel::where('word_category', 'vocabulary')->delete();
