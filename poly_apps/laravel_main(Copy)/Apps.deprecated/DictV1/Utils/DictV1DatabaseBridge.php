...
namespace App\Apps\DictV1\Utils;
...
{
    /**
     * Get the database table configuration for DictV1
     *
     * @return array
     */
    public static function getTableConfig(): array
    {
        return Config::get('DictV1_db_tables', []);
    }
    ...
    {
        return self::getTableName('dict_v1_dictionaries') ?? 'dict_v1_dictionaries';
    }
    ...
    {
        return self::getTableName('dict_v1_personal_dictionaries') ?? 'dict_v1_personal_dictionaries';
    }
    ...
    {
        return self::getTableName('dict_v1_word_groups') ?? 'dict_v1_word_groups';
    }
