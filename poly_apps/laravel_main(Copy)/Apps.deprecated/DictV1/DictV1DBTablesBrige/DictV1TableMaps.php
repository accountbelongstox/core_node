...
class DictV1TableMaps
{
    /**
     * DictV1 Application Database Table Mappings
     * This class provides centralized table name and field mappings for the DictV1 application
     * All database operations should reference these mappings instead of hardcoded table/field names
     */
    
    // DictV1 Application Tables
    public const DICT_V1_DICTIONARIES = [
        'tablename' => 'dict_v1_dictionaries',
        'fields' => [
            'id' => 'id',
            'content' => 'content',
            'md5' => 'md5',
    ...
    public const DICT_V1_PERSONAL_DICTIONARIES = [
        'tablename' => 'dict_v1_personal_dictionaries',
        'fields' => [
            'id' => 'id',
            'uid' => 'uid',
    ...
    public const DICT_V1_WORD_GROUPS = [
        'tablename' => 'dict_v1_word_groups',
        'fields' => [
            'id' => 'id',
            'gid' => 'gid',
            'username' => 'username',
    ...
    public static function getTableName(string $tableKey): string
    {
        ...
        throw new \InvalidArgumentException("Table key '{$tableKey}' not found in DictV1TableMaps");
    }
    ...
    {
        return [
            'DICT_V1_DICTIONARIES',
            'DICT_V1_PERSONAL_DICTIONARIES',
            'DICT_V1_WORD_GROUPS'
        ];
    }
