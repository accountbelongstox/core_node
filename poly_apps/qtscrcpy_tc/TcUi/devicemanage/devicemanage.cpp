...
bool DeviceManage::connectDevice(Device::DeviceParams params)
{
    ...
    // Connect multiple phones, need to open multiple interfaces
    // Uncomment
    // No need to allocate ports, all use 27183, server will release listening after connection is established
