        ...
        connect(m_server, &Server::connectToResult, this, [this](bool success, const QString &deviceName, const QSize &size) {
            if (success) {
                ...
                if (m_videoForm) {
                    ...
                    m_videoForm->show();
                    qDebug("got devicename: %s", deviceName.toLocal8Bit().constData());
                    m_videoForm->ui->nicknameLabel->setText(nickname);
                    m_videoForm->ui->nameLabel->setText(deviceName);
                    m_videoForm->ui->serialLabel->setText(m_params.serial);
