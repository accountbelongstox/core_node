...
const loadState = (): AudioGenState => {
  const cached = StorageManager.get<Partial<AudioGenState> | null>(StorageKeys.PYCORE_SENTENCE_AUDIO_GENERATION, null);
  return cached ? { ...initialState(), ...cached } : initialState();
};
