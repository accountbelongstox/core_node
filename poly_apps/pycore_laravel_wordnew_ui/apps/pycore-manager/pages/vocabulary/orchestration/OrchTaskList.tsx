/**
 * Orchestration task list: one row per task with status, segment progress and
 * edit / delete / cancel actions. Progress of running tasks is polled by the
 * parent tab (VocabAudioOrchTab) and reflected here.
 */
import React from 'react';
import { Loader2, Pencil, Play, Trash2, XCircle } from 'lucide-react';
import { pycoreApi, type OrchTaskSummary } from '@/apps/pycore-manager/api';
...
const OrchTaskList: React.FC<{
  ...
  onChanged: () => void;
}> = ({ tasks, selectedTaskId, onSelect, onEdit, onChanged }) => {
