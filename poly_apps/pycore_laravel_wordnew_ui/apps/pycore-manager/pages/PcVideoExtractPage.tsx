 ...
 * segment↔subtitle map, and a live CPU/MEM/GPU monitor. Uses pycoreApi HTTP
 * controllers and events. Optional live updates have a manual
...
const PcVideoExtractPage: React.FC = () => {
  ...
  const LANG_CODES = SUPPORTED_LEARNING_LANGUAGES.map((l) => l.code);
