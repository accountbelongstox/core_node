 ...
 *
 * QUICK START
 *   import { capTTS, useTextToSpeech } from '@/apps/wordnew/platform/capabilities/CapTextToSpeech';
...
export class CapTextToSpeechService {
  ...
  private readonly emitter = new TypedEventEmitter<CapTTSEventMap>('CapTextToSpeech');
