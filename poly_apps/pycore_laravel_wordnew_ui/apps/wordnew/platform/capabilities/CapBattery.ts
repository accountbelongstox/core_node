 ...
 *
 * QUICK START
 *   import { capBattery, useBattery } from '@/apps/wordnew/platform/capabilities/CapBattery';
...
export class CapBatteryService {
  ...
  private readonly emitter = new TypedEventEmitter<CapBatteryEventMap>('CapBattery');
