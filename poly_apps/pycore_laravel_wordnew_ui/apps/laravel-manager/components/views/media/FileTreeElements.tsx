...
import { Folder, FolderOpen, FileVideo, File, ChevronRight, ChevronDown, UploadCloud, Music, Image as ImageIcon, Code2, X, FileText, Loader2, Pencil, Trash2, Download, FileType, BookOpen } from 'lucide-react';
