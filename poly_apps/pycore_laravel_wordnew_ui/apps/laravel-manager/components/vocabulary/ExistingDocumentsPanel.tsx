            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="text-left text-xs uppercase tracking-wide text-slate-400 border-b border-slate-200 dark:border-slate-700">
                  <PaginatedSortHead sortKey="title" label={text.columns.title} sort={sort} onSort={setSort} className="py-2 pr-3 text-left" />
                  <PaginatedSortHead sortKey="language" label={text.columns.language} sort={sort} onSort={setSort} className="py-2 pr-3 text-left" />
                  <PaginatedSortHead sortKey="words" label={text.stats.words} sort={sort} onSort={setSort} className="py-2 pr-3 text-right" />
                  <PaginatedSortHead sortKey="uploaded" label={text.columns.uploaded} sort={sort} onSort={setSort} className="py-2 pr-3 text-left" />
                </tr>
              </thead>
              <tbody>
                {items.map((doc) => (
