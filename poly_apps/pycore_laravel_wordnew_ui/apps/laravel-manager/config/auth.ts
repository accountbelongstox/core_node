 ...
 * - Used by LmDashboard.tsx to wrap content with AuthGuard and by any code that needs to
 ...
 * - Message copy is kept in the Laravel manager translations; this module uses i18n.t(key, { lng })
 ...
 * 2. Add the corresponding auth_required message in the translation table under
 *    the appropriate key (e.g. server_manager, db_manager).
 * 3. Add the message key to VIEW_AUTH_MESSAGE_KEYS below.
 * 4. LmDashboard.tsx will wrap that view with AuthGuard and open the login modal.
 */
