export { StorageManager, STORAGE_MANAGER_CHANGED_EVENT } from './StorageManager';
...
export type {
  ...
  RevisionedStorageReplicaOptions,
  RevisionedStorageWrite,
} from './RevisionedStorageReplica';
