...
import type {
  ...
  SubtitleSearchHistoryResponse,
  SubtitleSearchHistoryDeleteResponse,
  SubtitleSearchHistoryClearResponse,
  SubtitleProvidersResponse,
  SubtitleProviderProbe,
  SubtitleCacheStats,
  SubtitleCacheClearResponse,
  WordAudioStatus,
  WordAudioTestResponse,
} from './PycoreServiceTypes';
import type {
  TranslateHistoryResponse,
  TranslateHistoryDeleteResponse,
  TranslateHistoryClearResponse,
  PcCapabilitySettings,
  PcCapabilityKey,
...
import type {
  ...
  AgentHistoryPromptsResponse,
  AgentHistorySessionResponse,
  AgentHistoryArticleRecordsResponse,
  AgentHistoryStatusResponse,
  AgentHistoryTestExtractResponse,
  AgentHistorySessionIdPagesResponse,
  AgentHistorySessionPageResponse,
  AgentHistoryPromptIdPagesResponse,
...
export const pycoreApiLocal = {
  ...
  getAgentHistoryVideoLogs: (sinceRevision = '', limit = 100) =>
    requestPycoreHttp(PYCORE_HTTP_ROUTES.agentHistoryArticleVideoLogs, {
      since_revision: sinceRevision,
      limit,
    }) as Promise<AgentHistoryVideoLogsResponse>,
  refreshAgentHistory: () =>
