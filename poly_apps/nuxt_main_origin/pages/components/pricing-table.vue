            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <div class="mx-auto max-w-[320px] md:max-w-[990px]">
                        <div class="justify-between space-y-4 rtl:space-x-reverse md:flex md:space-y-0 md:space-x-4">
                            ...
                            <div class="group rounded border border-[#e0e6ed] transition-all duration-300 dark:border-[#1b2e4b]">
                                <div class="border-b border-[#e0e6ed] p-5 pt-0 dark:border-[#1b2e4b]">
                                    <span
                                        ...
                                        >$49</span
                                    >
                                    <h3 class="mt-4 mb-2.5 text-xl lg:text-2xl">Freelancer</h3>
                            ...
                            <div class="group rounded border border-[#e0e6ed] transition-all duration-300 dark:border-[#1b2e4b]">
                                <div class="border-b border-[#e0e6ed] p-5 pt-0 dark:border-[#1b2e4b]">
                                    <span
                                        ...
                                        >$89</span
                                    >
                                    <h3 class="mt-4 mb-2.5 text-xl lg:text-2xl">Small business</h3>
                                    <p class="text-[15px]">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                                </div>
                                <div class="p-5">
                                    <ul class="mb-5 space-y-2.5 font-semibold">
                            ...
                            <div class="group rounded border border-[#e0e6ed] transition-all duration-300 dark:border-[#1b2e4b]">
                                <div class="border-b border-[#e0e6ed] p-5 pt-0 dark:border-[#1b2e4b]">
                                    <span
                                        ...
                                        >$129</span
                                    >
                                    <h3 class="mt-4 mb-2.5 text-xl lg:text-2xl">Larger business</h3>
                                    <p class="text-[15px]">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                                </div>
                                <div class="p-5">
                                    <ul class="mb-5 space-y-2.5 font-semibold">
