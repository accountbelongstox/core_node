...
&lt;span class=&quot;badge badge-outline-dark&quot;&gt;Dark&lt;/span&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Pills</h5>
                ...
                <div class="mb-5">
                    <div class="flex w-full">
                        <div class="flex w-1/2 items-center justify-center">
                            <span class="badge rounded-full bg-primary">Primary</span>
                        </div>
                        <div class="flex w-1/2 items-center justify-center">
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Classic</h5>
                ...
                <div class="mb-5">
                    <div class="flex w-full">
                        <div class="flex w-1/2 items-center justify-center">
                            <span class="badge rounded-none bg-primary">Primary</span>
                        </div>
                        <div class="flex w-1/2 items-center justify-center">
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Badges with Heading</h5>
                ...
                <div class="mb-5 dark:text-white-dark">
                    ...
                    <div class="prose space-y-2 dark:prose-headings:text-white-dark">
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Custom Badges</h5>
                ...
                <div class="mb-5">
                    <div class="flex flex-wrap items-center justify-center gap-3">
                        <button type="button" class="btn btn-primary my-4">
                            <span class="flex items-center">
                                <svg
                                    ...
                                    class="h-4.5 w-4.5 ltr:mr-1 rtl:ml-1"
                                >
                                    <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                                </svg>
                                Facebook</span
                            >
                            <span class="badge absolute -top-3 rounded-full bg-danger p-0.5 px-1.5 ltr:right-0 rtl:left-0">9</span>
                        </button>
                        <button type="button" class="btn btn-info my-4">
                            <span>Twitter</span><span class="badge absolute -top-3 rounded-full bg-danger p-0.5 px-1.5 ltr:right-0 rtl:left-0">4</span>
                        </button>
                        <button type="button" class="btn btn-secondary my-4 px-5">
                            <span>
                            ...
                            <span class="badge absolute -top-3 rounded-full bg-danger p-0.5 px-1.5 ltr:right-0 rtl:left-0">8</span>
                        </button>
                        ...
                        <div class="flex flex-wrap items-center justify-center gap-3">
                            <span class="badge my-4 flex items-center rounded-full bg-warning p-0 text-base ltr:pr-4 rtl:pl-4">
                                <img src="/assets/images/profile-34.jpeg" alt="" class="h-10 w-10 rounded-full object-cover" /><span class="ltr:ml-2 rtl:mr-2"
                                    >John Doe</span
                                ></span
                            >
                            <span class="badge my-4 flex items-center rounded-full bg-danger p-0 text-base ltr:pr-4 rtl:pl-4">
                                <img src="/assets/images/profile-34.jpeg" alt="" class="h-10 w-10 rounded-full object-cover" /><span class="ltr:ml-2 rtl:mr-2"
                                    >John Doe</span
                                >
                                <span class="cursor-pointer hover:opacity-90 ltr:ml-4 rtl:mr-4">x</span></span
                            >
                        </div>
                    </div>
                </div>
