            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <ol class="flex font-semibold text-gray-500 dark:text-white-dark">
                        ...
                        <li class="before:px-1.5 before:content-['/']"><a href="javascript:;">Components</a></li>
                        <li class="before:px-1.5 before:content-['/']">
                            <a href="javascript:;" class="text-black hover:text-black/70 dark:text-white-light dark:hover:text-white-light/70">UI Kit</a>
                        </li>
                    </ol>
                </div>
...
&lt;/ol&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Arrowed</h5>
...
&lt;/ol&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Dotted Seperators</h5>
                ...
                <div class="mb-5">
                    <ol class="flex font-semibold text-gray-500 dark:text-white-dark">
                        ...
                        <li class="before:relative before:-top-0.5 before:mx-4 before:inline-block before:h-1 before:w-1 before:rounded-full before:bg-primary">
...
&lt;/ol&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">With Icons</h5>
