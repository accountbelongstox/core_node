    ...
    <div>
        ...
        <div class="grid grid-cols-1 gap-6 pt-5 xl:grid-cols-2">
            <div class="panel">
                ...
                <div class="mb-5">
                    <div class="w-full">
                        <div class="prose max-w-full rounded bg-[#f1f2f3] px-4 py-9 dark:bg-[#1b2e4b] dark:text-white-light sm:px-8 sm:py-16">
                            <h2 class="mb-5 mt-4 text-center text-5xl text-dark dark:text-white-light">Hello, world!</h2>
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Jumbotron Fluid</h5>
                ...
                <div class="mb-5">
                    <div class="w-full">
                        <div class="prose max-w-full rounded bg-[#f1f2f3] px-4 py-9 dark:bg-[#1b2e4b] dark:text-white-light sm:px-8 sm:py-16">
                            <h2 class="mb-5 mt-4 text-center text-5xl text-dark dark:text-white-light">Fluid Jumbotron</h2>
                            <p class="lead mt-3 mb-4 dark:text-white-light">
                            ...
                            >
                                ...
                                <small
                                    class="block w-full text-xs not-italic text-[#777] before:relative before:-top-1 before:inline-block before:h-[1px] before:w-3 before:bg-[#777] before:opacity-50 ltr:text-right before:ltr:mr-1 rtl:text-left rtl:before:ml-1"
