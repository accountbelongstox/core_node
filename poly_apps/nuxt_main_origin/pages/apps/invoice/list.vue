            ...
            <div class="datatable invoice-table">
                <div class="mb-4.5 flex flex-col gap-5 px-5 md:flex-row md:items-center">
                    <div class="flex items-center gap-2">
                        ...
                        <NuxtLink to="/apps/invoice/add" class="btn btn-primary gap-2">
                            <svg
                ...
                >
                    ...
                    <template #invoice="data">
                        <NuxtLink to="/apps/invoice/preview" class="font-semibold text-primary underline hover:no-underline"
                            >#{{ data.value.invoice }}</NuxtLink
                        >
                    </template>
                    <template #name="data">
                    ...
                    <template #actions="data">
                        <div class="flex items-center justify-center gap-4">
                            <NuxtLink to="/apps/invoice/edit" class="hover:text-info">
                            ...
                            <NuxtLink to="/apps/invoice/preview" class="hover:text-primary">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
                                    <path
                                        opacity="0.5"
    ...
    const deleteRow = (item: any = null) => {
        if (confirm('Are you sure want to delete selected row ?')) {
            if (item) {
                ...
                const ids = selectedRows.map((d: { id: any }) => {
                    return d.id;
                });
