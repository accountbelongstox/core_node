    ...
    <div>
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <client-only>
                        <apexchart height="300" :options="lineChart" :series="lineChartSeries" class="rounded-lg bg-white dark:bg-black"></apexchart>
                    </client-only>
                </div>
...
&lt;/script&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <client-only>
                        <apexchart height="300" :options="areaChart" :series="areaChartSeries" class="rounded-lg bg-white dark:bg-black"></apexchart>
                    </client-only>
                </div>
...
&lt;/script&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <client-only>
                        <apexchart height="300" :options="columnChart" :series="columnChartSeries" class="rounded-lg bg-white dark:bg-black"></apexchart>
                    </client-only>
                </div>
...
&lt;/script&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <client-only>
                        <apexchart height="300" :options="barChart" :series="barChartSeries" class="rounded-lg bg-white dark:bg-black"></apexchart>
                    </client-only>
                </div>
...
&lt;/script&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <client-only>
                        <apexchart height="300" :options="mixedChart" :series="mixedChartSeries" class="rounded-lg bg-white dark:bg-black"></apexchart>
                    </client-only>
                </div>
...
&lt;/script&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <client-only>
                        <apexchart height="300" :options="radarChart" :series="radarChartSeries" class="rounded-lg bg-white dark:bg-black"></apexchart>
                    </client-only>
                </div>
...
&lt;/script&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <client-only>
                        <apexchart height="300" :options="pieChart" :series="pieChartSeries" class="rounded-lg bg-white dark:bg-black"></apexchart>
                    </client-only>
                </div>
...
&lt;/script&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <client-only>
                        <apexchart height="300" :options="donutChart" :series="donutChartSeries" class="rounded-lg bg-white dark:bg-black"></apexchart>
                    </client-only>
                </div>
...
&lt;/script&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <client-only>
                        <apexchart height="300" :options="polarAreaChart" :series="polarAreaChartSeries" class="rounded-lg bg-white dark:bg-black"></apexchart>
                    </client-only>
                </div>
...
&lt;/script&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <client-only>
                        <apexchart height="300" :options="radialBarChart" :series="radialBarChartSeries" class="rounded-lg bg-white dark:bg-black"></apexchart>
                    </client-only>
                </div>
...
&lt;/script&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <client-only>
                        <apexchart height="300" :options="bubbleChart" :series="bubbleChartSeries" class="rounded-lg bg-white dark:bg-black"></apexchart>
                    </client-only>
                </div>
