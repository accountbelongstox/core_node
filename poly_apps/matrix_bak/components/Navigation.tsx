      ...
      <div className="py-6 flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex flex-col gap-1">
          ...
          >
             ...
             <i className="ph ph-squares-four text-xl mx-auto md:mx-0 md:mr-3 group-hover:text-[#00f2ff] transition-colors"></i>
             {!collapsed && <span className="text-xs font-medium">Matrix View</span>}
          </div>
