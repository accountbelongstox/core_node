...
const WordGroupListPage: React.FC = () => {
        ...
        {wordGroups.length === 0 ? (
          ...
          wordGroups.map((group) => (
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('WordGroupDetail' as never, { groupId: group.id } as never)}
            >
              <View style={{ flex: 1 }}>
...
export default WordGroupListPage;
