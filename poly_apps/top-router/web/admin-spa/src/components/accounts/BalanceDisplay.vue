...
const load = async () => {
  ...
  try {
    const response = await adminApi.get(`/admin/accounts/${props.accountId}/balance`, {
...
const refresh = async () => {
  ...
  try {
    const response = await adminApi.post(`/admin/accounts/${props.accountId}/balance/refresh`, {
