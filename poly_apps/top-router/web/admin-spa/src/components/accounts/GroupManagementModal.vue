...
const createGroup = async () => {
  ...
  creating.value = true
  try {
    await adminApi.post('/admin/account-groups', {
...
const updateGroup = async () => {
  ...
  updating.value = true
  try {
    await adminApi.put(`/admin/account-groups/${editingGroup.value.id}`, {
...
const deleteGroup = async (group) => {
  ...
  try {
    await adminApi.delete(`/admin/account-groups/${group.id}`)
