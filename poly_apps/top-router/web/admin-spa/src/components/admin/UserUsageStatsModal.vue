        ...
        <div class="mb-6 flex items-center justify-between">
          <div>
            <h3 class="text-lg font-medium text-gray-900">
              使用统计 - {{ user?.displayName || user?.username }}
            </h3>
        ...
        <div v-else class="space-y-6">
              ...
              <div class="p-5">
                <div class="flex items-center">
                  ...
                  <div class="ml-5 w-0 flex-1">
                    <dl>
                      <dt class="truncate text-sm font-medium text-blue-600">请求数</dt>
            ...
            <div class="overflow-hidden rounded-lg bg-green-50 shadow">
              <div class="p-5">
                <div class="flex items-center">
                  ...
                  <div class="ml-5 w-0 flex-1">
                    <dl>
                      <dt class="truncate text-sm font-medium text-green-600">输入 Tokens</dt>
            ...
            <div class="overflow-hidden rounded-lg bg-purple-50 shadow">
              <div class="p-5">
                <div class="flex items-center">
                  ...
                  <div class="ml-5 w-0 flex-1">
                    <dl>
                      <dt class="truncate text-sm font-medium text-purple-600">输出 Tokens</dt>
            ...
            <div class="overflow-hidden rounded-lg bg-yellow-50 shadow">
              <div class="p-5">
                <div class="flex items-center">
                  ...
                  <div class="ml-5 w-0 flex-1">
                    <dl>
                      <dt class="truncate text-sm font-medium text-yellow-600">总成本</dt>
          ...
          >
            <div class="border-b border-gray-200 px-4 py-5 sm:px-6">
              <h4 class="text-lg font-medium leading-6 text-gray-900">API Key 使用情况</h4>
            </div>
              ...
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                  <tr v-for="apiKey in userDetails.apiKeys" :key="apiKey.id">
                    ...
                    <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-900">
                      <div>输入: {{ formatNumber(apiKey.usage?.inputTokens || 0) }}</div>
                      <div>输出: {{ formatNumber(apiKey.usage?.outputTokens || 0) }}</div>
                    </td>
                    <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-900">
                      ${{ (apiKey.usage?.totalCost || 0).toFixed(4) }}
                    </td>
                    <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500">
                      {{ apiKey.lastUsedAt ? formatDate(apiKey.lastUsedAt) : '从未' }}
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          <div class="rounded-lg border border-gray-200 bg-white">
            <div class="border-b border-gray-200 px-4 py-5 sm:px-6">
              <h4 class="text-lg font-medium leading-6 text-gray-900">使用趋势</h4>
            </div>
            <div class="p-6">
              <div
              ...
              >
                <div class="text-center">
                  ...
                  <h3 class="mt-2 text-sm font-medium text-gray-900">使用图表</h3>
                  <p class="mt-1 text-sm text-gray-500">
                    {{ getPeriodText(selectedPeriod) }}的每日使用趋势
                  </p>
                  <p class="mt-2 text-xs text-gray-400">
                    （可使用 Chart.js、D3.js 或类似库集成图表）
                  </p>
                </div>
              </div>
            </div>
          ...
          <div v-if="usageStats && usageStats.totalRequests === 0" class="py-12 text-center">
            ...
            <h3 class="mt-2 text-sm font-medium text-gray-900">暂无使用数据</h3>
            <p class="mt-1 text-sm text-gray-500">该用户在所选时间段内没有任何 API 请求。</p>
          </div>
        </div>
