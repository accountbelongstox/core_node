...
void ModernStyleSystem::setCurrentTheme(const QString &themeName)
{
    // Simple theme name to enum mapping
    if (themeName == "Light") {
        ...
        setCurrentTheme(Theme::Custom);
    }
}

QStringList ModernStyleSystem::availableThemes() const
{
    return QStringList() << "Light" << "Dark" << "Auto" << "Custom";
}

void ModernStyleSystem::loadTheme(const QString &themeName)
{
    setCurrentTheme(themeName);
}

void ModernStyleSystem::saveTheme(const QString &themeName)
{
    // TODO: Implement theme saving
    Q_UNUSED(themeName)
}

void ModernStyleSystem::deleteTheme(const QString &themeName)
{
...
void ModernStyleSystem::setBorderRadius(qreal radius)
{
...
void ModernStyleSystem::setShadowRadius(qreal radius)
{
...
void ModernStyleSystem::setupDefaultThemes()
{
    ...
    case Theme::Auto:
        ...
        setupDefaultThemes(); // Default to light for now
        break;
    case Theme::Custom:
...
void ModernStyleSystem::setupDefaultColors()
{
    // Colors are set in setupDefaultThemes()
}

void ModernStyleSystem::setupDefaultFonts()
{
    // Fonts are set in constructor
}

void ModernStyleSystem::setupDefaultAnimations()
{
    // Animation settings are set in constructor
}
