...
bool Recorder::open()
{
    ...
    QString comment = "Recorded by SmartMatrix " + QCoreApplication::applicationVersion();
...
#ifdef SmartMatrix_LAVF_HAS_NEW_CODEC_PARAMS_API
...
{
#ifdef SmartMatrix_LAVF_HAS_NEW_MUXER_ITERATOR_API
