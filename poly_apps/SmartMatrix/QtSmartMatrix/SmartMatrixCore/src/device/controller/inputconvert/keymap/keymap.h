...
// Qt6 API: QVector is now an alias for QList, use QList directly for best practice
#include <QList>
...
private:
    ...
    // Qt5: QVector<KeyMapNode> m_keyMapNodes;
    // Qt6: QVector is an alias for QList, use QList directly
    QList<KeyMapNode> m_keyMapNodes;
