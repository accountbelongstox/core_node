...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        languageWidget = new QWidget(configGroupBox);
        languageWidget->setObjectName("languageWidget");
        sizePolicy.setHeightForWidth(languageWidget->sizePolicy().hasHeightForWidth());
        languageWidget->setSizePolicy(sizePolicy);
        languageLayout = new QHBoxLayout(languageWidget);
        languageLayout->setSpacing(6);
        languageLayout->setContentsMargins(11, 11, 11, 11);
        languageLayout->setObjectName("languageLayout");
        ...
        verticalLayout_3->addWidget(languageWidget);
        ...
        devicePortEdt = new QComboBox(wirelessGroupBox);
        ...
        devicePortEdt->setMinimumSize(QSize(100, 0));
        devicePortEdt->setEditable(true);
        ...
        verticalSpacer = new QSpacerItem(40, 20, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        languageLabel->setText(QCoreApplication::translate("Widget", "Language:", nullptr));
        languageComboBox->setItemText(0, QCoreApplication::translate("Widget", "Auto", nullptr));
        languageComboBox->setItemText(1, QCoreApplication::translate("Widget", "English", nullptr));
        languageComboBox->setItemText(2, QCoreApplication::translate("Widget", "\344\270\255\346\226\207", nullptr));
        languageComboBox->setItemText(3, QCoreApplication::translate("Widget", "\346\227\245\346\234\254\350\252\236", nullptr));
        ...
        devicePortEdt->setCurrentText(QString());
