<template>
  <div class="app-base font-nunito text-sm font-normal antialiased" :class="[store.menu, store.rtlClass]">
...
<style scoped>
/* Base layout styles - minimal, no navigation-specific styles */
.app-base {
  position: relative;
}
