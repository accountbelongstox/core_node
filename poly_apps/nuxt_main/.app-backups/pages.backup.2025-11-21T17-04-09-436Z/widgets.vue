    ...
    <div>
        <div class="mb-6 grid gap-6 xl:grid-cols-3">
            <div class="panel h-full xl:col-span-2">
                ...
                <div class="relative">
                    <client-only>
                        <apexchart height="325" :options="revenueChart" :series="revenueSeries" class="rounded-lg bg-white dark:bg-black">
                            <!-- loader -->
            ...
            <div class="panel h-full">
                ...
                <div>
                    <client-only>
                        <apexchart height="460" :options="salesByCategory" :series="salesByCategorySeries" class="rounded-lg bg-white dark:bg-black">
                            <!-- loader -->
        ...
        <div class="mb-6 grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
            <div class="panel h-full sm:col-span-2 xl:col-span-1">
                ...
                <div>
                    <client-only>
                        <apexchart height="160" :options="dailySales" :series="dailySalesSeries" class="rounded-lg bg-white dark:bg-black">
                            <!-- loader -->
            ...
            <div class="panel h-full p-0">
                ...
                <client-only>
                    <apexchart height="290" :options="totalOrders" :series="totalOrdersSeries" class="rounded-lg bg-white dark:bg-black">
                        <!-- loader -->
            ...
            <div class="panel h-full pb-0 sm:col-span-2 xl:col-span-1">
                ...
                <client-only>
                    <perfect-scrollbar
                        ...
                        class="relative mb-4 -mr-3 h-[290px] pr-3"
                    >
            ...
            <div class="panel h-full">
                ...
                <div>
                    <div class="space-y-6">
                        ...
                        <div class="flex">
                            <span class="grid h-9 w-9 place-content-center rounded-md bg-info-light text-base text-info dark:bg-info dark:text-info-light"
                                >DA</span
                            >
                            <div class="flex-1 px-3">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                ...
                                <td><NuxtLink to="/apps/invoice/preview">#46894</NuxtLink></td>
                                <td>$56.07</td>
                            ...
                            <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                ...
                                <td><NuxtLink to="/apps/invoice/preview">#76894</NuxtLink></td>
                                <td>$126.04</td>
                            ...
                            <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                ...
                                <td><NuxtLink to="/apps/invoice/preview">#66894</NuxtLink></td>
                                <td>$56.07</td>
                                <td><span class="badge bg-success shadow-md dark:group-hover:bg-transparent">Paid</span></td>
                            </tr>
                            <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                ...
                                <td><NuxtLink to="/apps/invoice/preview">#75844</NuxtLink></td>
                                <td>$110.00</td>
                                <td><span class="badge bg-secondary shadow-md dark:group-hover:bg-transparent">Shipped</span></td>
                            </tr>
                            <tr class="group text-white-dark hover:text-black dark:hover:text-white-light/90">
        ...
        <div class="mb-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div
                class="panel grid h-full grid-cols-1 content-between overflow-hidden before:absolute before:-right-44 before:top-0 before:bottom-0 before:m-auto before:h-96 before:w-96 before:rounded-full before:bg-[#1937cc]"
            ...
            <div class="panel h-full">
                ...
                <client-only>
                    <perfect-scrollbar
                        ...
                        class="relative -mr-3 h-[360px] pr-3"
                    >
                        <div class="space-y-7">
                            <div class="flex">
                                <div
                                    class="relative z-10 before:absolute before:top-10 before:left-4 before:h-[calc(100%-24px)] before:w-[2px] before:bg-white-dark/30 ltr:mr-2 rtl:ml-2"
                                >
        ...
        <div class="mb-6 grid gap-6 sm:grid-cols-3 xl:grid-cols-5">
            ...
            <div class="panel h-full p-0">
                <div class="flex p-5">
                    <div class="flex h-11 w-11 items-center justify-center rounded-xl bg-primary/10 text-primary dark:bg-primary dark:text-white-light">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
                            <circle cx="12" cy="6" r="4" stroke="currentColor" stroke-width="1.5" />
                            <path
                                opacity="0.5"
                ...
                <div class="h-40">
                    <client-only>
                        <apexchart height="160" :options="followers" :series="followersSeries" class="absolute bottom-0 w-full">
                            <!-- loader -->
                            <div class="grid min-h-[160px] place-content-center bg-white-light/30 dark:bg-dark dark:bg-opacity-[0.08]">
                                <span
                                    class="inline-flex h-5 w-5 animate-spin rounded-full border-2 border-black !border-l-transparent dark:border-white"
                                ></span>
                            </div>
            ...
            <div class="panel h-full p-0">
                <div class="flex p-5">
                    <div class="flex h-11 w-11 items-center justify-center rounded-xl bg-danger/10 text-danger dark:bg-danger dark:text-white-light">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
                            <path
                ...
                <div class="h-40">
                    <client-only>
                        <apexchart height="160" :options="referral" :series="referralSeries" class="absolute bottom-0 w-full">
                            <!-- loader -->
                            <div class="grid min-h-[160px] place-content-center bg-white-light/30 dark:bg-dark dark:bg-opacity-[0.08]">
                                <span
                                    class="inline-flex h-5 w-5 animate-spin rounded-full border-2 border-black !border-l-transparent dark:border-white"
            ...
            <div class="panel h-full p-0">
                <div class="flex p-5">
                    <div class="flex h-11 w-11 items-center justify-center rounded-xl bg-success/10 text-success dark:bg-success dark:text-white-light">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
                            <path
                ...
                <div class="h-40">
                    <client-only>
                        <apexchart height="160" :options="engagement" :series="engagementSeries" class="absolute bottom-0 w-full">
                            <!-- loader -->
                            <div class="grid min-h-[160px] place-content-center bg-white-light/30 dark:bg-dark dark:bg-opacity-[0.08]">
                                <span
                                    class="inline-flex h-5 w-5 animate-spin rounded-full border-2 border-black !border-l-transparent dark:border-white"
        ...
        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            <div class="panel h-full">
                <div class="-m-5 mb-5 flex items-start border-b border-[#e0e6ed] p-5 dark:border-[#1b2e4b]">
                    <div class="rounded-full ring-2 ring-white-light ltr:mr-4 rtl:ml-4 dark:ring-dark">
            ...
            <div class="panel h-full">
                <div class="-m-5 mb-5 flex items-center justify-between border-b border-[#e0e6ed] p-5 dark:border-[#1b2e4b]">
                    <a href="javascript:;" class="flex font-semibold">
                        <div class="flex h-10 w-10 items-center justify-center rounded-md bg-secondary text-white ltr:mr-4 rtl:ml-4">
                            <span>FD</span>
                        </div>
                        <div>
                            <h6>Figma Design</h6>
