        ...
        <div class="panel m-6 w-full max-w-lg sm:w-[480px]">
            <h2 class="mb-5 text-2xl font-bold">
                <svg
                    ...
                    class="inline-block h-7 w-7 text-primary ltr:mr-1 rtl:ml-1"
                >
                    <path
                        opacity="0.5"
            ...
            <form class="space-y-4" @submit.prevent="router.push('/')">
                <div class="relative">
                    <span class="absolute top-2.5 text-primary ltr:left-2 rtl:right-2">
                ...
                <div class="relative">
                    ...
                    <textarea rows="4" class="form-textarea resize-none ltr:pl-8 rtl:pr-8" placeholder="Message"></textarea>
                </div>
