                ...
                <div class="panel">
                    ...
                    <TabGroup as="div" class="mb-5">
                        <TabList class="mt-3 flex flex-wrap">
                            ...
                            <Tab as="template" disabled>
                                <a href="javascript:;" class="pointer-events-none -mb-[1px] block rounded p-3.5 py-2 text-white-light dark:text-dark"
                                    >Disabled</a
                                >
                            </Tab>
                        </TabList>
...
&lt;/script&gt;
                ...
                <div class="panel">
                    ...
                    <TabGroup as="div" class="mb-5">
                        <TabList class="mt-3 mb-5 flex flex-wrap">
                            <Tab as="template" v-slot="{ selected }">
                                <a
                                    href="javascript:;"
...
&lt;/script&gt;
                ...
                <div class="panel">
                    ...
                    <TabGroup as="div" class="mb-5">
                        <TabList class="mt-3 mb-5 flex flex-wrap border-b border-white-light dark:border-[#191e3a]">
                            <Tab as="template" v-slot="{ selected }">
                                <a
                                    href="javascript:;"
...
&lt;/script&gt;
                ...
                <div class="panel">
                    ...
                    <TabGroup as="div" class="mb-5">
                        <TabList class="mt-3 flex flex-wrap justify-between border-b border-white-light text-center dark:border-[#191e3a]">
                            <Tab as="template" v-slot="{ selected }">
                                <a
                                    href="javascript:;"
...
&lt;/script&gt;
                ...
                <div class="panel">
                    ...
                    <TabGroup as="div" class="mb-5">
                        <TabList class="mt-3 mb-5 grid grid-cols-4 gap-2 rtl:space-x-reverse sm:flex sm:flex-wrap sm:justify-center sm:space-x-3">
                            <Tab as="template" v-slot="{ selected }">
                                <a
                                    href="javascript:;"
...
&lt;/script&gt;
                ...
                <div class="panel">
                    ...
                    <TabGroup as="div" class="mb-5">
                        <TabList class="mt-3 mb-5 flex flex-wrap justify-center space-x-3 rtl:space-x-reverse">
                            <Tab as="template" v-slot="{ selected }">
                                <a
                                    href="javascript:;"
...
&lt;/script&gt;
                ...
                <div class="panel">
                    ...
                    <TabGroup as="div" class="mb-5 flex flex-col sm:flex-row">
                        <TabList class="mb-5 space-y-2 ltr:pr-4 rtl:pl-4 sm:order-1 sm:mb-0 sm:flex-[0_0_20%]">
                            <Tab as="template" v-slot="{ selected }"
                                ><a
                                    href="javascript:;"
                                    class="block rounded-md p-3.5 py-2 !outline-none transition-all duration-300 hover:bg-success hover:text-white"
