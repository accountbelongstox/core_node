        ...
        <div class="grid grid-cols-1 gap-6 pt-5 lg:grid-cols-2">
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Card 1</h5>
                ...
                <div class="mb-5 flex items-center justify-center">
                    ...
                    >
                        <div class="py-7 px-6">
                            ...
                            <h5 class="mb-4 text-xl font-semibold text-[#3b3f5c] dark:text-white-light">Simple</h5>
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Card 2</h5>
                ...
                <div class="mb-5 flex items-center justify-center">
                    ...
                    >
                        <div class="py-7 px-6">
                            <div class="-mx-6 -mt-7 mb-7 h-[215px] overflow-hidden rounded-tl rounded-tr">
                                <img src="/assets/images/profile-28.jpeg" alt="" class="h-full w-full object-cover" />
                            </div>
                            <h5 class="mb-4 text-xl font-semibold text-[#3b3f5c] dark:text-white-light">CLI Based</h5>
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Card 3</h5>
                ...
                <div class="mb-5 flex items-center justify-center">
                    <div
                        class="w-full max-w-[18rem] rounded border border-[#e0e6ed] bg-[#3b3f5c] p-5 shadow-[4px_6px_10px_-3px_#bfc9d4] dark:border-[#1b2e4b] dark:bg-[#191e3a] dark:shadow-none"
                    >
                        <div class="text-center text-black-light">
                            <div class="mx-auto mb-5 h-20 w-20 overflow-hidden rounded-full">
                                <img src="/assets/images/profile-34.jpeg" alt="" class="h-full w-full object-cover" />
                            </div>
                            <h5 class="mb-2 text-[15px] font-semibold text-white">Luke Ivory</h5>
                            <p>Manager</p>
                            <div class="my-4 flex items-center justify-center text-[#e2a03f]">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 fill-[#e2a03f]">
                                    <path
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Card 4</h5>
                ...
                <div class="mb-5 flex items-center justify-center">
                    <div
                        class="w-full max-w-[30rem] rounded border border-[#e0e6ed] bg-white shadow-[4px_6px_10px_-3px_#bfc9d4] dark:border-[#1b2e4b] dark:bg-[#191e3a] dark:shadow-none"
                    >
                        <div class="flex flex-col items-center p-5 sm:flex-row">
                            <div class="mb-5 h-20 w-20 overflow-hidden rounded-full">
                                <img src="/assets/images/profile-34.jpeg" alt="" class="h-full w-full object-cover" />
                            </div>
                            <div class="flex-1 text-center sm:text-left ltr:sm:pl-5 rtl:sm:pr-5">
                                <h5 class="mb-2 text-[15px] font-semibold text-[#3b3f5c] dark:text-white-light">Luke Ivory</h5>
                                <p class="mb-2 text-white-dark">Manager</p>
                                <span class="badge rounded-full bg-primary">4.5</span>
                                <p class="mt-4 font-semibold text-white-dark sm:mt-8">
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Card 5</h5>
                ...
                <div class="mb-5 flex items-center justify-center">
                    <div
                        class="w-full max-w-[20rem] rounded border border-[#e0e6ed] bg-secondary p-5 shadow-[4px_6px_10px_-3px_#bfc9d4] dark:border-0 dark:bg-secondary-dark-light dark:shadow-none"
                    >
                        <div class="text-black-light">
                            ...
                            <div class="flex">
                                <div class="mx-auto mb-5 h-14 w-14 overflow-hidden rounded-full">
                                    <img src="/assets/images/profile-34.jpeg" alt="" class="h-full w-full object-cover" />
                                </div>
                                <div class="flex-1 ltr:pl-4 rtl:pr-4">
                                    <h5 class="mb-1 text-[15px] font-semibold text-white">Luke Ivory</h5>
                                    <p>Manager</p>
                                </div>
                            </div>
                        </div>
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Card 6</h5>
                ...
                <div class="mb-5 flex items-center justify-center">
                    <div
                        class="w-full max-w-[20rem] rounded border border-[#e0e6ed] bg-white p-5 shadow-[4px_6px_10px_-3px_#bfc9d4] dark:border-[#1b2e4b] dark:bg-[#191e3a] dark:shadow-none"
                    >
                        <div class="text-[#515365] dark:text-white-light">
                            <p class="mb-5 font-semibold italic">
                                Maecenas nec mi vel lacus condimentum rhoncus dignissim egestas orci. Integer blandit porta placerat. Vestibulum in ultricies.
                            </p>
                            <div class="flex">
                                <div class="flex-1">
                                    <h5 class="mb-1.5 text-[15px] font-bold text-[#3b3f5c] dark:text-white-light">Luke Ivory</h5>
                                    <p class="mb-1.5 text-white-dark">Manager</p>
                                    <div class="flex items-center justify-start text-[#e2a03f]">
                                        <svg
                                            width="24"
                                            height="24"
                                            viewBox="0 0 24 24"
                                        ...
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-3 w-3">
                                            <path
                                                d="M9.15316 5.40838C10.4198 3.13613 11.0531 2 12 2C12.9469 2 13.5802 3.13612 14.8468 5.40837L15.1745 5.99623C15.5345 6.64193 15.7144 6.96479 15.9951 7.17781C16.2757 7.39083 16.6251 7.4699 17.3241 7.62805L17.9605 7.77203C20.4201 8.32856 21.65 8.60682 21.9426 9.54773C22.2352 10.4886 21.3968 11.4691 19.7199 13.4299L19.2861 13.9372C18.8096 14.4944 18.5713 14.773 18.4641 15.1177C18.357 15.4624 18.393 15.8341 18.465 16.5776L18.5306 17.2544C18.7841 19.8706 18.9109 21.1787 18.1449 21.7602C17.3788 22.3417 16.2273 21.8115 13.9243 20.7512L13.3285 20.4768C12.6741 20.1755 12.3469 20.0248 12 20.0248C11.6531 20.0248 11.3259 20.1755 10.6715 20.4768L10.0757 20.7512C7.77268 21.8115 6.62118 22.3417 5.85515 21.7602C5.08912 21.1787 5.21588 19.8706 5.4694 17.2544L5.53498 16.5776C5.60703 15.8341 5.64305 15.4624 5.53586 15.1177C5.42868 14.773 5.19043 14.4944 4.71392 13.9372L4.2801 13.4299C2.60325 11.4691 1.76482 10.4886 2.05742 9.54773C2.35002 8.60682 3.57986 8.32856 6.03954 7.77203L6.67589 7.62805C7.37485 7.4699 7.72433 7.39083 8.00494 7.17781C8.28555 6.96479 8.46553 6.64194 8.82547 5.99623L9.15316 5.40838Z"
                                                stroke="currentColor"
                                                stroke-width="1.5"
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Card 7</h5>
                ...
                <div class="mb-5 flex items-center justify-center">
                    <div
                        class="w-full max-w-[20rem] rounded border border-[#e0e6ed] bg-primary p-5 shadow-[4px_6px_10px_-3px_#bfc9d4] dark:border-0 dark:bg-primary-dark-light dark:shadow-none"
                    >
                        <div class="text-center font-semibold">
                            <h5 class="mb-5 text-xl font-bold text-white dark:text-white-light">Rating</h5>
                            <p class="mb-5 text-base text-white">(4.3)</p>
                            <div class="flex items-center justify-center gap-1 text-[#e2a03f]">
                                <svg
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Card 8</h5>
                ...
                <div class="mb-5 flex items-center justify-center">
                    <div
                        class="w-full max-w-[24rem] rounded border border-[#e0e6ed] bg-white p-5 shadow-[4px_6px_10px_-3px_#bfc9d4] dark:border-[#1b2e4b] dark:bg-[#191e3a] dark:shadow-none"
                    >
                        <div class="mb-5 flex justify-between">
                            <h6 class="text-base font-semibold text-[#0e1726] dark:text-white-light">Placed Order</h6>
                            <span class="badge bg-primary/10 py-1.5 text-primary dark:bg-primary dark:text-white">IN PROGRESS</span>
                        </div>
                        <div class="mb-5 flex items-center justify-start -space-x-3 rtl:space-x-reverse">
                            <img
                                class="h-9 w-9 overflow-hidden rounded-full object-cover shadow-[0_0_15px_1px_rgba(113,106,202,0.30)] ring-2 ring-white dark:shadow-none dark:ring-[#515365]"
                            ...
                            />
                            <span
                                class="rounded-full bg-white px-2 py-1 text-xs text-primary shadow-[0_0_20px_0_#d0d0d0] dark:bg-[#0e1726] dark:text-white dark:shadow-none"
                                >+5 more</span
                            >
                        </div>
                        <div class="text-right">
                            <span class="font-semibold text-primary">60%</span>
                            <div class="mt-1.5 h-1.5 w-full rounded-full bg-[#ebedf2] dark:bg-[#0e1726]">
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Card 9</h5>
                ...
                <div class="mb-5 flex items-center justify-center">
                    ...
                    >
                        <div class="py-7 px-6">
                            ...
                            <p class="mb-1.5 text-xs font-bold text-primary">25 Sep 2020</p>
                            <h5 class="mb-4 text-[15px] font-bold text-[#3b3f5c] dark:text-white-light">How to Start a Blog in 5 Easy Steps.</h5>
                            <p class="text-white-dark">Vestibulum vestibulum tortor ut eros tincidunt, ut rutrum elit volutpat.</p>
                            <div
                                class="relative mt-6 flex justify-between pt-4 before:absolute before:inset-x-0 before:top-0 before:mx-auto before:h-[1px] before:w-[250px] before:bg-[#e0e6ed] dark:before:bg-[#1b2e4b]"
                            >
                                <div class="flex items-center font-semibold">
                                    <div class="inline-block h-9 w-9 overflow-hidden rounded-full ltr:mr-2 rtl:ml-2.5">
                                        <span class="flex h-full w-full items-center justify-center bg-[#515365] text-[#e0e6ed]">AG</span>
                                    </div>
