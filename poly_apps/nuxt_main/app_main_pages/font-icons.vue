                ...
                <div class="mb-5">
                    ...
                    <p class="mb-5">
                        ...
                        <a
                            ...
                            target="_blank"
                            class="font-semibold text-primary hover:text-black hover:underline dark:hover:text-white-dark"
                            >Solar Icon Set</a
                        >
                    </p>
                    <div class="mb-5 inline-block rounded bg-[#009688]/[.26] py-1 px-2 text-base text-[#009688]">Line Duotone</div>
                    ...
                    <div class="mb-5 inline-block rounded bg-[#009688]/[.26] py-1 px-2 text-base text-[#009688]">Bold Duotone</div>
                    <div class="mb-5 flex flex-wrap items-center gap-10">
                        <div class="grid h-14 w-14 place-content-center rounded-md border border-white-dark/20 dark:border-[#191e3a]">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="mb-5 inline-block rounded bg-[#009688]/[.26] py-1 px-2 text-base text-[#009688]">Broken</div>
                    <div class="mb-5 flex flex-wrap items-center gap-10">
                        <div class="grid h-14 w-14 place-content-center rounded-md border border-white-dark/20 dark:border-[#191e3a]">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="mb-5 inline-block rounded bg-[#009688]/[.26] py-1 px-2 text-base text-[#009688]">Outline</div>
                    <div class="mb-5 flex flex-wrap items-center gap-10">
                        <div class="grid h-14 w-14 place-content-center rounded-md border border-white-dark/20 dark:border-[#191e3a]">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="mb-5 inline-block rounded bg-[#009688]/[.26] py-1 px-2 text-base text-[#009688]">Bold</div>
