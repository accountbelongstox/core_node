<template>
    <div>
        <div class="relative flex h-full gap-5 sm:h-[calc(100vh_-_150px)] sm:min-h-0" :class="{ 'min-h-[999px]': isShowChatMenu }">
            <div
                class="panel absolute z-10 hidden h-full w-full max-w-xs flex-none space-y-4 overflow-hidden p-4 xl:relative xl:block"
            ...
            >
                ...
                <div class="relative">
                    <input type="text" class="peer form-input ltr:pr-9 rtl:pl-9" placeholder="Searching..." v-model="searchUser" />
                ...
                <div class="!mt-0">
                    <client-only>
                        <perfect-scrollbar
                            ...
                            class="chat-users relative -mr-3.5 h-full min-h-[100px] space-y-0.5 pr-3.5 sm:h-[calc(100vh_-_357px)]"
                        >
                            <template v-for="person in searchUsers" :key="person.id">
                                <button
                                    ...
                                    :class="{
                                        'bg-gray-100 text-primary dark:bg-[#050b14] dark:text-primary': selectedUser && selectedUser.userId === person.userId,
                                    }"
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center">
                                            ...
                                            <div class="mx-3 ltr:text-left rtl:text-right">
                                                ...
                                                <p class="max-w-[185px] truncate text-xs text-white-dark">{{ person.preview }}</p>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="panel flex-1 p-0">
                ...
                <template v-if="isShowUserChat && selectedUser">
                    <div class="relative h-full">
                        ...
                        <div class="h-px w-full border-b border-[#e0e6ed] dark:border-[#1b2e4b]"></div>
                        <client-only>
                            <perfect-scrollbar class="chat-conversation-box relative h-full sm:h-[calc(100vh_-_300px)]">
                                <div class="min-h-[400px] space-y-5 p-4 pb-[68px] sm:min-h-[300px] sm:pb-0">
