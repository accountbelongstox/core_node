        ...
        <div class="space-y-8 pt-5">
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Default Alerts</h5>
                ...
                <div class="mb-5 grid grid-cols-1 gap-5 lg:grid-cols-2">
                    <div class="flex items-center rounded bg-primary-light p-3.5 text-primary dark:bg-primary-dark-light">
                    ...
                    <div class="flex items-center rounded bg-secondary-light p-3.5 text-secondary dark:bg-secondary-dark-light">
                        <span class="ltr:pr-2 rtl:pl-2"
                    ...
                    <div class="flex items-center rounded bg-warning-light p-3.5 text-warning dark:bg-warning-dark-light">
                        <span class="ltr:pr-2 rtl:pl-2"
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Outline Alerts</h5>
                ...
                <div class="mb-5 grid grid-cols-1 gap-5 lg:grid-cols-2">
                    <div class="flex items-center rounded border border-primary p-3.5 text-white-dark">
                        <span class="ltr:pr-2 rtl:pl-2">
                    ...
                    <div class="flex items-center rounded border border-danger p-3.5 text-white-dark">
                        <span class="ltr:pr-2 rtl:pl-2">
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Solid Alerts</h5>
                ...
                <div class="mb-5 grid grid-cols-1 gap-5 lg:grid-cols-2">
                    <div class="flex items-center rounded bg-primary p-3.5 text-white">
                        <span class="ltr:pr-2 rtl:pl-2">
                    ...
                    <div class="flex items-center rounded bg-warning p-3.5 text-white">
                        <span class="ltr:pr-2 rtl:pl-2"><strong class="ltr:mr-1 rtl:ml-1">Info!</strong>Lorem Ipsum is simply dummy text of the printing.</span>
                        <button type="button" class="hover:opacity-80 ltr:ml-auto rtl:mr-auto">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Alerts with icon</h5>
                ...
                <div class="mb-5 grid grid-cols-1 gap-5 lg:grid-cols-2">
                    <div
                        class="relative flex items-center rounded border border-success bg-success-light p-3.5 text-success ltr:border-l-[64px] rtl:border-r-[64px] dark:bg-success-dark-light"
                    >
                    ...
                    <div
                        class="relative flex items-center rounded border border-dark bg-dark-light p-3.5 text-dark ltr:border-r-[64px] rtl:border-l-[64px] dark:border-white-light/20 dark:bg-dark-dark-light dark:text-white-light"
                    >
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Arrowed Alerts</h5>
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Custom Alerts</h5>
                ...
                <div class="mb-5 grid grid-cols-1 gap-5 lg:grid-cols-2">
                    <div class="flex items-center rounded bg-info p-3.5 text-white">
                        <span class="h-6 w-6 text-white ltr:mr-4 rtl:ml-4">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6">
                                <path
                                    d="M19.0001 9.7041V9C19.0001 5.13401 15.8661 2 12.0001 2C8.13407 2 5.00006 5.13401 5.00006 9V9.7041C5.00006 10.5491 4.74995 11.3752 4.28123 12.0783L3.13263 13.8012C2.08349 15.3749 2.88442 17.5139 4.70913 18.0116C9.48258 19.3134 14.5175 19.3134 19.291 18.0116C21.1157 17.5139 21.9166 15.3749 20.8675 13.8012L19.7189 12.0783C19.2502 11.3752 19.0001 10.5491 19.0001 9.7041Z"
                                    stroke="currentColor"
                    ...
                    <div
                        class="flex items-center rounded p-3.5 text-white"
                    ...
                    <div class="flex items-center rounded bg-[url('/assets/images/menu-heade.jpg')] bg-cover bg-center bg-no-repeat p-3.5 text-white">
                        <span class="ltr:pr-2 rtl:pl-2"
                            ><strong class="ltr:mr-1 rtl:ml-1">Warning!</strong>Lorem Ipsum is simply dummy text of the printing.</span
                        >
                        <button type="button" class="hover:opacity-80 ltr:ml-auto rtl:mr-auto">
