...
import { useItToolsStore } from '@/app_ittools_pages/stores/ittools-store';
import type { Tool } from '@/app_ittools_pages/types';
import ToolExecutionPanel from '@/app_ittools_pages/components/ToolExecutionPanel.vue';
import BrowserAutomationPanel from '@/app_ittools_pages/components/BrowserAutomationPanel.vue';
import WindowsOperationsPanel from '@/app_ittools_pages/components/WindowsOperationsPanel.vue';
import NginxManagementPanel from '@/app_ittools_pages/components/NginxManagementPanel.vue';
import { useApiClient } from '@/app_ittools_pages/composables/useApiClient';
import { appLogger, type LogEntry, type LogLevel } from '@/app_ittools_pages/services/logger';
import ItToolsTopBar from '@/app_ittools_pages/components/ittools_index_components/ItToolsTopBar.vue';
import ItToolsSidebar from '@/app_ittools_pages/components/ittools_index_components/ItToolsSidebar.vue';
import QuickNavDropdown from '@/app_ittools_pages/components/ittools_index_components/QuickNavDropdown.vue';
import CategoryTreePanel from '@/app_ittools_pages/components/ittools_index_components/CategoryTreePanel.vue';
import ItToolsSearchPanel from '@/app_ittools_pages/components/ittools_index_components/ItToolsSearchPanel.vue';
import ItToolsActiveCard from '@/app_ittools_pages/components/ittools_index_components/ItToolsActiveCard.vue';
