<template>
    <div :class="{ 'dark text-white-dark': config.semidark }">
                            ...
                            <li class="menu nav-item">
                                ...
                                <vue-collapsible :isOpen="activeDropdown === 'datatables'">
                                    <ul class="sub-menu text-gray-500">
                                        ...
                                        <li>
                                            <NuxtLink to="/datatables/alt-pagination" @click="toggleMobileMenu">{{ $t('alt._pagination') }}</NuxtLink>
                                        </li>
                                        <li>
                            ...
                            <li class="menu nav-item">
                                ...
                                <vue-collapsible :isOpen="activeDropdown === 'forms'">
                                    <ul class="sub-menu text-gray-500">
                                        ...
                                        <li>
                                            <NuxtLink to="/forms/checkbox-radio" @click="toggleMobileMenu">{{ $t('checkbox_&_radio') }}</NuxtLink>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <NuxtLink to="/forms/date-picker" @click="toggleMobileMenu">{{ $t('date_&_range_picker') }}</NuxtLink>
                                        </li>
                                        <li>
