...
&lt;/form&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Input Password</h5>
...
&lt;/form&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Input Email</h5>
...
&lt;/form&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Input Url</h5>
...
&lt;/form&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Input Telephone</h5>
...
&lt;/form&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Input Search</h5>
...
&lt;/form&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Input Range</h5>
...
&lt;/form&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Input With Label</h5>
...
&lt;/form&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Form grid</h5>
...
&lt;/form&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Form row</h5>
...
&lt;/form&gt;
            ...
            <div class="panel lg:col-span-2">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Column sizing</h5>
...
&lt;/form&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Input with help text ( Default Left)</h5>
                ...
                <div class="mb-5">
                    <form>
                        <div>
                            <input type="text" placeholder="Enter First Name" class="form-input" />
                            <span class="text-xs text-white-dark">I am the helper text.</span>
                        </div>
                    </form>
                </div>
...
&lt;/form&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Input with badge help text (Default Left)</h5>
...
&lt;/form&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Input with block badge help text (Default Left)</h5>
                ...
                <div class="mb-5">
                    <form>
                        <div>
                            <input type="text" placeholder="Enter First Name" class="form-input mb-2" />
                            <span class="badge block bg-primary text-xs hover:top-0">I am the helper text.</span>
                        </div>
                    </form>
                </div>
...
&lt;/form&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Inline Help text</h5>
...
&lt;/form&gt;
            ...
            <div class="panel lg:col-span-2">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Input Fields</h5>
                    ...
                    <form>
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                            <div>
                                ...
                                <input id="inputLarge" type="text" placeholder="Large Input" class="form-input-lg form-input" />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input id="inputSmall" type="text" placeholder="Small Input" class="form-input-sm form-input" />
                            </div>
                        </div>
                    </form>
                </div>
...
&lt;/form&gt;
            ...
            <div class="panel lg:col-span-2">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Select Field</h5>
                ...
                <div class="mb-5">
                    <form>
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                            <div>
                                <select class="form-select-lg form-select text-white-dark">
                                    <option>Open this select menu</option>
                                    <option>One</option>
                                    <option>Two</option>
                                    <option>Three</option>
                            ...
                            <div>
                                <select class="form-select-sm form-select text-white-dark">
                                    <option>Open this select menu</option>
                                    <option>One</option>
                                    <option>Two</option>
                                    <option>Three</option>
...
&lt;/form&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Horizontal form label sizing</h5>
                ...
                <div class="mb-5">
                    <form class="space-y-5">
                        <div class="items-center justify-between gap-5 sm:flex md:gap-20">
...
&lt;/form&gt;
            ...
            <div class="panel lg:row-start-[14]">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Input Readonly</h5>
...
&lt;/form&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Disabled Fields</h5>
                ...
                <div class="mb-5">
                    <form class="space-y-5">
                        ...
                        <div>
                            ...
                            <select
                                id="disSelect"
                                class="form-select text-white-dark disabled:pointer-events-none disabled:bg-[#eee] dark:disabled:bg-[#1b2e4b]"
                                disabled
                            >
                                <option>Open this select menu</option>
                                <option>One</option>
...
&lt;/form&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Radio</h5>
...
&lt;/form&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Disabled</h5>
...
&lt;/form&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Select menu</h5>
...
&lt;/form&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Multiselect</h5>
                ...
                <div class="mb-5">
                    <form>
                        <div>
                            <select size="4" multiple class="form-multiselect !bg-none text-white-dark">
                                <option>Open this select menu</option>
                                <option>One</option>
                                <option>Two</option>
                                <option>Three</option>
