        ...
        <div class="flex items-center space-x-4">
          ...
          <div v-if="!authStore.isAuthenticated" class="flex items-center space-x-2">
            <button
              ...
              class="px-3 py-1.5 text-sm font-medium text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-lg transition"
            >
              Login
            </button>
            <button
          ...
          <div v-else class="relative">
            <button
              ...
              class="flex items-center space-x-2 px-3 py-1.5 rounded-lg hover:bg-gray-100 transition"
            >
