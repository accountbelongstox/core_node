                ...
                <div class="flex h-full flex-col pb-16">
                    ...
                    <client-only>
                        <perfect-scrollbar
                            ...
                            class="relative -mr-3.5 h-full grow pr-3.5"
                        >
                            <div class="space-y-1">
                                <button
                                    type="button"
                                ...
                                >
                                    ...
                                    <div class="whitespace-nowrap rounded-md bg-primary-light py-0.5 px-2 font-semibold dark:bg-[#060818]">
                                                        ...
                                                        <ul @click="close()">
                                                            <li>
                                                                <a href="javascript:;" @click="setGroup('personal')">
                                                                    <div class="h-2 w-2 rounded-full bg-primary ltr:mr-3 rtl:ml-3"></div>
                                                                    Personal
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="javascript:;" @click="setGroup('work')">
                                                                    <div class="h-2 w-2 rounded-full bg-warning ltr:mr-3 rtl:ml-3"></div>
                                                                    Work
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="javascript:;" @click="setGroup('social')">
                                                                    <div class="h-2 w-2 rounded-full bg-success ltr:mr-3 rtl:ml-3"></div>
                                                                    Social
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="javascript:;" @click="setGroup('private')">
                                                                    <div class="h-2 w-2 rounded-full bg-danger ltr:mr-3 rtl:ml-3"></div>
                                                                    Private
                                                                </a>
                                                            </li>
                                                        </ul>
                        ...
                        <form class="grid gap-6 p-6">
                            ...
                            <div>
                                <input
                                    id="file"
                                    type="file"
                                    class="form-input p-0 file:border-0 file:bg-primary/90 file:py-2 file:px-4 file:font-semibold file:text-white file:hover:bg-primary ltr:file:mr-5 rtl:file:ml-5"
                                    multiple
