<template>
    <div>
        ...
        <div class="grid grid-cols-1 gap-6 pt-5 xl:grid-cols-2">
            <!-- Profile -->
            <div class="panel">
                ...
                <div class="mb-5">
                    ...
                    <div class="sm:flex">
                        <div
                            class="relative z-[2] mx-auto mb-5 before:absolute before:top-12 before:left-1/2 before:-bottom-[15px] before:-z-[1] before:hidden before:h-auto before:w-0 before:-translate-x-1/2 before:border-l-2 before:border-[#ebedf2] dark:before:border-[#191e3a] sm:mb-0 sm:before:block ltr:sm:mr-8 rtl:sm:ml-8"
                        >
                            <img src="/assets/images/profile-16.jpeg" alt="" class="mx-auto h-12 w-12 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)]" />
                        </div>
                        <div class="flex-1">
                            ...
                            <div class="mt-4 mb-16 sm:mt-7">
                                <svg
                                    ...
                                    class="inline-block h-5 w-5 align-text-bottom text-white-dark ltr:mr-2.5 rtl:ml-2.5"
                                >
                                    <path
                                        opacity="0.5"
                                ...
                                <div class="mt-6 flex space-x-1 ltr:pl-8 rtl:space-x-reverse rtl:pr-8">
                                    <img
                                        ...
                                        alt=""
                                        class="relative top-0 h-10 w-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] transition-all duration-300 hover:-top-0.5 hover:shadow-none"
                                    />
                                    <img
                    ...
                    <div class="sm:flex">
                        <div
                            class="relative z-[2] mx-auto mb-5 before:absolute before:top-12 before:left-1/2 before:-bottom-[15px] before:-z-[1] before:hidden before:h-auto before:w-0 before:-translate-x-1/2 before:border-l-2 before:border-[#ebedf2] dark:before:border-[#191e3a] sm:mb-0 sm:before:block ltr:sm:mr-8 rtl:sm:ml-8"
                        >
                            <img src="/assets/images/profile-7.jpeg" alt="" class="mx-auto h-12 w-12 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)]" />
                        </div>
                        <div class="flex-1">
                            ...
                            <div class="mt-4 mb-16 sm:mt-7">
                                ...
                                <div class="mt-6 grid grid-cols-3 gap-3 ltr:pl-8 rtl:pr-8 sm:grid-cols-5 lg:grid-cols-8">
                                    <img
                                        src="/assets/images/drag-1.jpeg"
                                        alt=""
                                        class="relative top-0 w-full rounded-md shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] transition-all duration-300 hover:-top-0.5 hover:shadow-none"
                                    />
                                    <img
                                        src="/assets/images/profile-16.jpeg"
                                        alt=""
                        ...
                        <div class="flex-1">
                            ...
                            <div class="mt-4 mb-16 sm:mt-7">
                                <svg
                                    ...
                                    fill="none"
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="inline-block h-4.5 w-4.5 align-text-bottom text-white-dark ltr:mr-2.5 rtl:ml-2.5"
                                >
                                    <path
...
&lt;/div&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5 inline-block w-full">
                    <ul
                        class="relative mx-auto table max-w-[900px] py-12 before:absolute before:bottom-0 before:left-1/2 before:top-0 before:-ml-[1.5px] before:w-[3px] before:bg-[#ebedf2] dark:before:bg-[#191e3a]"
                    >
                        <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                            <div
                                class="absolute left-1/2 top-[32px] z-[1] -ml-2.5 hidden h-5 w-5 rounded-full border-[3px] border-[#ebedf2] bg-info dark:border-[#191e3a] sm:block"
                            ></div>
                            <div
                        ...
                        <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                            <div
                                class="absolute left-1/2 top-[32px] z-[1] -ml-2.5 hidden h-5 w-5 rounded-full border-[3px] border-[#ebedf2] bg-primary dark:border-[#191e3a] sm:block"
                            ></div>
                            <div
                        ...
                        <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                            <div
                                class="absolute left-1/2 top-[32px] z-[1] -ml-2.5 hidden h-5 w-5 rounded-full border-[3px] border-[#ebedf2] bg-success dark:border-[#191e3a] sm:block"
                            ></div>
                            <div
                                class="relative mx-auto w-full max-w-[320px] rounded-md border border-[#ebedf2] bg-white shadow-[0_20px_20px_rgba(126,142,177,0.12)] before:absolute before:top-10 before:hidden before:h-[3px] before:w-[37px] before:rounded-full before:bg-[#ebedf2] ltr:before:-right-[37px] rtl:before:-left-[37px] dark:border-[#191e3a] dark:bg-[#191e3a] dark:before:bg-[#191e3a] sm:w-[46%] sm:max-w-full sm:before:block ltr:sm:float-left rtl:sm:float-right"
                            >
                        ...
                        <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                            <div
                                class="absolute left-1/2 top-[32px] z-[1] -ml-2.5 hidden h-5 w-5 rounded-full border-[3px] border-[#ebedf2] bg-danger dark:border-[#191e3a] sm:block"
                            ></div>
                            <div
                                class="relative mx-auto w-full max-w-[320px] rounded-md border border-[#ebedf2] bg-white shadow-[0_20px_20px_rgba(126,142,177,0.12)] before:absolute before:top-10 before:hidden before:h-[3px] before:w-[37px] before:rounded-full before:bg-[#ebedf2] ltr:before:-left-[37px] rtl:before:-right-[37px] dark:border-[#191e3a] dark:bg-[#191e3a] dark:before:bg-[#191e3a] sm:w-[46%] sm:max-w-full sm:before:block ltr:sm:float-right rtl:sm:float-left"
                            >
                ...
                <div class="mb-5">
                    <div class="mx-auto max-w-[900px]">
                        ...
                        <div class="flex">
                            ...
                            ></div>
                            <div class="self-center p-2.5 ltr:ml-2.5 rtl:ml-2.5 rtl:ltr:mr-2.5">
                                <p class="text-[13px] font-semibold text-[#3b3f5c] dark:text-white-light">Conference call with Marketing Manager.</p>
                ...
                <div class="mb-5">
                    <div class="mx-auto max-w-[900px] space-y-3 text-center sm:space-y-0 ltr:sm:text-left rtl:sm:text-right">
                        <div class="items-center sm:flex">
                            ...
                            <div
                                class="relative p-2.5 after:absolute after:left-1/2 after:top-[25px] after:-bottom-[15px] after:h-auto after:w-0 after:-translate-x-1/2 after:rounded-full after:border-l-2 after:border-white-dark/20"
                            >
                                <img src="/assets/images/profile-16.jpeg" alt="" class="relative z-[1] mx-auto h-11 w-11 rounded-full" />
                            </div>
                            <p class="mt-5 self-center p-2.5 text-xs font-bold text-white-dark sm:mt-0 sm:min-w-[100px] sm:max-w-[100px]">25 mins ago</p>
                            <p class="p-2.5 text-[13px] font-semibold text-[#3b3f5c] dark:text-white-light">Conference call with Marketing Manager.</p>
                        </div>
                        <div class="items-center sm:flex">
                            ...
                            <div
                                class="relative p-2.5 after:absolute after:left-1/2 after:top-[25px] after:-bottom-[15px] after:h-auto after:w-0 after:-translate-x-1/2 after:rounded-full after:border-l-2 after:border-white-dark/20"
                            >
                                <img src="/assets/images/profile-1.jpeg" alt="" class="relative z-[1] mx-auto h-11 w-11 rounded-full" />
                            </div>
                            <p class="mt-5 self-center p-2.5 text-xs font-bold text-white-dark sm:mt-0 sm:min-w-[100px] sm:max-w-[100px]">2 hrs ago</p>
                        ...
                        <div class="items-center sm:flex">
                            ...
                            <div
                                class="relative p-2.5 after:absolute after:left-1/2 after:top-[25px] after:-bottom-[15px] after:h-auto after:w-0 after:-translate-x-1/2 after:rounded-full after:border-l-2 after:border-white-dark/20"
                            >
                                <img src="/assets/images/profile-2.jpeg" alt="" class="relative z-[1] mx-auto h-11 w-11 rounded-full" />
                            </div>
                            <p class="mt-5 self-center p-2.5 text-xs font-bold text-white-dark sm:mt-0 sm:min-w-[100px] sm:max-w-[100px]">4 hrs ago</p>
                        ...
                        <div class="items-center sm:flex">
                            ...
                            <div
                                class="relative p-2.5 after:absolute after:left-1/2 after:top-[25px] after:-bottom-[15px] after:h-auto after:w-0 after:-translate-x-1/2 after:rounded-full after:border-l-2 after:border-white-dark/20"
                            >
                                <img src="/assets/images/profile-3.jpeg" alt="" class="relative z-[1] mx-auto h-11 w-11 rounded-full" />
                            </div>
                            <p class="mt-5 self-center p-2.5 text-xs font-bold text-white-dark sm:mt-0 sm:min-w-[100px] sm:max-w-[100px]">6 hrs ago</p>
                        ...
                        <div class="items-center sm:flex">
                            ...
                            <div class="relative p-2.5">
                                <img src="/assets/images/profile-4.jpeg" alt="" class="relative z-[1] mx-auto h-11 w-11 rounded-full" />
                            </div>
                            <p class="mt-5 self-center p-2.5 text-xs font-bold text-white-dark sm:mt-0 sm:min-w-[100px] sm:max-w-[100px]">9 hrs ago</p>
