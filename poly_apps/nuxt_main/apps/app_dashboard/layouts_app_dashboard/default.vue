<!--
  DASHBOARD APP CUSTOM LAYOUT

  This layout is specifically for the Dashboard app.
  It CHOOSES to use the shared Header, Sidebar, and Footer components.

  Key principle: Dashboard app actively imports these components,
  they are NOT forced by a top-level layout.
-->
<template>
      ...
      <div class="main-container min-h-screen text-black dark:text-white-dark" :class="[store.navbar]">
        ...
        <div class="main-content">
          ...
          <div class="animation p-6">
            ...
            <!-- ✅ DASHBOARD CHOOSES TO USE SHARED FOOTER -->
            <layout-footer />
          </div>
        </div>
        <!-- END CONTENT AREA -->
...
<style scoped>
/* Dashboard-specific layout styles if needed */
.dashboard-layout {
  /* Can customize dashboard layout here */
}
</style>
