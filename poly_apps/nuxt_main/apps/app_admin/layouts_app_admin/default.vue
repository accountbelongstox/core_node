<!--
  ADMIN APP CUSTOM LAYOUT

  This layout is specifically for the Admin app.
  It CHOOSES to use the shared Header, Sidebar, and Footer components.

  Key principle: Admin app actively imports these components,
...
<style scoped>
/* Admin-specific layout styles if needed */
.admin-layout {
  /* Can customize admin layout here */
}
</style>
