...
import { useVideoStream } from '@/app_pymatrix_pages/composables/useVideoStream';
...
import { useDeviceRole } from '@/app_pymatrix_pages/composables/useDeviceRole';
...
import { useScriptRecorder } from '@/app_pymatrix_pages/composables/useScriptRecorder';
...
async function handleContextMenuAction(action: string, serial: string) {
  ...
  switch (action) {
    ...
    case 'toggle-recording':
      ...
      const recordingStore = await import('@/app_pymatrix_pages/stores/recordingStore');
