  ...
  <div class="ittools-root">
    ...
    <div class="app-container">
      ...
      <div class="bento-layout">
        <!-- Left Sidebar -->
        <aside class="sidebar-panel glass-strong glass-scroll">
          <div class="sidebar-header">
            <span class="label-glass">Categories</span>
          </div>
          ...
          <div class="bento-card tool-card">
            ...
            <div class="tool-content">
              ...
              <div v-else class="empty-state">
                ...
                <h3>Select a Tool</h3>
                <p>Choose a utility from the left sidebar to start working</p>
              </div>
            </div>
          </div>
        </main>

        <!-- Right Panel - Recent Tools -->
        <aside class="right-panel glass-strong glass-scroll">
          <div class="panel-header">
            <span class="label-glass">Recent Tools</span>
            <span class="panel-count">Last 10</span>
          </div>
          <div v-if="recentlyUsedTools.length" class="recent-list">
            <button
...
const switchTab = (tabId: string) => { activeMainTab.value = tabId; };
const toggleRightPanel = () => { rightPanelVisible.value = !rightPanelVisible.value; };
