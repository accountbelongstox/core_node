...
import type { Tool, HistoryEntry } from '../types_app_ittools';
import ToolModal from '../components_app_ittools/ToolModal.vue';
import SettingsModal from '../components_app_ittools/SettingsModal.vue';
...
const executeTool = async (toolId: string, params: Record<string, any>) => {
  ...
  if (tool) {
    const api = new (await import('../services_app_ittools/ittools-main-api')).ItToolsMainAPI();
    try {
