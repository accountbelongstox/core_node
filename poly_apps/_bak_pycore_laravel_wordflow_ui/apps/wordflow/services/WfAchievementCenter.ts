 ...
 * WfProfileProfilePage hardcoded 6 always-on badges while WfMineSocialPage /
 * WfSocialLeaderboardPage each kept a private 4-badge copy — three sources of
...
export interface WfAchievementInput {
...
export interface WfAchievement {
  id: string;
  name: string;
  description: string;
  icon: LucideIcon;
 ...
 */
export function deriveAchievements(input: WfAchievementInput): WfAchievement[] {
...
export function statsToAchievementInput(stats: any): WfAchievementInput {
...
export function leaderEntryToAchievementInput(entry: any): WfAchievementInput {
