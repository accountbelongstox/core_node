...
import { tool as videoCompressor } from './video-compressor';
import { tool as archiveCreator } from './archive-creator';
...
export const toolsByCategory: ToolCategory[] = [
  ...
  },
  {
    ...
    components: [qrCodeGenerator, wifiQrCodeGenerator, svgPlaceholderGenerator, cameraRecorder, imageCompressor, videoCompressor, archiveCreator],
  },
  {
    name: 'Development',
    components: [
