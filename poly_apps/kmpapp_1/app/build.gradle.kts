...
android {
    defaultConfig {
        applicationId = "com.escodro.qyapp"
    ...
    signingConfigs {
        create("release") {
            keyAlias = getSigningKey(properties, "QYAPP_KEY_ALIAS", "keyAlias")
            keyPassword = getSigningKey(properties, "QYAPP_KEY_PASSWORD", "keyPassword")
            storeFile = file(getSigningKey(properties, "QYAPP_STORE_PATH", "storePath"))
            storePassword = getSigningKey(properties, "QYAPP_KEY_STORE_PASSWORD", "storePassword")
        }
    }
