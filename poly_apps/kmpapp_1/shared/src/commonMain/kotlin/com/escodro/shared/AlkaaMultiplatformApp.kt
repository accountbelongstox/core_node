...
import com.escodro.appstate.rememberQyappAppState
...
@Composable
fun QyappMultiplatformApp(
    modifier: Modifier = Modifier,
    appState: AppState = rememberQyappAppState(),
) {
    QyappTheme(isDarkTheme = rememberIsDarkTheme()) {
        Home(
            appState = appState,
            modifier = modifier,
        )
