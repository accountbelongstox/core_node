...
/**
 * Function to remember a [QyappAppState].
 *
 * @param navHostController the [NavHostController] used to navigate between destinations
 */
@Composable
fun rememberQyappAppState(
    navHostController: NavHostController = rememberNavController(),
): QyappAppState = remember(navHostController) {
    QyappAppState(navHostController)
}
