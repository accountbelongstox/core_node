...
val QyappLightColorScheme = lightColorScheme(
...
val QyappDarkColorScheme = darkColorScheme(
...
fun QyappTheme(
    ...
    val colorScheme = when {
        ...
        isDarkTheme -> QyappDarkColorScheme
        else -> QyappLightColorScheme
    }

    MaterialTheme(
        colorScheme = colorScheme,
        typography = QyappTypography,
        content = content,
    )
}

@Composable
fun QyappThemePreview(
    isDarkTheme: Boolean = false,
    content: @Composable () -> Unit,
) {
    val colorScheme = if (isDarkTheme) {
        QyappDarkColorScheme
    } else {
        QyappLightColorScheme
    }
