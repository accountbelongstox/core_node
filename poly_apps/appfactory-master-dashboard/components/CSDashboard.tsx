  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard title="My Revenue" value="$4,250" change="+8.2%" isPositive icon={<DollarSign size={20} />} />
        <StatCard title="Promotions" value="124" change="+12" isPositive icon={<TrendingUp size={20} />} />
        <StatCard title="Active Apps" value="3" icon={<Smartphone size={20} />} />
        <StatCard title="Commission Rate" value="15%" icon={<Target size={20} />} />
      </div>
      ...
      <div className="bg-white dark:bg-slate-800 p-8 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col items-center justify-center min-h-[400px]">
        ...
        <h3 className="text-xl font-bold text-slate-800 dark:text-white">CS Dashboard Overview</h3>
        <p className="text-slate-500 dark:text-slate-400 mt-2 text-center max-w-md">
          Welcome to your personal workspace. Here you can track your assigned apps, revenue, and performance metrics.
        </p>
      </div>
    </div>
  );
      ...
      <main className="flex-1 ml-64 flex flex-col">
        ...
        <div className="p-8">
          <Routes>
            ...
            <Route path="/my-apps" element={<div className="flex items-center justify-center h-96 text-slate-400">My Apps Coming Soon</div>} />
            <Route path="/promotions" element={<div className="flex items-center justify-center h-96 text-slate-400">Promotions Coming Soon</div>} />
            <Route path="/performance" element={<div className="flex items-center justify-center h-96 text-slate-400">Performance Coming Soon</div>} />
          </Routes>
        </div>
      </main>
    </div>
