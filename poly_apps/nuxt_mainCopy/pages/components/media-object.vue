        ...
        <div class="grid grid-cols-1 gap-6 pt-5 xl:grid-cols-2">
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Simple</h5>
                ...
                <div class="mb-5">
                    <div class="flex">
                        <div class="ltr:mr-4 rtl:ml-4">
                            <img src="/assets/images/profile-5.jpeg" alt="" class="h-16 w-16 rounded" />
                        </div>
                        <div class="flex-1">
                            <h4 class="mb-2 text-lg font-semibold text-primary">Heading</h4>
                            <p class="media-text">
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Order</h5>
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Top-aligned media</h5>
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Center-aligned media</h5>
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Bottom-aligned media</h5>
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Right Aligned</h5>
                ...
                <div class="mb-5">
                    <div class="flex">
                        <div class="flex-1 ltr:mr-4 ltr:text-right rtl:ml-4 rtl:text-left">
                            <h4 class="mb-2 text-lg font-semibold text-primary">Heading</h4>
                            <p class="media-text">
                                Fusce condimentum cursus mauris et ornare. Mauris fermentum mi id sollicitudin viverra. Aenean dignissim sed ante eget dapibus.
                                Sed dapibus nulla elementum, rutrum neque eu, gravida neque. Fusce condimentum cursus mauris et ornare. Mauris fermentum mi id
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Media list</h5>
                ...
                <div class="mb-5">
                    <div class="mb-5 flex">
                        <div class="ltr:mr-4 rtl:ml-4">
                            <img src="/assets/images/profile-5.jpeg" alt="" class="h-14 w-14 rounded" />
                        </div>
                        <div class="flex-1">
                            <h4 class="mb-2 text-lg font-semibold text-primary">Heading</h4>
                            <p class="media-text">
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Nesting</h5>
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Notation Text</h5>
                ...
                <div class="mb-5">
                    <div class="flex">
                        ...
                        <div class="flex-1">
                            ...
                            <ul class="flex space-x-4 font-bold rtl:space-x-reverse">
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Notation Icon</h5>
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Badge</h5>
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Dropdown List</h5>
                    ...
                    <div class="flex">
                        ...
                        <div class="flex-1">
                            <div class="mb-2 flex justify-between">
                                <h4 class="text-lg font-semibold text-primary">Heading</h4>
                                <div class="dropdown">
                                    <client-only>
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <div class="mb-5 flex items-center">
                        <div class="ltr:mr-4 rtl:ml-4">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-danger">
                    ...
                    <div class="flex items-center">
                        <div class="ltr:mr-4 rtl:ml-4">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-warning">
                                <path
                                    opacity="0.5"
