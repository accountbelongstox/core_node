                                        ...
                                        <div class="flex min-h-full items-start justify-center px-4 py-8">
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        class="bg-[#fbfbfb] py-3 text-lg font-bold ltr:pl-5 ltr:pr-[50px] rtl:pr-5 rtl:pl-[50px] dark:bg-[#121c2c]"
                                                    >
                                                        Modal Title
                                                    </div>
                                                    <div class="p-5">
                                ...
                                <div class="fixed inset-0 overflow-y-auto">
                                    <div class="flex min-h-full items-start justify-center px-4 py-8">
                                        <DialogPanel class="panel w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                            ...
                                            <div class="bg-[#fbfbfb] py-3 text-lg font-bold ltr:pl-5 ltr:pr-[50px] rtl:pr-5 rtl:pl-[50px] dark:bg-[#121c2c]">
                                                Modal Title
                                            </div>
                                            <div class="p-5">
                                                <p>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <div class="p-5">
                                                                ...
                                                                <div class="mt-8 mb-5 flex items-center justify-center">
                                                ...
                                                <div class="flex min-h-full items-start justify-center px-4 py-8">
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <div class="py-5 text-lg font-semibold ltr:pl-5 ltr:pr-[50px] rtl:pr-5 rtl:pl-[50px]">Login</div>
                                                            <div class="p-5">
                                                                <form>
                                                ...
                                                <div class="flex min-h-full items-start justify-center px-4 py-8">
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <div class="py-5 text-lg font-semibold ltr:pl-5 ltr:pr-[50px] rtl:pr-5 rtl:pl-[50px]">Register</div>
                                                            <div class="p-5">
                                                                <form>
                                                                    <div class="relative mb-4">
                                                                        <span
                                                ...
                                                <div class="flex min-h-full items-start justify-center px-4 py-8">
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <div class="py-5 text-lg font-semibold ltr:pl-5 ltr:pr-[50px] rtl:pr-5 rtl:pl-[50px]">Slider</div>
                                                            <div class="px-5">
                                                                <Swiper
