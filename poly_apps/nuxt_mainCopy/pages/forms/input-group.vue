<template>
                        ...
                        <form>
                            ...
                            <div class="mb-5">
                                <div class="flex">
                                    ...
                                    <div
                                        class="flex items-center justify-center border border-[#e0e6ed] bg-[#eee] px-3 font-semibold ltr:rounded-r-md ltr:border-l-0 rtl:rounded-l-md rtl:border-r-0 dark:border-[#17263c] dark:bg-[#1b2e4b]"
                                    >
                                        @example.com
                                    </div>
                                </div>
                            ...
                            <div>
                                <div class="flex">
                                    <div
                                        class="flex items-center justify-center whitespace-nowrap border border-[#e0e6ed] bg-[#eee] px-3 font-semibold ltr:rounded-l-md ltr:border-r-0 rtl:rounded-r-md rtl:border-l-0 dark:border-[#17263c] dark:bg-[#1b2e4b]"
                                    >
                                        With textarea
                                    </div>
  ...
  &lt;/form&gt;
                ...
                <div class="panel">
                    <div class="mb-5 flex items-center justify-between">
                        <h5 class="text-lg font-semibold dark:text-white-light">Simple Icon</h5>
                        <a
                            class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600"
                            href="javascript:;"
  ...
  &lt;/div&gt;
                ...
                <div class="panel">
                    <div class="mb-5 flex items-center justify-between">
                        <h5 class="text-lg font-semibold dark:text-white-light">Spinning Icon</h5>
                        <a
                            class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600"
                            href="javascript:;"
                            ...
                            <div class="flex">
                                ...
                                >
                                    <svg
                                        ...
                                        class="h-5 w-5 animate-spin text-white-dark"
                                    >
  ...
  &lt;/div&gt;
                ...
                <div class="panel">
                    <div class="mb-5 flex items-center justify-between">
                        <h5 class="text-lg font-semibold dark:text-white-light">Dropdown Icon</h5>
                        <a
                            class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600"
                            href="javascript:;"
                            ...
                            <div class="flex">
                                <client-only>
                                    <Popper
                                        ...
                                        offsetDistance="0"
                                        class="input-group-dropodwn align-middle"
                                    >
                                        <div
                        ...
                        <div class="dropdown">
                            ...
                            <div class="flex">
                                ...
                                <client-only>
                                    ...
                                    >
                                        <div
                                            class="flex h-full cursor-pointer items-center justify-center border border-[#e0e6ed] bg-success px-3 font-semibold ltr:rounded-r-md ltr:border-l-0 rtl:rounded-l-md rtl:border-r-0 dark:border-[#17263c]"
                                        >
                                            <svg
                                                width="24"
                                                height="24"
                    ...
                    <div class="mb-5">
                        <div class="mb-5">
                            ...
                            <div class="flex">
                                ...
                                >
                                    <input type="checkbox" class="form-checkbox border-[#e0e6ed] ltr:mr-0 rtl:ml-0 dark:border-white-dark" checked />
                                </div>
                        ...
                        <div>
                            ...
                            <div class="flex">
                                ...
                                <div
                                    class="flex items-center justify-center border border-[#e0e6ed] bg-[#f1f2f3] px-3 font-semibold ltr:rounded-r-md ltr:border-l-0 rtl:rounded-l-md rtl:border-r-0 dark:border-[#17263c] dark:bg-[#1b2e4b]"
                                >
                                    <input
                                        type="checkbox"
                                        class="form-checkbox border-[#e0e6ed] text-warning ltr:mr-0 rtl:ml-0 dark:border-white-dark"
                                        checked
                                    />
                                </div>
                            </div>
  ...
  &lt;/div&gt;
                ...
                <div class="panel">
                    <div class="mb-5 flex items-center justify-between">
                        <h5 class="text-lg font-semibold dark:text-white-light">Radios</h5>
                        <a
                            class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600"
                            href="javascript:;"
                        ...
                        <div class="mb-5">
                            ...
                            <div class="flex">
                                <div
                                    class="flex items-center justify-center border border-[#e0e6ed] bg-[#f1f2f3] px-3 font-semibold ltr:rounded-l-md ltr:border-r-0 rtl:rounded-r-md rtl:border-l-0 dark:border-[#17263c] dark:bg-[#1b2e4b]"
                                >
                                    <input type="radio" class="form-radio border-[#e0e6ed] text-info ltr:mr-0 rtl:ml-0 dark:border-white-dark" checked />
                                </div>
                        ...
                        <div>
                            ...
                            <div class="flex">
                                ...
                                <div
                                    class="flex items-center justify-center border border-[#e0e6ed] bg-[#f1f2f3] px-3 font-semibold ltr:rounded-r-md ltr:border-l-0 rtl:rounded-l-md rtl:border-r-0 dark:border-[#17263c] dark:bg-[#1b2e4b]"
                                >
                                    <input type="radio" class="form-radio border-[#e0e6ed] text-danger ltr:mr-0 rtl:ml-0 dark:border-white-dark" checked />
                                </div>
                            </div>
                        </div>
                    </div>
  ...
  &lt;/div&gt;
                ...
                <div class="panel">
                    <div class="mb-5 flex items-center justify-between">
                        <h5 class="text-lg font-semibold dark:text-white-light">Switch</h5>
                        <a
                            class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600"
                            href="javascript:;"
                        ...
                        <div class="mb-5">
                            ...
                            <div class="flex">
                                <div
                                    class="flex items-center justify-center border border-[#e0e6ed] bg-[#eee] px-3 font-semibold ltr:rounded-l-md ltr:border-r-0 rtl:rounded-r-md rtl:border-l-0 dark:border-[#17263c] dark:bg-[#1b2e4b]"
                                >
                                    <label class="relative mb-0 h-4 w-7 cursor-pointer">
                                        <input
                                            type="checkbox"
                                            class="peer absolute z-10 h-full w-full cursor-pointer opacity-0 focus:outline-none focus:ring-0"
                                            id="custom_switch_checkbox1"
                                        />
                                        <span
                                            class="block h-full rounded-full border border-[#adb5bd] bg-white before:absolute before:bottom-[2px] before:h-3 before:w-3 before:rounded-full before:bg-[#adb5bd] before:transition-all before:duration-300 peer-checked:border-primary peer-checked:bg-primary peer-checked:before:bg-white ltr:before:left-0.5 ltr:peer-checked:before:left-3.5 rtl:before:right-0.5 rtl:peer-checked:before:right-3.5 dark:bg-dark dark:before:bg-white-dark"
                                        ></span>
                                    </label>
                                </div>
  ...
  &lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Sizes</h5>
                    ...
                    <form>
                        <div class="mb-5">
                            <div class="flex">
                                ...
                                <input type="text" placeholder="Username" class="form-input py-2.5 text-base ltr:rounded-l-none rtl:rounded-r-none" />
                            </div>
                        </div>
                        <div class="mb-5">
                            <div class="flex">
                        ...
                        <div>
                            <div class="flex">
                                ...
                                <input type="text" placeholder="Username" class="form-input py-1.5 text-xs ltr:rounded-l-none rtl:rounded-r-none" />
                            </div>
                        </div>
                    </form>
                </div>
  ...
  &lt;/form&gt;
            ...
            <div class="grid grid-cols-1 gap-4 xl:grid-cols-2">
                <div class="panel">
                    <div class="mb-5 flex items-center justify-between">
                        <h5 class="text-lg font-semibold dark:text-white-light">Multiple inputs</h5>
                        <a
                            class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600"
                            href="javascript:;"
                        ...
                        <form>
                            <div class="flex">
                                ...
                                <input
                                    ...
                                    class="form-input flex-1 rounded-none focus:!border-r focus:!border-l ltr:border-r-0 rtl:border-l-0"
                                />
                                <input type="text" placeholder="Last Name" class="form-input flex-1 ltr:rounded-l-none rtl:rounded-r-none" />
                            </div>
                        </form>
                    </div>
  ...
  &lt;/form&gt;
                ...
                <div class="panel">
                    <div class="mb-5 flex items-center justify-between">
                        <h5 class="text-lg font-semibold dark:text-white-light">Multiple addons</h5>
                        <a
                            class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600"
                            href="javascript:;"
                        ...
                        <form>
                            <div class="mb-5">
                                <div class="flex">
                                    ...
                                    <div
                                        class="flex items-center justify-center rounded-none border border-[#e0e6ed] bg-[#eee] px-3 font-semibold ltr:border-r-0 rtl:border-l-0 dark:border-[#17263c] dark:bg-[#1b2e4b]"
                                    >
                                        0.00
                                    </div>
                                    <input type="text" placeholder="" class="form-input flex-1 ltr:rounded-l-none rtl:rounded-r-none" />
                                </div>
                            </div>
                            <div>
                                <div class="flex">
                                    <input
                                        type="text"
                                        placeholder=""
                                        class="form-input flex-1 ltr:rounded-r-none ltr:rounded-l-md rtl:rounded-l-none rtl:rounded-r-md"
                                    />
                                    <div
                                        class="flex items-center justify-center rounded-none border border-[#e0e6ed] bg-[#eee] px-3 font-semibold dark:border-[#17263c] dark:bg-[#1b2e4b]"
                                    >
                                        0.00
                                    </div>
                                    <div
  ...
  &lt;/form&gt;
            ...
            <div class="grid grid-cols-1 gap-4 xl:grid-cols-2">
                <div class="panel">
                    <div class="mb-5 flex items-center justify-between">
                        <h5 class="text-lg font-semibold dark:text-white-light">Buttons with dropdowns</h5>
                        <a
                            class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600"
                            href="javascript:;"
                            ...
                            <div class="dropdown">
                                ...
                                <div class="flex">
                                    ...
                                    <client-only>
                                        ...
                                        >
                                            <div
                                                class="flex h-full cursor-pointer items-center justify-center border border-[#e0e6ed] bg-danger px-3 font-semibold text-white ltr:rounded-r-md ltr:border-l-0 rtl:rounded-l-md rtl:border-r-0 dark:border-[#17263c]"
                                            >
                                                Dropdown
                                            </div>
                                            <template #content="{ close }">
  ...
  &lt;/form&gt;
                ...
                <div class="panel">
                    <div class="mb-5 flex items-center justify-between">
                        <h5 class="text-lg font-semibold dark:text-white-light">Segmented buttons</h5>
                        <a
                            class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600"
                            href="javascript:;"
                    ...
                    <div class="mb-5">
                        <form>
                            <div class="dropdown mb-5">
                                ...
                                <div class="flex">
                                    <div
                                        class="flex items-center justify-center border border-info bg-info px-3 font-semibold text-white ltr:rounded-l-md ltr:border-r-0 rtl:rounded-r-md rtl:border-l-0"
                                    >
                                        Action
                                    </div>
                                    <client-only>
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        placeholder=""
                                        class="form-input ltr:rounded-l-none ltr:border-l-0 rtl:rounded-r-none rtl:border-r-0"
                                    />
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="flex">
                                    ...
                                    <client-only>
                                        ...
                                        >
                                            <div
                                                class="flex h-full cursor-pointer items-center justify-center rounded-none border border-secondary bg-white px-3 font-semibold text-secondary dark:bg-[#1b2e4b]"
                                            >
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
                                                    <path
                                                        d="M19 9L12 15L5 9"
                                    ...
                                    <div
                                        class="flex cursor-pointer items-center justify-center border border-secondary bg-secondary px-3 font-semibold text-white ltr:rounded-r-md ltr:border-l-0 rtl:rounded-l-md rtl:border-r-0"
                                    >
                                        Action
                                    </div>
                                </div>
  ...
  &lt;/form&gt;
                ...
                <div class="panel lg:col-span-2">
                    <div class="mb-5 flex items-center justify-between">
                        <h5 class="text-lg font-semibold dark:text-white-light">Button addons</h5>
                        <a
                            class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600"
                            href="javascript:;"
