        ...
        <div class="grid grid-cols-1 gap-6 pt-5 lg:grid-cols-2">
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Infobox 1</h5>
                ...
                <div class="mb-5">
                    <div class="flex w-full flex-wrap justify-center">
                        <div
                            class="rounded-md border border-gray-500/20 p-6 shadow-[rgb(31_45_61_/_10%)_0px_2px_10px_1px] dark:shadow-[0_2px_11px_0_rgb(6_8_24_/_39%)]"
                        >
                            ...
                            <h5 class="mb-3.5 text-lg font-semibold dark:text-white-light">Layout Package</h5>
                            <p class="mb-3.5 text-[15px] text-white-dark">Lorem ipsum dolor sit amet, labore et dolore magna aliqua.</p>
                            <a href="javascript:;" class="group font-semibold text-primary hover:underline"
                                >Discover
                                <svg
                                    width="24"
                                    height="24"
                                    ...
                                    class="relative inline-block h-4 w-4 transition-all duration-300 group-hover:translate-x-2 ltr:ml-1 rtl:mr-1 rtl:rotate-180 rtl:group-hover:-translate-x-2"
                                >
                                    <path
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Infobox 2</h5>
                ...
                <div class="mb-5">
                    <div class="flex w-full flex-wrap justify-center">
                        <div
                            class="rounded-md border border-gray-500/20 bg-dark p-6 text-center shadow-[rgb(31_45_61_/_10%)_0px_2px_10px_1px] dark:shadow-[0_2px_11px_0_rgb(6_8_24_/_39%)]"
                        >
                            <div class="bg1-white-dark mx-auto mb-5 flex h-20 w-20 items-center justify-center rounded-full text-white-light">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-12 w-12">
                                    <path
                                        d="M15.5777 3.38197L17.5777 4.43152C19.7294 5.56066 20.8052 6.12523 21.4026 7.13974C22 8.15425 22 9.41667 22 11.9415V12.0585C22 14.5833 22 15.8458 21.4026 16.8603C20.8052 17.8748 19.7294 18.4393 17.5777 19.5685L15.5777 20.618C13.8221 21.5393 12.9443 22 12 22C11.0557 22 10.1779 21.5393 8.42229 20.618L6.42229 19.5685C4.27063 18.4393 3.19479 17.8748 2.5974 16.8603C2 15.8458 2 14.5833 2 12.0585V11.9415C2 9.41667 2 8.15425 2.5974 7.13974C3.19479 6.12523 4.27063 5.56066 6.42229 4.43152L8.42229 3.38197C10.1779 2.46066 11.0557 2 12 2C12.9443 2 13.8221 2.46066 15.5777 3.38197Z"
                                        stroke="currentColor"
                            ...
                            <h5 class="mb-3.5 text-lg font-semibold text-white-light">Layout Package</h5>
                            <p class="mb-3.5 text-[15px] text-white-light">Lorem ipsum dolor sit amet, labore et dolore magna aliqua.</p>
                            <a href="javascript:;" class="group font-semibold text-info hover:underline"
                                >Discover
                                <svg
                                    width="24"
                                    height="24"
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Infobox 3</h5>
                ...
                <div class="mb-5">
                    <div class="flex w-full flex-wrap justify-center">
                        <div
                            class="relative mt-8 rounded-md border border-gray-500/20 p-6 pt-12 shadow-[rgb(31_45_61_/_10%)_0px_2px_10px_1px] dark:shadow-[0_2px_11px_0_rgb(6_8_24_/_39%)]"
                        >
                            <div
                                class="absolute -top-8 mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-md bg-primary text-white-light ltr:left-6 rtl:right-6"
                            >
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-12 w-12">
                                    <path
                                        d="M15.5777 3.38197L17.5777 4.43152C19.7294 5.56066 20.8052 6.12523 21.4026 7.13974C22 8.15425 22 9.41667 22 11.9415V12.0585C22 14.5833 22 15.8458 21.4026 16.8603C20.8052 17.8748 19.7294 18.4393 17.5777 19.5685L15.5777 20.618C13.8221 21.5393 12.9443 22 12 22C11.0557 22 10.1779 21.5393 8.42229 20.618L6.42229 19.5685C4.27063 18.4393 3.19479 17.8748 2.5974 16.8603C2 15.8458 2 14.5833 2 12.0585V11.9415C2 9.41667 2 8.15425 2.5974 7.13974C3.19479 6.12523 4.27063 5.56066 6.42229 4.43152L8.42229 3.38197C10.1779 2.46066 11.0557 2 12 2C12.9443 2 13.8221 2.46066 15.5777 3.38197Z"
                            ...
                            <h5 class="mb-3.5 text-lg font-semibold text-dark dark:text-white-light">Layout Package</h5>
                            <p class="mb-3.5 text-[15px] text-white-dark">Lorem ipsum dolor sit amet, labore et dolore magna aliqua.</p>
                            <a href="javascript:;" class="group font-semibold text-primary hover:underline"
                                >Discover
                                <svg
