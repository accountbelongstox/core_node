<!-- 
  ...
  Generated at: 2025-11-02T23:12:42.973Z
  App Entry: ittools
    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      <aside class="w-64 bg-white border-r border-gray-200 overflow-y-auto">
        <div class="p-4">
          ...
          <div class="space-y-1">
            ...
            <!-- Settings Sidebar -->
            <template v-if="activeMainTab === 'settings'">
              <button
      ...
      <main class="flex-1 overflow-y-auto bg-gray-50">
        <div class="p-6">
          ...
          <!-- Settings Content -->
          <div v-if="activeMainTab === 'settings'" class="space-y-6">
            <SettingsPanel />
          </div>
        </div>
      </main>
...
const settingsSidebarItems = [
  ...
  { id: 'behavior', name: 'Behavior', icon: 'fas fa-cog' },
  { id: 'connections', name: 'Connections', icon: 'fas fa-wifi' },
  { id: 'tools', name: 'Tool Preferences', icon: 'fas fa-tools' },
  { id: 'data-management', name: 'Data Management', icon: 'fas fa-database' },
