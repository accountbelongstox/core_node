...
export const ADVANCED_IMAGE_TOOLS: Record<string, ToolConfig> = {
  imageRotator: {
    id: 'imageRotator',
    name: 'Image Rotator',
...
export const ADVANCED_CALCULATOR_TOOLS: Record<string, ToolConfig> = {
  ageCalculator: {
    id: 'ageCalculator',
    name: 'Age Calculator',
...
export const UNIFIED_API_TOOLS: Record<string, ToolConfig> = {
  textEncoder: {
    id: 'textEncoder',
