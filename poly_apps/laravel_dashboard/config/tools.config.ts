 ...
 */
export const VOCABULARY_TOOLS: Record<string, ToolConfig> = {
  wordLibrary: {
    id: 'wordLibrary',
    name: 'Word Library',
    category: 'Vocabulary',
 ...
 */
export const SERVER_MANAGER_TOOLS: Record<string, ToolConfig> = {
  systemInfo: {
    id: 'systemInfo',
 ...
 */
export const IT_TOOLS: Record<string, ToolConfig> = {
  // Hash & Crypto Tools
  hashGenerator: {
    id: 'hashGenerator',
    name: 'Hash Generator',
 ...
 */
export const VOICE_SUBTITLE_TOOLS: Record<string, ToolConfig> = {
  vsQueue: {
    id: 'vsQueue',
