...
const Sidebar: React.FC<SidebarProps> = ({ activeView, onViewChange, lang }) => {
  ...
  return (
    <aside className="w-16 md:w-20 h-screen flex flex-col items-center py-6 bg-white/50 dark:bg-slate-950/50 backdrop-blur-md border-r border-black/5 dark:border-white/10 z-50 transition-colors duration-300">
      {/* Brand Logo / Rocket */}
      <div className="mb-8 p-3 bg-indigo-500/10 dark:bg-indigo-500/20 rounded-xl text-indigo-600 dark:text-indigo-400 border border-indigo-500/20 dark:border-indigo-500/30 shadow-[0_0_15px_rgba(99,102,241,0.2)] dark:shadow-[0_0_15px_rgba(99,102,241,0.3)]">
        <Rocket size={24} />
      </div>
