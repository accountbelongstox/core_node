        ...
        <TouchableOpacity>
          <GlassCard style={localStyles.mapPreview}>
            <View style={localStyles.mapPlaceholder}>
              <Text style={localStyles.mapPlaceholderText}>{t('friend.mapView')}</Text>
            </View>
            <View style={localStyles.mapFooter}>
              ...
              <Text style={[localStyles.mapFooterTime, { color: colors.textSecondary }]}>
                {t('friend.updated')}: 1 {t('friend.minAgo')}
              </Text>
            </View>
          </GlassCard>
        </TouchableOpacity>
