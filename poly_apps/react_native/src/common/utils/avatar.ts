...
// The path is relative to this file location: src/common/utils/avatar.ts -> assets/images/avatars/
// Path: ../../../assets/images/avatars/ (up 3 levels from src/common/utils to project root)
