...
import { MobileLayout, Header, GlassCard } from '@/apps/awy/awy_components/Shared';
...
const About: React.FC = () => {
  ...
  const menuItems = [
    { key: 'feature', label: t('about.feature') },
    { key: 'privacy', label: t('about.privacy') },
    { key: 'terms', label: t('about.terms') },
    { key: 'updates', label: t('about.updates') },
  ];
  ...
  return (
    <MobileLayout showNav={false}>
      ...
      >
        ...
        <Text style={[localStyles.version, { color: colors.textSecondary }]}>
          {t('about.version')}
        </Text>
        ...
        <GlassCard style={localStyles.menuCard}>
          {menuItems.map((item, index) => (
            <TouchableOpacity 
              ...
              activeOpacity={0.7}
            >
              <Text style={[localStyles.menuItemText, { color: colors.textPrimary }]}>
                {item.label}
              </Text>
