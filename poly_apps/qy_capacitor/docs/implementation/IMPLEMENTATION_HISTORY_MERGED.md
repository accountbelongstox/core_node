...
## ARCHIVED (folded 2026-05-18) — `docs/backend/BACKEND_FRONTEND_GAP_ANALYSIS.md` — resolved/superseded; historical only. Do NOT use as current guidance.
...
## ARCHIVED (folded 2026-05-18) — `docs/backend/CRITICAL_FIX_API_BASE_URL.md` — resolved/superseded; historical only. Do NOT use as current guidance.
